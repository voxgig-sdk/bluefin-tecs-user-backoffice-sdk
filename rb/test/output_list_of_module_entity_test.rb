...
class OutputListOfModuleEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_LIST_OF_MODULE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def output_list_of_module_basic_setup(extra)
  ...
  entid_env_raw = ENV["BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_LIST_OF_MODULE_ENTID"]

...
class OutputChangeLogoEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_CHANGE_LOGO_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def output_change_logo_basic_setup(extra)
  ...
  entid_env_raw = ENV["BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_CHANGE_LOGO_ENTID"]

...
#      offline in seeded test mode (BluefinTecsUserBackofficeSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BluefinTecsUserBackoffice_sdk.rb")
  SDK_CLASS = "BluefinTecsUserBackofficeSDK"
  ...
  SDK_BASE = "BluefinTecsUserBackoffice_sdk"

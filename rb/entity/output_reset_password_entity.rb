...
class OutputResetPasswordEntity
  ...
  def make
    opts = @_entopts.dup
    OutputResetPasswordEntity.new(@_client, opts)
  end
  ...
  # @return [OutputResetPassword, Hash] the current OutputResetPassword data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputResetPassword fields)
  def match_get
  ...
  #
  # @param reqdata [OutputResetPasswordCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputResetPassword, Hash] the created OutputResetPassword; raises BluefinTecsUserBackofficeError on failure

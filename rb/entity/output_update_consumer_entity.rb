...
class OutputUpdateConsumerEntity
  ...
  def make
    opts = @_entopts.dup
    OutputUpdateConsumerEntity.new(@_client, opts)
  end
  ...
  # @return [OutputUpdateConsumer, Hash] the current OutputUpdateConsumer data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputUpdateConsumer fields)
  def match_get
  ...
  #
  # @param reqdata [OutputUpdateConsumerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputUpdateConsumer, Hash] the created OutputUpdateConsumer; raises BluefinTecsUserBackofficeError on failure

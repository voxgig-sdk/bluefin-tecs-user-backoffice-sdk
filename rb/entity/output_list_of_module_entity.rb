...
class OutputListOfModuleEntity
  ...
  def make
    opts = @_entopts.dup
    OutputListOfModuleEntity.new(@_client, opts)
  end
  ...
  # @return [OutputListOfModule, Hash] the current OutputListOfModule data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputListOfModule fields)
  def match_get
  ...
  #
  # @param reqdata [OutputListOfModuleCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputListOfModule, Hash] the created OutputListOfModule; raises BluefinTecsUserBackofficeError on failure

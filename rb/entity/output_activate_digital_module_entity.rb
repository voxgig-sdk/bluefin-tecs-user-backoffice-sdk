...
class OutputActivateDigitalModuleEntity
  ...
  def make
    opts = @_entopts.dup
    OutputActivateDigitalModuleEntity.new(@_client, opts)
  end
  ...
  # @return [OutputActivateDigitalModule, Hash] the current OutputActivateDigitalModule data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputActivateDigitalModule fields)
  def match_get
  ...
  #
  # @param reqdata [OutputActivateDigitalModuleCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputActivateDigitalModule, Hash] the created OutputActivateDigitalModule; raises BluefinTecsUserBackofficeError on failure

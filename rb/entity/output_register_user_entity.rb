...
class OutputRegisterUserEntity
  ...
  def make
    opts = @_entopts.dup
    OutputRegisterUserEntity.new(@_client, opts)
  end
  ...
  # @return [OutputRegisterUser, Hash] the current OutputRegisterUser data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputRegisterUser fields)
  def match_get
  ...
  #
  # @param reqdata [OutputRegisterUserCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputRegisterUser, Hash] the created OutputRegisterUser; raises BluefinTecsUserBackofficeError on failure

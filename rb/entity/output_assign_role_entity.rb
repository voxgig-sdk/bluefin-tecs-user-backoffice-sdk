...
class OutputAssignRoleEntity
  ...
  def make
    opts = @_entopts.dup
    OutputAssignRoleEntity.new(@_client, opts)
  end
  ...
  # @return [OutputAssignRole, Hash] the current OutputAssignRole data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputAssignRole fields)
  def match_get
  ...
  #
  # @param reqdata [OutputAssignRoleCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputAssignRole, Hash] the created OutputAssignRole; raises BluefinTecsUserBackofficeError on failure

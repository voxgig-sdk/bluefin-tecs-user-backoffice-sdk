...
class OutputGetKycDocumentEntity
  ...
  def make
    opts = @_entopts.dup
    OutputGetKycDocumentEntity.new(@_client, opts)
  end
  ...
  # @return [OutputGetKycDocument, Hash] the current OutputGetKycDocument data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputGetKycDocument fields)
  def match_get
  ...
  #
  # @param reqdata [OutputGetKycDocumentCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputGetKycDocument, Hash] the created OutputGetKycDocument; raises BluefinTecsUserBackofficeError on failure

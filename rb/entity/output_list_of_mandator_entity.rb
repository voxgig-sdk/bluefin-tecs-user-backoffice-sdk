...
class OutputListOfMandatorEntity
  ...
  def make
    opts = @_entopts.dup
    OutputListOfMandatorEntity.new(@_client, opts)
  end
  ...
  # @return [OutputListOfMandator, Hash] the current OutputListOfMandator data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputListOfMandator fields)
  def match_get
  ...
  #
  # @param reqdata [OutputListOfMandatorCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputListOfMandator, Hash] the created OutputListOfMandator; raises BluefinTecsUserBackofficeError on failure

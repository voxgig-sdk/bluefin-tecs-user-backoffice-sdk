...
class OutputUpdateProfileEntity
  ...
  def make
    opts = @_entopts.dup
    OutputUpdateProfileEntity.new(@_client, opts)
  end
  ...
  # @return [OutputUpdateProfile, Hash] the current OutputUpdateProfile data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputUpdateProfile fields)
  def match_get
  ...
  #
  # @param reqdata [OutputUpdateProfileCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputUpdateProfile, Hash] the created OutputUpdateProfile; raises BluefinTecsUserBackofficeError on failure

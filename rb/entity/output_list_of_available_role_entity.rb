...
class OutputListOfAvailableRoleEntity
  ...
  def make
    opts = @_entopts.dup
    OutputListOfAvailableRoleEntity.new(@_client, opts)
  end
  ...
  # @return [OutputListOfAvailableRole, Hash] the current OutputListOfAvailableRole data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputListOfAvailableRole fields)
  def match_get
  ...
  #
  # @param reqdata [OutputListOfAvailableRoleCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputListOfAvailableRole, Hash] the created OutputListOfAvailableRole; raises BluefinTecsUserBackofficeError on failure

...
class OutputResendLinkEntity
  ...
  def make
    opts = @_entopts.dup
    OutputResendLinkEntity.new(@_client, opts)
  end
  ...
  # @return [OutputResendLink, Hash] the current OutputResendLink data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputResendLink fields)
  def match_get
  ...
  #
  # @param reqdata [OutputResendLinkCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputResendLink, Hash] the created OutputResendLink; raises BluefinTecsUserBackofficeError on failure

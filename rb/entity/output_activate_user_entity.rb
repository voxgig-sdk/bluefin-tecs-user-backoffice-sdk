...
class OutputActivateUserEntity
  ...
  def make
    opts = @_entopts.dup
    OutputActivateUserEntity.new(@_client, opts)
  end
  ...
  # @return [OutputActivateUser, Hash] the current OutputActivateUser data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputActivateUser fields)
  def match_get
  ...
  #
  # @param reqdata [OutputActivateUserCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputActivateUser, Hash] the created OutputActivateUser; raises BluefinTecsUserBackofficeError on failure

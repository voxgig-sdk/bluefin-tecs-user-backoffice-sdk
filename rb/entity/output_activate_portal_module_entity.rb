...
class OutputActivatePortalModuleEntity
  ...
  def make
    opts = @_entopts.dup
    OutputActivatePortalModuleEntity.new(@_client, opts)
  end
  ...
  # @return [OutputActivatePortalModule, Hash] the current OutputActivatePortalModule data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputActivatePortalModule fields)
  def match_get
  ...
  #
  # @param reqdata [OutputActivatePortalModuleCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputActivatePortalModule, Hash] the created OutputActivatePortalModule; raises BluefinTecsUserBackofficeError on failure

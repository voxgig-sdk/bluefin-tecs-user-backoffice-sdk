...
class OutputDeactivateUserEntity
  ...
  def make
    opts = @_entopts.dup
    OutputDeactivateUserEntity.new(@_client, opts)
  end
  ...
  # @return [OutputDeactivateUser, Hash] the current OutputDeactivateUser data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputDeactivateUser fields)
  def match_get
  ...
  #
  # @param reqdata [OutputDeactivateUserCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputDeactivateUser, Hash] the created OutputDeactivateUser; raises BluefinTecsUserBackofficeError on failure

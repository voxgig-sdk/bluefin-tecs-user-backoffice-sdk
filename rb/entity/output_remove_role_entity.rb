...
class OutputRemoveRoleEntity
  ...
  def make
    opts = @_entopts.dup
    OutputRemoveRoleEntity.new(@_client, opts)
  end
  ...
  # @return [OutputRemoveRole, Hash] the current OutputRemoveRole data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputRemoveRole fields)
  def match_get
  ...
  #
  # @param reqdata [OutputRemoveRoleCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputRemoveRole, Hash] the created OutputRemoveRole; raises BluefinTecsUserBackofficeError on failure

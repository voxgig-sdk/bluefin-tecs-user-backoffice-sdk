...
class OutputProvideCredentialEntity
  ...
  def make
    opts = @_entopts.dup
    OutputProvideCredentialEntity.new(@_client, opts)
  end
  ...
  # @return [OutputProvideCredential, Hash] the current OutputProvideCredential data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputProvideCredential fields)
  def match_get
  ...
  #
  # @param reqdata [OutputProvideCredentialCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputProvideCredential, Hash] the created OutputProvideCredential; raises BluefinTecsUserBackofficeError on failure

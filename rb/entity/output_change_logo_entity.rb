...
class OutputChangeLogoEntity
  ...
  def make
    opts = @_entopts.dup
    OutputChangeLogoEntity.new(@_client, opts)
  end
  ...
  # @return [OutputChangeLogo, Hash] the current OutputChangeLogo data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputChangeLogo fields)
  def match_get
  ...
  #
  # @param reqdata [OutputChangeLogoCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputChangeLogo, Hash] the created OutputChangeLogo; raises BluefinTecsUserBackofficeError on failure

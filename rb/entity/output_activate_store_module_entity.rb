...
class OutputActivateStoreModuleEntity
  ...
  def make
    opts = @_entopts.dup
    OutputActivateStoreModuleEntity.new(@_client, opts)
  end
  ...
  # @return [OutputActivateStoreModule, Hash] the current OutputActivateStoreModule data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputActivateStoreModule fields)
  def match_get
  ...
  #
  # @param reqdata [OutputActivateStoreModuleCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputActivateStoreModule, Hash] the created OutputActivateStoreModule; raises BluefinTecsUserBackofficeError on failure

...
class OutputCreateServiceUserEntity
  ...
  def make
    opts = @_entopts.dup
    OutputCreateServiceUserEntity.new(@_client, opts)
  end
  ...
  # @return [OutputCreateServiceUser, Hash] the current OutputCreateServiceUser data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputCreateServiceUser fields)
  def match_get
  ...
  #
  # @param reqdata [OutputCreateServiceUserCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputCreateServiceUser, Hash] the created OutputCreateServiceUser; raises BluefinTecsUserBackofficeError on failure

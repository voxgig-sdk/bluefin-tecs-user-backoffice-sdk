...
class OutputGetLogoEntity
  ...
  def make
    opts = @_entopts.dup
    OutputGetLogoEntity.new(@_client, opts)
  end
  ...
  # @return [OutputGetLogo, Hash] the current OutputGetLogo data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputGetLogo fields)
  def match_get
  ...
  #
  # @param reqmatch [OutputGetLogoLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.OutputGetLogo.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputGetLogo, Hash] the loaded OutputGetLogo; raises BluefinTecsUserBackofficeError on failure

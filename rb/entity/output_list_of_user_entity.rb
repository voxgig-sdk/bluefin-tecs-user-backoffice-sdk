...
class OutputListOfUserEntity
  ...
  def make
    opts = @_entopts.dup
    OutputListOfUserEntity.new(@_client, opts)
  end
  ...
  # @return [OutputListOfUser, Hash] the current OutputListOfUser data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputListOfUser fields)
  def match_get
  ...
  #
  # @param reqdata [OutputListOfUserCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputListOfUser, Hash] the created OutputListOfUser; raises BluefinTecsUserBackofficeError on failure

...
class OutputCreateMandatorEntity
  ...
  def make
    opts = @_entopts.dup
    OutputCreateMandatorEntity.new(@_client, opts)
  end
  ...
  # @return [OutputCreateMandator, Hash] the current OutputCreateMandator data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputCreateMandator fields)
  def match_get
  ...
  #
  # @param reqdata [OutputCreateMandatorCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputCreateMandator, Hash] the created OutputCreateMandator; raises BluefinTecsUserBackofficeError on failure

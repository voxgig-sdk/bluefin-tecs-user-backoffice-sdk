...
class OutputListOfRoleGroupEntity
  ...
  def make
    opts = @_entopts.dup
    OutputListOfRoleGroupEntity.new(@_client, opts)
  end
  ...
  # @return [OutputListOfRoleGroup, Hash] the current OutputListOfRoleGroup data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OutputListOfRoleGroup fields)
  def match_get
  ...
  #
  # @param reqdata [OutputListOfRoleGroupCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OutputListOfRoleGroup, Hash] the created OutputListOfRoleGroup; raises BluefinTecsUserBackofficeError on failure

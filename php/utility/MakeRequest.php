...
// BluefinTecsUserBackoffice SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BluefinTecsUserBackofficeMakeRequest
{
    public static function call(BluefinTecsUserBackofficeContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BluefinTecsUserBackofficeResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BluefinTecsUserBackofficeResponse($fetched);
        } else {

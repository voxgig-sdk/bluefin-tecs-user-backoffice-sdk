...
class BluefinTecsUserBackofficeGraphql
{
    ...
    // equivalent.
    public static function body(BluefinTecsUserBackofficeContext $ctx): mixed
    {
    ...
    public static function errors(BluefinTecsUserBackofficeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

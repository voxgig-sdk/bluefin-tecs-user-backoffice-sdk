...
// BluefinTecsUserBackoffice SDK utility: result_basic

class BluefinTecsUserBackofficeResultBasic
{
    public static function call(BluefinTecsUserBackofficeContext $ctx): ?BluefinTecsUserBackofficeResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof BluefinTecsUserBackofficeError) ? $result->err->msg : (string)$result->err;

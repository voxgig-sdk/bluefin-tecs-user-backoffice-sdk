...
// BluefinTecsUserBackoffice SDK utility type

class BluefinTecsUserBackofficeUtility
{
    ...
    public static function copy(BluefinTecsUserBackofficeUtility $src): BluefinTecsUserBackofficeUtility
    {
        $u = new BluefinTecsUserBackofficeUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;

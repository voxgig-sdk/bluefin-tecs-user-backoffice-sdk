...
class OutputListOfRoleGroupEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_list_of_role_group";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputListOfRoleGroupEntity($this->_client, $opts);
    }

    /**
     * @param OutputListOfRoleGroup|array $args OutputListOfRoleGroup data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputListOfRoleGroup|array The current OutputListOfRoleGroup data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputListOfRoleGroup fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputListOfRoleGroup fields).
     */
     ...
     *
     * @param OutputListOfRoleGroupCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputListOfRoleGroupCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputListOfRoleGroup|array The created OutputListOfRoleGroup as an assoc-array at the

...
class OutputChangeLogoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OutputChangeLogoEntity($this->_client, $opts);
    }

    /**
     * @param OutputChangeLogo|array $args OutputChangeLogo data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputChangeLogo|array The current OutputChangeLogo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputChangeLogo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputChangeLogo fields).
     */
     ...
     *
     * @param OutputChangeLogoCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputChangeLogoCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputChangeLogo|array The created OutputChangeLogo as an assoc-array at the

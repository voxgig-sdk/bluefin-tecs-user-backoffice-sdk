...
class OutputListOfModuleEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_list_of_module";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputListOfModuleEntity($this->_client, $opts);
    }

    /**
     * @param OutputListOfModule|array $args OutputListOfModule data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputListOfModule|array The current OutputListOfModule data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputListOfModule fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputListOfModule fields).
     */
     ...
     *
     * @param OutputListOfModuleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputListOfModuleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputListOfModule|array The created OutputListOfModule as an assoc-array at the

...
class OutputUpdateConsumerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_update_consumer";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputUpdateConsumerEntity($this->_client, $opts);
    }

    /**
     * @param OutputUpdateConsumer|array $args OutputUpdateConsumer data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputUpdateConsumer|array The current OutputUpdateConsumer data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputUpdateConsumer fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputUpdateConsumer fields).
     */
     ...
     *
     * @param OutputUpdateConsumerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputUpdateConsumerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputUpdateConsumer|array The created OutputUpdateConsumer as an assoc-array at the

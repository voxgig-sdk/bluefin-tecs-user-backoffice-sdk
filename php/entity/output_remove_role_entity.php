...
class OutputRemoveRoleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OutputRemoveRoleEntity($this->_client, $opts);
    }

    /**
     * @param OutputRemoveRole|array $args OutputRemoveRole data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputRemoveRole|array The current OutputRemoveRole data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputRemoveRole fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputRemoveRole fields).
     */
     ...
     *
     * @param OutputRemoveRoleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputRemoveRoleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputRemoveRole|array The created OutputRemoveRole as an assoc-array at the

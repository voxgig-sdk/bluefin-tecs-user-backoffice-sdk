...
class OutputActivatePortalModuleEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_activate_portal_module";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputActivatePortalModuleEntity($this->_client, $opts);
    }

    /**
     * @param OutputActivatePortalModule|array $args OutputActivatePortalModule data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputActivatePortalModule|array The current OutputActivatePortalModule data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputActivatePortalModule fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputActivatePortalModule fields).
     */
     ...
     *
     * @param OutputActivatePortalModuleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputActivatePortalModuleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputActivatePortalModule|array The created OutputActivatePortalModule as an assoc-array at the

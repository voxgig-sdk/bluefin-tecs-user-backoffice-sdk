...
class OutputListOfTransactionsHistoryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_list_of_transactions_history";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputListOfTransactionsHistoryEntity($this->_client, $opts);
    }

    /**
     * @param OutputListOfTransactionsHistory|array $args OutputListOfTransactionsHistory data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = BluefinTecsUserBackofficeHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return OutputListOfTransactionsHistory|array The current OutputListOfTransactionsHistory data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputListOfTransactionsHistory fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = BluefinTecsUserBackofficeHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of OutputListOfTransactionsHistory fields).
     */
    ...
    /**
     * Create a new OutputListOfTransactionsHistory.
     *
     * @param OutputListOfTransactionsHistoryCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputListOfTransactionsHistoryCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputListOfTransactionsHistory|array The created OutputListOfTransactionsHistory as an assoc-array at the
     *   SDK boundary; throws BluefinTecsUserBackofficeError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                if ($ctx->result->resdata) {
                    $this->_data = BluefinTecsUserBackofficeHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }

...
class OutputCreateServiceUserEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_create_service_user";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputCreateServiceUserEntity($this->_client, $opts);
    }

    /**
     * @param OutputCreateServiceUser|array $args OutputCreateServiceUser data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputCreateServiceUser|array The current OutputCreateServiceUser data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputCreateServiceUser fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputCreateServiceUser fields).
     */
     ...
     *
     * @param OutputCreateServiceUserCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputCreateServiceUserCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputCreateServiceUser|array The created OutputCreateServiceUser as an assoc-array at the

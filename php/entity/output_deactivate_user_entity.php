...
class OutputDeactivateUserEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_deactivate_user";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputDeactivateUserEntity($this->_client, $opts);
    }

    /**
     * @param OutputDeactivateUser|array $args OutputDeactivateUser data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputDeactivateUser|array The current OutputDeactivateUser data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputDeactivateUser fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputDeactivateUser fields).
     */
     ...
     *
     * @param OutputDeactivateUserCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputDeactivateUserCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputDeactivateUser|array The created OutputDeactivateUser as an assoc-array at the

...
class OutputUpdateProfileEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_update_profile";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputUpdateProfileEntity($this->_client, $opts);
    }

    /**
     * @param OutputUpdateProfile|array $args OutputUpdateProfile data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputUpdateProfile|array The current OutputUpdateProfile data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputUpdateProfile fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputUpdateProfile fields).
     */
     ...
     *
     * @param OutputUpdateProfileCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputUpdateProfileCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputUpdateProfile|array The created OutputUpdateProfile as an assoc-array at the

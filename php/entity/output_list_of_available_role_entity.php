...
class OutputListOfAvailableRoleEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_list_of_available_role";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputListOfAvailableRoleEntity($this->_client, $opts);
    }

    /**
     * @param OutputListOfAvailableRole|array $args OutputListOfAvailableRole data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputListOfAvailableRole|array The current OutputListOfAvailableRole data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputListOfAvailableRole fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputListOfAvailableRole fields).
     */
     ...
     *
     * @param OutputListOfAvailableRoleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputListOfAvailableRoleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputListOfAvailableRole|array The created OutputListOfAvailableRole as an assoc-array at the

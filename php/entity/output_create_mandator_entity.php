...
class OutputCreateMandatorEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_create_mandator";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputCreateMandatorEntity($this->_client, $opts);
    }

    /**
     * @param OutputCreateMandator|array $args OutputCreateMandator data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputCreateMandator|array The current OutputCreateMandator data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputCreateMandator fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputCreateMandator fields).
     */
     ...
     *
     * @param OutputCreateMandatorCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputCreateMandatorCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputCreateMandator|array The created OutputCreateMandator as an assoc-array at the

...
class OutputActivateUserEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_activate_user";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputActivateUserEntity($this->_client, $opts);
    }

    /**
     * @param OutputActivateUser|array $args OutputActivateUser data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputActivateUser|array The current OutputActivateUser data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputActivateUser fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputActivateUser fields).
     */
     ...
     *
     * @param OutputActivateUserCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputActivateUserCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputActivateUser|array The created OutputActivateUser as an assoc-array at the

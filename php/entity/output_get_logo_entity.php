...
class OutputGetLogoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OutputGetLogoEntity($this->_client, $opts);
    }

    /**
     * @param OutputGetLogo|array $args OutputGetLogo data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputGetLogo|array The current OutputGetLogo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputGetLogo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputGetLogo fields).
     */
     ...
     *
     * @param OutputGetLogoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OutputGetLogoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputGetLogo|array The loaded OutputGetLogo as an assoc-array at the

...
class OutputListOfMandatorEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_list_of_mandator";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputListOfMandatorEntity($this->_client, $opts);
    }

    /**
     * @param OutputListOfMandator|array $args OutputListOfMandator data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputListOfMandator|array The current OutputListOfMandator data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputListOfMandator fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputListOfMandator fields).
     */
     ...
     *
     * @param OutputListOfMandatorCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputListOfMandatorCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputListOfMandator|array The created OutputListOfMandator as an assoc-array at the

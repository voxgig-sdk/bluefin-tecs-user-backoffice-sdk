...
class OutputListOfUserEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_list_of_user";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputListOfUserEntity($this->_client, $opts);
    }

    /**
     * @param OutputListOfUser|array $args OutputListOfUser data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputListOfUser|array The current OutputListOfUser data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputListOfUser fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputListOfUser fields).
     */
     ...
     *
     * @param OutputListOfUserCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputListOfUserCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputListOfUser|array The created OutputListOfUser as an assoc-array at the

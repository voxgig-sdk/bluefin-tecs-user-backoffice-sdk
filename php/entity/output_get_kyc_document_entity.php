...
class OutputGetKycDocumentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_get_kyc_document";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputGetKycDocumentEntity($this->_client, $opts);
    }

    /**
     * @param OutputGetKycDocument|array $args OutputGetKycDocument data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputGetKycDocument|array The current OutputGetKycDocument data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputGetKycDocument fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputGetKycDocument fields).
     */
     ...
     *
     * @param OutputGetKycDocumentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputGetKycDocumentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputGetKycDocument|array The created OutputGetKycDocument as an assoc-array at the

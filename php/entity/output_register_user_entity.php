...
class OutputRegisterUserEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_register_user";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputRegisterUserEntity($this->_client, $opts);
    }

    /**
     * @param OutputRegisterUser|array $args OutputRegisterUser data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputRegisterUser|array The current OutputRegisterUser data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputRegisterUser fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputRegisterUser fields).
     */
     ...
     *
     * @param OutputRegisterUserCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputRegisterUserCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputRegisterUser|array The created OutputRegisterUser as an assoc-array at the

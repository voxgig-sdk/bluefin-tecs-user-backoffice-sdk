...
class OutputActivateStoreModuleEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_activate_store_module";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputActivateStoreModuleEntity($this->_client, $opts);
    }

    /**
     * @param OutputActivateStoreModule|array $args OutputActivateStoreModule data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputActivateStoreModule|array The current OutputActivateStoreModule data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputActivateStoreModule fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputActivateStoreModule fields).
     */
     ...
     *
     * @param OutputActivateStoreModuleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputActivateStoreModuleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputActivateStoreModule|array The created OutputActivateStoreModule as an assoc-array at the

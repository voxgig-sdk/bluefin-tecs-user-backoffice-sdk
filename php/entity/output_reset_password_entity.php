...
class OutputResetPasswordEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_reset_password";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputResetPasswordEntity($this->_client, $opts);
    }

    /**
     * @param OutputResetPassword|array $args OutputResetPassword data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputResetPassword|array The current OutputResetPassword data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputResetPassword fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputResetPassword fields).
     */
     ...
     *
     * @param OutputResetPasswordCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputResetPasswordCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputResetPassword|array The created OutputResetPassword as an assoc-array at the

...
class OutputResendLinkEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OutputResendLinkEntity($this->_client, $opts);
    }

    /**
     * @param OutputResendLink|array $args OutputResendLink data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputResendLink|array The current OutputResendLink data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputResendLink fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputResendLink fields).
     */
     ...
     *
     * @param OutputResendLinkCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputResendLinkCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputResendLink|array The created OutputResendLink as an assoc-array at the

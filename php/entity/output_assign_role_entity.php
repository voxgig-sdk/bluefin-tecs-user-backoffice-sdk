...
class OutputAssignRoleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OutputAssignRoleEntity($this->_client, $opts);
    }

    /**
     * @param OutputAssignRole|array $args OutputAssignRole data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputAssignRole|array The current OutputAssignRole data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputAssignRole fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputAssignRole fields).
     */
     ...
     *
     * @param OutputAssignRoleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputAssignRoleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputAssignRole|array The created OutputAssignRole as an assoc-array at the

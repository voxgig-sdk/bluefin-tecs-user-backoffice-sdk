...
class OutputActivateDigitalModuleEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_activate_digital_module";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputActivateDigitalModuleEntity($this->_client, $opts);
    }

    /**
     * @param OutputActivateDigitalModule|array $args OutputActivateDigitalModule data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputActivateDigitalModule|array The current OutputActivateDigitalModule data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputActivateDigitalModule fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputActivateDigitalModule fields).
     */
     ...
     *
     * @param OutputActivateDigitalModuleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputActivateDigitalModuleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputActivateDigitalModule|array The created OutputActivateDigitalModule as an assoc-array at the

...
class OutputProvideCredentialEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "output_provide_credential";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OutputProvideCredentialEntity($this->_client, $opts);
    }

    /**
     * @param OutputProvideCredential|array $args OutputProvideCredential data (assoc-array) to store.
     */
    ...
    /**
     * @return OutputProvideCredential|array The current OutputProvideCredential data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OutputProvideCredential fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OutputProvideCredential fields).
     */
     ...
     *
     * @param OutputProvideCredentialCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OutputProvideCredentialCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OutputProvideCredential|array The created OutputProvideCredential as an assoc-array at the

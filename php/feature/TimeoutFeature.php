...
// BluefinTecsUserBackoffice SDK timeout feature
...
class BluefinTecsUserBackofficeTimeoutFeature extends BluefinTecsUserBackofficeBaseFeature
{
    ...
    private function _with_timeout(BluefinTecsUserBackofficeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BluefinTecsUserBackofficeContext $_ctx, float $ms): void
    {
        $client = $this->client;

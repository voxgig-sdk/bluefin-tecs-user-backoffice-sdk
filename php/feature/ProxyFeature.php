...
class BluefinTecsUserBackofficeProxyFeature extends BluefinTecsUserBackofficeBaseFeature
{
    ...
    public function init(BluefinTecsUserBackofficeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BluefinTecsUserBackofficeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

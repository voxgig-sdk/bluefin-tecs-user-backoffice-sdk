...
class BluefinTecsUserBackofficeMetricsFeature extends BluefinTecsUserBackofficeBaseFeature
{
    ...
    private function _record(BluefinTecsUserBackofficeContext $ctx, bool $ok): void
    {

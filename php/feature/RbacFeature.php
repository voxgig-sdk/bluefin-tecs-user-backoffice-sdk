...
// BluefinTecsUserBackoffice SDK rbac feature
...
class BluefinTecsUserBackofficeRbacFeature extends BluefinTecsUserBackofficeBaseFeature
{
    ...
    private function _required(BluefinTecsUserBackofficeContext $ctx): ?string
    {
    ...
    private function _reject(BluefinTecsUserBackofficeContext $ctx, string $required): void
    {
    ...
    private function _track(BluefinTecsUserBackofficeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

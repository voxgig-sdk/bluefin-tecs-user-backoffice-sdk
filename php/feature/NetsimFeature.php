...
// BluefinTecsUserBackoffice SDK netsim feature
...
class BluefinTecsUserBackofficeNetsimFeature extends BluefinTecsUserBackofficeBaseFeature
{
    ...
    private function _simulate(BluefinTecsUserBackofficeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BluefinTecsUserBackofficeContext $ctx, array $applied): void
    {
        $client = $this->client;

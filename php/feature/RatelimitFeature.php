...
// BluefinTecsUserBackoffice SDK ratelimit feature
...
class BluefinTecsUserBackofficeRatelimitFeature extends BluefinTecsUserBackofficeBaseFeature
{
    ...
    private function _acquire(BluefinTecsUserBackofficeContext $ctx): void
    {
    ...
    private function _track(BluefinTecsUserBackofficeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

...
class BluefinTecsUserBackofficeTelemetryFeature extends BluefinTecsUserBackofficeBaseFeature
{
    ...
    private function _close(BluefinTecsUserBackofficeContext $ctx, bool $ok): void
    {

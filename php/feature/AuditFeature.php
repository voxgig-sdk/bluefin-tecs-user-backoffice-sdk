...
class BluefinTecsUserBackofficeAuditFeature extends BluefinTecsUserBackofficeBaseFeature
{
    ...
    private function _emit(BluefinTecsUserBackofficeContext $ctx, string $outcome): void
    {

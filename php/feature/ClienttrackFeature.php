...
class BluefinTecsUserBackofficeClienttrackFeature extends BluefinTecsUserBackofficeBaseFeature
{
    ...
    public function PostConstruct(BluefinTecsUserBackofficeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BluefinTecsUserBackoffice-SDK';

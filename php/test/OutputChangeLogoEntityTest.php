...
class OutputChangeLogoEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_CHANGE_LOGO_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $output_change_logo_ref01_data = Helpers::to_map(is_object($output_change_logo_ref01_data_result) && method_exists($output_change_logo_ref01_data_result, 'data_get') ? $output_change_logo_ref01_data_result->data_get() : $output_change_logo_ref01_data_result);
...
function output_change_logo_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_CHANGE_LOGO_ENTID");

...
class OutputGetLogoDirectTest extends TestCase
{
    public function test_direct_load_output_get_logo(): void
    {
        $setup = output_get_logo_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-output_get_logo", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {

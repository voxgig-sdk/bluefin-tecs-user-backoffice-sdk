...
class OutputResetPasswordEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_RESET_PASSWORD_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function output_reset_password_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_RESET_PASSWORD_ENTID");

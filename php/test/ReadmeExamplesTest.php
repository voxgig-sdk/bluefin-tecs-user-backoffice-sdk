...
// BluefinTecsUserBackoffice SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BluefinTecsUserBackofficeSDK::test)
...
{
    private const SDK_CLASS = 'BluefinTecsUserBackofficeSDK';
    ...
    private const SDK_BASE = 'bluefintecsuserbackoffice_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../bluefintecsuserbackoffice_sdk.php';
        foreach ($this->phpBlocks() as $blk) {

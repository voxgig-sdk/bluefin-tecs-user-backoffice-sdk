...
const testSeed = `map[string]any{"entity": map[string]any{"output_activate_digital_module": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_activate_portal_module": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_activate_store_module": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_activate_user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_assign_role": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_change_logo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_create_mandator": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_create_service_user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_deactivate_user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_get_kyc_document": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_get_logo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_list_of_available_role": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_list_of_mandator": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_list_of_module": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_list_of_role_group": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_list_of_transactions_history": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_list_of_user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_provide_credential": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_register_user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_remove_role": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_resend_link": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_reset_password": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_update_consumer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "output_update_profile": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "version": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

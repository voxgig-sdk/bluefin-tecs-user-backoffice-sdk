...
func TestOutputGetLogoEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		outputGetLogoRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.output_get_logo")))
...
func output_get_logoBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_GET_LOGO_ENTID")
	...
	idmapResolved := core.ToMapAny(env["BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_GET_LOGO_ENTID"])

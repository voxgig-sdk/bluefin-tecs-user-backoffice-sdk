...
type OutputActivateUserEntity struct {
	name    string
...
func NewOutputActivateUserEntity(client *core.BluefinTecsUserBackofficeSDK, entopts map[string]any) *OutputActivateUserEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputActivateUserEntity) GetName() string { return e.name }
...
func (e *OutputActivateUserEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputActivateUserEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputActivateUserEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputActivateUserEntity(e.client, opts)
}

func (e *OutputActivateUserEntity) Data(args ...any) any {
...
func (e *OutputActivateUserEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputActivateUser; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputActivateUserEntity) DataTyped(data ...OutputActivateUser) OutputActivateUser {
	if len(data) > 0 {
		return typedFrom[OutputActivateUser](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputActivateUser](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputActivateUser (all fields
// optional at the wire level).
func (e *OutputActivateUserEntity) MatchTyped(match ...OutputActivateUser) OutputActivateUser {
	if len(match) > 0 {
		return typedFrom[OutputActivateUser](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputActivateUser](e.Match())
}
...
func (e *OutputActivateUserEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputActivateUserEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OutputActivateUserEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OutputActivateUserEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputActivateUserCreateData and returns an OutputActivateUser. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OutputActivateUserEntity) CreateTyped(reqdata OutputActivateUserCreateData, ctrl map[string]any) (OutputActivateUser, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OutputActivateUser{}, err
	}
	return typedFrom[OutputActivateUser](res), nil
}



func (e *OutputActivateUserEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputActivateUserEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputActivateUserEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

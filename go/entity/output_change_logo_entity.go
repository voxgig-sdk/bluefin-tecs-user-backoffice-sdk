...
type OutputChangeLogoEntity struct {
	name    string
...
func NewOutputChangeLogoEntity(client *core.BluefinTecsUserBackofficeSDK, entopts map[string]any) *OutputChangeLogoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputChangeLogoEntity) GetName() string { return e.name }
...
func (e *OutputChangeLogoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputChangeLogoEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputChangeLogoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputChangeLogoEntity(e.client, opts)
}

func (e *OutputChangeLogoEntity) Data(args ...any) any {
...
func (e *OutputChangeLogoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputChangeLogo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputChangeLogoEntity) DataTyped(data ...OutputChangeLogo) OutputChangeLogo {
	if len(data) > 0 {
		return typedFrom[OutputChangeLogo](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputChangeLogo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputChangeLogo (all fields
// optional at the wire level).
func (e *OutputChangeLogoEntity) MatchTyped(match ...OutputChangeLogo) OutputChangeLogo {
	if len(match) > 0 {
		return typedFrom[OutputChangeLogo](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputChangeLogo](e.Match())
}
...
func (e *OutputChangeLogoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputChangeLogoEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OutputChangeLogoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OutputChangeLogoEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputChangeLogoCreateData and returns an OutputChangeLogo. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OutputChangeLogoEntity) CreateTyped(reqdata OutputChangeLogoCreateData, ctrl map[string]any) (OutputChangeLogo, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OutputChangeLogo{}, err
	}
	return typedFrom[OutputChangeLogo](res), nil
}



func (e *OutputChangeLogoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputChangeLogoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputChangeLogoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

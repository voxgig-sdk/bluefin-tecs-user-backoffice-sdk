...
type OutputListOfModuleEntity struct {
	name    string
...
func NewOutputListOfModuleEntity(client *core.BluefinTecsUserBackofficeSDK, entopts map[string]any) *OutputListOfModuleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputListOfModuleEntity) GetName() string { return e.name }
...
func (e *OutputListOfModuleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputListOfModuleEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputListOfModuleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputListOfModuleEntity(e.client, opts)
}

func (e *OutputListOfModuleEntity) Data(args ...any) any {
...
func (e *OutputListOfModuleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputListOfModule; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputListOfModuleEntity) DataTyped(data ...OutputListOfModule) OutputListOfModule {
	if len(data) > 0 {
		return typedFrom[OutputListOfModule](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputListOfModule](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputListOfModule (all fields
// optional at the wire level).
func (e *OutputListOfModuleEntity) MatchTyped(match ...OutputListOfModule) OutputListOfModule {
	if len(match) > 0 {
		return typedFrom[OutputListOfModule](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputListOfModule](e.Match())
}
...
func (e *OutputListOfModuleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputListOfModuleEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OutputListOfModuleEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OutputListOfModuleEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputListOfModuleCreateData and returns an OutputListOfModule. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OutputListOfModuleEntity) CreateTyped(reqdata OutputListOfModuleCreateData, ctrl map[string]any) (OutputListOfModule, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OutputListOfModule{}, err
	}
	return typedFrom[OutputListOfModule](res), nil
}



func (e *OutputListOfModuleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputListOfModuleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputListOfModuleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

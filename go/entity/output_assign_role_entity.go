...
type OutputAssignRoleEntity struct {
	name    string
...
func NewOutputAssignRoleEntity(client *core.BluefinTecsUserBackofficeSDK, entopts map[string]any) *OutputAssignRoleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputAssignRoleEntity) GetName() string { return e.name }
...
func (e *OutputAssignRoleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputAssignRoleEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputAssignRoleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputAssignRoleEntity(e.client, opts)
}

func (e *OutputAssignRoleEntity) Data(args ...any) any {
...
func (e *OutputAssignRoleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputAssignRole; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputAssignRoleEntity) DataTyped(data ...OutputAssignRole) OutputAssignRole {
	if len(data) > 0 {
		return typedFrom[OutputAssignRole](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputAssignRole](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputAssignRole (all fields
// optional at the wire level).
func (e *OutputAssignRoleEntity) MatchTyped(match ...OutputAssignRole) OutputAssignRole {
	if len(match) > 0 {
		return typedFrom[OutputAssignRole](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputAssignRole](e.Match())
}
...
func (e *OutputAssignRoleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputAssignRoleEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OutputAssignRoleEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OutputAssignRoleEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputAssignRoleCreateData and returns an OutputAssignRole. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OutputAssignRoleEntity) CreateTyped(reqdata OutputAssignRoleCreateData, ctrl map[string]any) (OutputAssignRole, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OutputAssignRole{}, err
	}
	return typedFrom[OutputAssignRole](res), nil
}



func (e *OutputAssignRoleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputAssignRoleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputAssignRoleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

...
type OutputResendLinkEntity struct {
	name    string
...
func NewOutputResendLinkEntity(client *core.BluefinTecsUserBackofficeSDK, entopts map[string]any) *OutputResendLinkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputResendLinkEntity) GetName() string { return e.name }
...
func (e *OutputResendLinkEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputResendLinkEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputResendLinkEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputResendLinkEntity(e.client, opts)
}

func (e *OutputResendLinkEntity) Data(args ...any) any {
...
func (e *OutputResendLinkEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputResendLink; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputResendLinkEntity) DataTyped(data ...OutputResendLink) OutputResendLink {
	if len(data) > 0 {
		return typedFrom[OutputResendLink](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputResendLink](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputResendLink (all fields
// optional at the wire level).
func (e *OutputResendLinkEntity) MatchTyped(match ...OutputResendLink) OutputResendLink {
	if len(match) > 0 {
		return typedFrom[OutputResendLink](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputResendLink](e.Match())
}
...
func (e *OutputResendLinkEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputResendLinkEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OutputResendLinkEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OutputResendLinkEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputResendLinkCreateData and returns an OutputResendLink. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OutputResendLinkEntity) CreateTyped(reqdata OutputResendLinkCreateData, ctrl map[string]any) (OutputResendLink, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OutputResendLink{}, err
	}
	return typedFrom[OutputResendLink](res), nil
}



func (e *OutputResendLinkEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputResendLinkEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputResendLinkEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

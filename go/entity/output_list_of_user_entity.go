...
type OutputListOfUserEntity struct {
	name    string
...
func NewOutputListOfUserEntity(client *core.BluefinTecsUserBackofficeSDK, entopts map[string]any) *OutputListOfUserEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputListOfUserEntity) GetName() string { return e.name }
...
func (e *OutputListOfUserEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputListOfUserEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputListOfUserEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputListOfUserEntity(e.client, opts)
}

func (e *OutputListOfUserEntity) Data(args ...any) any {
...
func (e *OutputListOfUserEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputListOfUser; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputListOfUserEntity) DataTyped(data ...OutputListOfUser) OutputListOfUser {
	if len(data) > 0 {
		return typedFrom[OutputListOfUser](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputListOfUser](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputListOfUser (all fields
// optional at the wire level).
func (e *OutputListOfUserEntity) MatchTyped(match ...OutputListOfUser) OutputListOfUser {
	if len(match) > 0 {
		return typedFrom[OutputListOfUser](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputListOfUser](e.Match())
}
...
func (e *OutputListOfUserEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputListOfUserEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OutputListOfUserEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OutputListOfUserEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputListOfUserCreateData and returns an OutputListOfUser. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OutputListOfUserEntity) CreateTyped(reqdata OutputListOfUserCreateData, ctrl map[string]any) (OutputListOfUser, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OutputListOfUser{}, err
	}
	return typedFrom[OutputListOfUser](res), nil
}



func (e *OutputListOfUserEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputListOfUserEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputListOfUserEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

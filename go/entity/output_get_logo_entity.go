...
type OutputGetLogoEntity struct {
	name    string
...
func NewOutputGetLogoEntity(client *core.BluefinTecsUserBackofficeSDK, entopts map[string]any) *OutputGetLogoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputGetLogoEntity) GetName() string { return e.name }
...
func (e *OutputGetLogoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputGetLogoEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputGetLogoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputGetLogoEntity(e.client, opts)
}

func (e *OutputGetLogoEntity) Data(args ...any) any {
...
func (e *OutputGetLogoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputGetLogo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputGetLogoEntity) DataTyped(data ...OutputGetLogo) OutputGetLogo {
	if len(data) > 0 {
		return typedFrom[OutputGetLogo](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputGetLogo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputGetLogo (all fields
// optional at the wire level).
func (e *OutputGetLogoEntity) MatchTyped(match ...OutputGetLogo) OutputGetLogo {
	if len(match) > 0 {
		return typedFrom[OutputGetLogo](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputGetLogo](e.Match())
}
...
func (e *OutputGetLogoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputGetLogoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputGetLogoLoadMatch and returns an OutputGetLogo. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OutputGetLogoEntity) LoadTyped(reqmatch OutputGetLogoLoadMatch, ctrl map[string]any) (OutputGetLogo, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return OutputGetLogo{}, err
	}
	return typedFrom[OutputGetLogo](res), nil
}



func (e *OutputGetLogoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OutputGetLogoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OutputGetLogoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputGetLogoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputGetLogoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

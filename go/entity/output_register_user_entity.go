...
type OutputRegisterUserEntity struct {
	name    string
...
func NewOutputRegisterUserEntity(client *core.BluefinTecsUserBackofficeSDK, entopts map[string]any) *OutputRegisterUserEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputRegisterUserEntity) GetName() string { return e.name }
...
func (e *OutputRegisterUserEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputRegisterUserEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputRegisterUserEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputRegisterUserEntity(e.client, opts)
}

func (e *OutputRegisterUserEntity) Data(args ...any) any {
...
func (e *OutputRegisterUserEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputRegisterUser; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputRegisterUserEntity) DataTyped(data ...OutputRegisterUser) OutputRegisterUser {
	if len(data) > 0 {
		return typedFrom[OutputRegisterUser](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputRegisterUser](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputRegisterUser (all fields
// optional at the wire level).
func (e *OutputRegisterUserEntity) MatchTyped(match ...OutputRegisterUser) OutputRegisterUser {
	if len(match) > 0 {
		return typedFrom[OutputRegisterUser](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputRegisterUser](e.Match())
}
...
func (e *OutputRegisterUserEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputRegisterUserEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OutputRegisterUserEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OutputRegisterUserEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputRegisterUserCreateData and returns an OutputRegisterUser. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OutputRegisterUserEntity) CreateTyped(reqdata OutputRegisterUserCreateData, ctrl map[string]any) (OutputRegisterUser, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OutputRegisterUser{}, err
	}
	return typedFrom[OutputRegisterUser](res), nil
}



func (e *OutputRegisterUserEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputRegisterUserEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputRegisterUserEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

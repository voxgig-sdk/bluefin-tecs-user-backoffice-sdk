...
type OutputRemoveRoleEntity struct {
	name    string
...
func NewOutputRemoveRoleEntity(client *core.BluefinTecsUserBackofficeSDK, entopts map[string]any) *OutputRemoveRoleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutputRemoveRoleEntity) GetName() string { return e.name }
...
func (e *OutputRemoveRoleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutputRemoveRoleEntity) Deleted() bool {
	return e.deleted
}


func (e *OutputRemoveRoleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutputRemoveRoleEntity(e.client, opts)
}

func (e *OutputRemoveRoleEntity) Data(args ...any) any {
...
func (e *OutputRemoveRoleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OutputRemoveRole; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutputRemoveRoleEntity) DataTyped(data ...OutputRemoveRole) OutputRemoveRole {
	if len(data) > 0 {
		return typedFrom[OutputRemoveRole](e.Data(asMap(data[0])))
	}
	return typedFrom[OutputRemoveRole](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OutputRemoveRole (all fields
// optional at the wire level).
func (e *OutputRemoveRoleEntity) MatchTyped(match ...OutputRemoveRole) OutputRemoveRole {
	if len(match) > 0 {
		return typedFrom[OutputRemoveRole](e.Match(asMap(match[0])))
	}
	return typedFrom[OutputRemoveRole](e.Match())
}
...
func (e *OutputRemoveRoleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutputRemoveRoleEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OutputRemoveRoleEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OutputRemoveRoleEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutputRemoveRoleCreateData and returns an OutputRemoveRole. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OutputRemoveRoleEntity) CreateTyped(reqdata OutputRemoveRoleCreateData, ctrl map[string]any) (OutputRemoveRole, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OutputRemoveRole{}, err
	}
	return typedFrom[OutputRemoveRole](res), nil
}



func (e *OutputRemoveRoleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutputRemoveRoleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutputRemoveRoleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

...
import "github.com/voxgig-sdk/bluefin-tecs-user-backoffice-sdk/go/core"
...
func makeErrorUtil(ctx *core.Context, err error) (any, error) {
	...
	sdkErr := &core.BluefinTecsUserBackofficeError{
	...
	if se, ok := err.(*core.BluefinTecsUserBackofficeError); ok {
		sdkErr.Code = se.Code
	}

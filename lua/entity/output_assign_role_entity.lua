...
local OutputAssignRoleEntity = {}
OutputAssignRoleEntity.__index = OutputAssignRoleEntity


function OutputAssignRoleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputAssignRoleEntity)
  self._name = "output_assign_role"
  self._client = client
...
function OutputAssignRoleEntity:get_name()
  return self._name
end


function OutputAssignRoleEntity:make()
  local opts = {}
...
function OutputAssignRoleEntity:mark_deleted()
  self._deleted = true
end


function OutputAssignRoleEntity:deleted()
  return true == self._deleted
end


function OutputAssignRoleEntity:data_set(args)
  if args ~= nil then
...
function OutputAssignRoleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputAssignRoleEntity:match_set(args)
  if args ~= nil then
...
function OutputAssignRoleEntity:match_get()
...
function OutputAssignRoleEntity:stream(action, args, callopts)
...
---@param reqdata OutputAssignRoleCreateData
---@param ctrl? table
---@return OutputAssignRole
---@return string? err
function OutputAssignRoleEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputAssignRoleEntity:_run_op(ctx, post_done)
  local utility = self._utility

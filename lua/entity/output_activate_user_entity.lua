...
local OutputActivateUserEntity = {}
OutputActivateUserEntity.__index = OutputActivateUserEntity


function OutputActivateUserEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputActivateUserEntity)
  self._name = "output_activate_user"
  self._client = client
...
function OutputActivateUserEntity:get_name()
  return self._name
end


function OutputActivateUserEntity:make()
  local opts = {}
...
function OutputActivateUserEntity:mark_deleted()
  self._deleted = true
end


function OutputActivateUserEntity:deleted()
  return true == self._deleted
end


function OutputActivateUserEntity:data_set(args)
  if args ~= nil then
...
function OutputActivateUserEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputActivateUserEntity:match_set(args)
  if args ~= nil then
...
function OutputActivateUserEntity:match_get()
...
function OutputActivateUserEntity:stream(action, args, callopts)
...
---@param reqdata OutputActivateUserCreateData
---@param ctrl? table
---@return OutputActivateUser
---@return string? err
function OutputActivateUserEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputActivateUserEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputActivateUserEntity

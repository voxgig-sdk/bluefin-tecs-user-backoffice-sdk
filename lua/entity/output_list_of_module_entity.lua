...
local OutputListOfModuleEntity = {}
OutputListOfModuleEntity.__index = OutputListOfModuleEntity


function OutputListOfModuleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputListOfModuleEntity)
  self._name = "output_list_of_module"
  self._client = client
...
function OutputListOfModuleEntity:get_name()
  return self._name
end


function OutputListOfModuleEntity:make()
  local opts = {}
...
function OutputListOfModuleEntity:mark_deleted()
  self._deleted = true
end


function OutputListOfModuleEntity:deleted()
  return true == self._deleted
end


function OutputListOfModuleEntity:data_set(args)
  if args ~= nil then
...
function OutputListOfModuleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputListOfModuleEntity:match_set(args)
  if args ~= nil then
...
function OutputListOfModuleEntity:match_get()
...
function OutputListOfModuleEntity:stream(action, args, callopts)
...
---@param reqdata OutputListOfModuleCreateData
---@param ctrl? table
---@return OutputListOfModule
---@return string? err
function OutputListOfModuleEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputListOfModuleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputListOfModuleEntity

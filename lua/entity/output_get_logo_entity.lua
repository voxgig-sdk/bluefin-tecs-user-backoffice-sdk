...
local OutputGetLogoEntity = {}
OutputGetLogoEntity.__index = OutputGetLogoEntity


function OutputGetLogoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputGetLogoEntity)
  self._name = "output_get_logo"
  self._client = client
...
function OutputGetLogoEntity:get_name()
  return self._name
end


function OutputGetLogoEntity:make()
  local opts = {}
...
function OutputGetLogoEntity:mark_deleted()
  self._deleted = true
end


function OutputGetLogoEntity:deleted()
  return true == self._deleted
end


function OutputGetLogoEntity:data_set(args)
  if args ~= nil then
...
function OutputGetLogoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputGetLogoEntity:match_set(args)
  if args ~= nil then
...
function OutputGetLogoEntity:match_get()
...
function OutputGetLogoEntity:stream(action, args, callopts)
...
---@param reqmatch OutputGetLogoLoadMatch
---@param ctrl? table
---@return OutputGetLogo
---@return string? err
function OutputGetLogoEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function OutputGetLogoEntity:_run_op(ctx, post_done)
  local utility = self._utility

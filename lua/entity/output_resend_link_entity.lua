...
local OutputResendLinkEntity = {}
OutputResendLinkEntity.__index = OutputResendLinkEntity


function OutputResendLinkEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputResendLinkEntity)
  self._name = "output_resend_link"
  self._client = client
...
function OutputResendLinkEntity:get_name()
  return self._name
end


function OutputResendLinkEntity:make()
  local opts = {}
...
function OutputResendLinkEntity:mark_deleted()
  self._deleted = true
end


function OutputResendLinkEntity:deleted()
  return true == self._deleted
end


function OutputResendLinkEntity:data_set(args)
  if args ~= nil then
...
function OutputResendLinkEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputResendLinkEntity:match_set(args)
  if args ~= nil then
...
function OutputResendLinkEntity:match_get()
...
function OutputResendLinkEntity:stream(action, args, callopts)
...
---@param reqdata OutputResendLinkCreateData
---@param ctrl? table
---@return OutputResendLink
---@return string? err
function OutputResendLinkEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputResendLinkEntity:_run_op(ctx, post_done)
  local utility = self._utility

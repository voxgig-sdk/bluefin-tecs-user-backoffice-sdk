...
local OutputProvideCredentialEntity = {}
OutputProvideCredentialEntity.__index = OutputProvideCredentialEntity


function OutputProvideCredentialEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputProvideCredentialEntity)
  self._name = "output_provide_credential"
  self._client = client
...
function OutputProvideCredentialEntity:get_name()
  return self._name
end


function OutputProvideCredentialEntity:make()
  local opts = {}
...
function OutputProvideCredentialEntity:mark_deleted()
  self._deleted = true
end


function OutputProvideCredentialEntity:deleted()
  return true == self._deleted
end


function OutputProvideCredentialEntity:data_set(args)
  if args ~= nil then
...
function OutputProvideCredentialEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputProvideCredentialEntity:match_set(args)
  if args ~= nil then
...
function OutputProvideCredentialEntity:match_get()
...
function OutputProvideCredentialEntity:stream(action, args, callopts)
...
---@param reqdata OutputProvideCredentialCreateData
---@param ctrl? table
---@return OutputProvideCredential
---@return string? err
function OutputProvideCredentialEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputProvideCredentialEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputProvideCredentialEntity

...
local OutputListOfMandatorEntity = {}
OutputListOfMandatorEntity.__index = OutputListOfMandatorEntity


function OutputListOfMandatorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputListOfMandatorEntity)
  self._name = "output_list_of_mandator"
  self._client = client
...
function OutputListOfMandatorEntity:get_name()
  return self._name
end


function OutputListOfMandatorEntity:make()
  local opts = {}
...
function OutputListOfMandatorEntity:mark_deleted()
  self._deleted = true
end


function OutputListOfMandatorEntity:deleted()
  return true == self._deleted
end


function OutputListOfMandatorEntity:data_set(args)
  if args ~= nil then
...
function OutputListOfMandatorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputListOfMandatorEntity:match_set(args)
  if args ~= nil then
...
function OutputListOfMandatorEntity:match_get()
...
function OutputListOfMandatorEntity:stream(action, args, callopts)
...
---@param reqdata OutputListOfMandatorCreateData
---@param ctrl? table
---@return OutputListOfMandator
---@return string? err
function OutputListOfMandatorEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputListOfMandatorEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputListOfMandatorEntity

...
local OutputActivateStoreModuleEntity = {}
OutputActivateStoreModuleEntity.__index = OutputActivateStoreModuleEntity


function OutputActivateStoreModuleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputActivateStoreModuleEntity)
  self._name = "output_activate_store_module"
  self._client = client
...
function OutputActivateStoreModuleEntity:get_name()
  return self._name
end


function OutputActivateStoreModuleEntity:make()
  local opts = {}
...
function OutputActivateStoreModuleEntity:mark_deleted()
  self._deleted = true
end


function OutputActivateStoreModuleEntity:deleted()
  return true == self._deleted
end


function OutputActivateStoreModuleEntity:data_set(args)
  if args ~= nil then
...
function OutputActivateStoreModuleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputActivateStoreModuleEntity:match_set(args)
  if args ~= nil then
...
function OutputActivateStoreModuleEntity:match_get()
...
function OutputActivateStoreModuleEntity:stream(action, args, callopts)
...
---@param reqdata OutputActivateStoreModuleCreateData
---@param ctrl? table
---@return OutputActivateStoreModule
---@return string? err
function OutputActivateStoreModuleEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputActivateStoreModuleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputActivateStoreModuleEntity

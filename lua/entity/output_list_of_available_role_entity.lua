...
local OutputListOfAvailableRoleEntity = {}
OutputListOfAvailableRoleEntity.__index = OutputListOfAvailableRoleEntity


function OutputListOfAvailableRoleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputListOfAvailableRoleEntity)
  self._name = "output_list_of_available_role"
  self._client = client
...
function OutputListOfAvailableRoleEntity:get_name()
  return self._name
end


function OutputListOfAvailableRoleEntity:make()
  local opts = {}
...
function OutputListOfAvailableRoleEntity:mark_deleted()
  self._deleted = true
end


function OutputListOfAvailableRoleEntity:deleted()
  return true == self._deleted
end


function OutputListOfAvailableRoleEntity:data_set(args)
  if args ~= nil then
...
function OutputListOfAvailableRoleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputListOfAvailableRoleEntity:match_set(args)
  if args ~= nil then
...
function OutputListOfAvailableRoleEntity:match_get()
...
function OutputListOfAvailableRoleEntity:stream(action, args, callopts)
...
---@param reqdata OutputListOfAvailableRoleCreateData
---@param ctrl? table
---@return OutputListOfAvailableRole
---@return string? err
function OutputListOfAvailableRoleEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputListOfAvailableRoleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputListOfAvailableRoleEntity

...
local OutputRemoveRoleEntity = {}
OutputRemoveRoleEntity.__index = OutputRemoveRoleEntity


function OutputRemoveRoleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputRemoveRoleEntity)
  self._name = "output_remove_role"
  self._client = client
...
function OutputRemoveRoleEntity:get_name()
  return self._name
end


function OutputRemoveRoleEntity:make()
  local opts = {}
...
function OutputRemoveRoleEntity:mark_deleted()
  self._deleted = true
end


function OutputRemoveRoleEntity:deleted()
  return true == self._deleted
end


function OutputRemoveRoleEntity:data_set(args)
  if args ~= nil then
...
function OutputRemoveRoleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputRemoveRoleEntity:match_set(args)
  if args ~= nil then
...
function OutputRemoveRoleEntity:match_get()
...
function OutputRemoveRoleEntity:stream(action, args, callopts)
...
---@param reqdata OutputRemoveRoleCreateData
---@param ctrl? table
---@return OutputRemoveRole
---@return string? err
function OutputRemoveRoleEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputRemoveRoleEntity:_run_op(ctx, post_done)
  local utility = self._utility

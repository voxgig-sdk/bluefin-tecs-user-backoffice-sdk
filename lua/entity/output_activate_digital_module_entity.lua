...
local OutputActivateDigitalModuleEntity = {}
OutputActivateDigitalModuleEntity.__index = OutputActivateDigitalModuleEntity


function OutputActivateDigitalModuleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputActivateDigitalModuleEntity)
  self._name = "output_activate_digital_module"
  self._client = client
...
function OutputActivateDigitalModuleEntity:get_name()
  return self._name
end


function OutputActivateDigitalModuleEntity:make()
  local opts = {}
...
function OutputActivateDigitalModuleEntity:mark_deleted()
  self._deleted = true
end


function OutputActivateDigitalModuleEntity:deleted()
  return true == self._deleted
end


function OutputActivateDigitalModuleEntity:data_set(args)
  if args ~= nil then
...
function OutputActivateDigitalModuleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputActivateDigitalModuleEntity:match_set(args)
  if args ~= nil then
...
function OutputActivateDigitalModuleEntity:match_get()
...
function OutputActivateDigitalModuleEntity:stream(action, args, callopts)
...
---@param reqdata OutputActivateDigitalModuleCreateData
---@param ctrl? table
---@return OutputActivateDigitalModule
---@return string? err
function OutputActivateDigitalModuleEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputActivateDigitalModuleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputActivateDigitalModuleEntity

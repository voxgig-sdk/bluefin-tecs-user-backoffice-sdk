-- BluefinTecsUserBackoffice SDK OutputListOfTransactionsHistory entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OutputListOfTransactionsHistoryEntity = {}
OutputListOfTransactionsHistoryEntity.__index = OutputListOfTransactionsHistoryEntity


function OutputListOfTransactionsHistoryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputListOfTransactionsHistoryEntity)
  self._name = "output_list_of_transactions_history"
  self._client = client
...
function OutputListOfTransactionsHistoryEntity:get_name()
  return self._name
end


function OutputListOfTransactionsHistoryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OutputListOfTransactionsHistoryEntity.new(self._client, opts)
end
...
function OutputListOfTransactionsHistoryEntity:mark_deleted()
  self._deleted = true
end


function OutputListOfTransactionsHistoryEntity:deleted()
  return true == self._deleted
end


function OutputListOfTransactionsHistoryEntity:data_set(args)
  if args ~= nil then
...
function OutputListOfTransactionsHistoryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputListOfTransactionsHistoryEntity:match_set(args)
  if args ~= nil then
...
function OutputListOfTransactionsHistoryEntity:match_get()
...
function OutputListOfTransactionsHistoryEntity:stream(action, args, callopts)
...
---@param reqdata OutputListOfTransactionsHistoryCreateData
---@param ctrl? table
---@return OutputListOfTransactionsHistory
---@return string? err
function OutputListOfTransactionsHistoryEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputListOfTransactionsHistoryEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputListOfTransactionsHistoryEntity

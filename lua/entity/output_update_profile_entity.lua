...
local OutputUpdateProfileEntity = {}
OutputUpdateProfileEntity.__index = OutputUpdateProfileEntity


function OutputUpdateProfileEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputUpdateProfileEntity)
  self._name = "output_update_profile"
  self._client = client
...
function OutputUpdateProfileEntity:get_name()
  return self._name
end


function OutputUpdateProfileEntity:make()
  local opts = {}
...
function OutputUpdateProfileEntity:mark_deleted()
  self._deleted = true
end


function OutputUpdateProfileEntity:deleted()
  return true == self._deleted
end


function OutputUpdateProfileEntity:data_set(args)
  if args ~= nil then
...
function OutputUpdateProfileEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputUpdateProfileEntity:match_set(args)
  if args ~= nil then
...
function OutputUpdateProfileEntity:match_get()
...
function OutputUpdateProfileEntity:stream(action, args, callopts)
...
---@param reqdata OutputUpdateProfileCreateData
---@param ctrl? table
---@return OutputUpdateProfile
---@return string? err
function OutputUpdateProfileEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputUpdateProfileEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputUpdateProfileEntity

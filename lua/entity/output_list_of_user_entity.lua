...
local OutputListOfUserEntity = {}
OutputListOfUserEntity.__index = OutputListOfUserEntity


function OutputListOfUserEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputListOfUserEntity)
  self._name = "output_list_of_user"
  self._client = client
...
function OutputListOfUserEntity:get_name()
  return self._name
end


function OutputListOfUserEntity:make()
  local opts = {}
...
function OutputListOfUserEntity:mark_deleted()
  self._deleted = true
end


function OutputListOfUserEntity:deleted()
  return true == self._deleted
end


function OutputListOfUserEntity:data_set(args)
  if args ~= nil then
...
function OutputListOfUserEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputListOfUserEntity:match_set(args)
  if args ~= nil then
...
function OutputListOfUserEntity:match_get()
...
function OutputListOfUserEntity:stream(action, args, callopts)
...
---@param reqdata OutputListOfUserCreateData
---@param ctrl? table
---@return OutputListOfUser
---@return string? err
function OutputListOfUserEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputListOfUserEntity:_run_op(ctx, post_done)
  local utility = self._utility

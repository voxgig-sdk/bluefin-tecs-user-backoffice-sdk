...
local OutputCreateMandatorEntity = {}
OutputCreateMandatorEntity.__index = OutputCreateMandatorEntity


function OutputCreateMandatorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputCreateMandatorEntity)
  self._name = "output_create_mandator"
  self._client = client
...
function OutputCreateMandatorEntity:get_name()
  return self._name
end


function OutputCreateMandatorEntity:make()
  local opts = {}
...
function OutputCreateMandatorEntity:mark_deleted()
  self._deleted = true
end


function OutputCreateMandatorEntity:deleted()
  return true == self._deleted
end


function OutputCreateMandatorEntity:data_set(args)
  if args ~= nil then
...
function OutputCreateMandatorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputCreateMandatorEntity:match_set(args)
  if args ~= nil then
...
function OutputCreateMandatorEntity:match_get()
...
function OutputCreateMandatorEntity:stream(action, args, callopts)
...
---@param reqdata OutputCreateMandatorCreateData
---@param ctrl? table
---@return OutputCreateMandator
---@return string? err
function OutputCreateMandatorEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputCreateMandatorEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputCreateMandatorEntity

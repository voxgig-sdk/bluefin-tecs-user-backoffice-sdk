...
local OutputChangeLogoEntity = {}
OutputChangeLogoEntity.__index = OutputChangeLogoEntity


function OutputChangeLogoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputChangeLogoEntity)
  self._name = "output_change_logo"
  self._client = client
...
function OutputChangeLogoEntity:get_name()
  return self._name
end


function OutputChangeLogoEntity:make()
  local opts = {}
...
function OutputChangeLogoEntity:mark_deleted()
  self._deleted = true
end


function OutputChangeLogoEntity:deleted()
  return true == self._deleted
end


function OutputChangeLogoEntity:data_set(args)
  if args ~= nil then
...
function OutputChangeLogoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputChangeLogoEntity:match_set(args)
  if args ~= nil then
...
function OutputChangeLogoEntity:match_get()
...
function OutputChangeLogoEntity:stream(action, args, callopts)
...
---@param reqdata OutputChangeLogoCreateData
---@param ctrl? table
---@return OutputChangeLogo
---@return string? err
function OutputChangeLogoEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputChangeLogoEntity:_run_op(ctx, post_done)
  local utility = self._utility

...
local OutputResetPasswordEntity = {}
OutputResetPasswordEntity.__index = OutputResetPasswordEntity


function OutputResetPasswordEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputResetPasswordEntity)
  self._name = "output_reset_password"
  self._client = client
...
function OutputResetPasswordEntity:get_name()
  return self._name
end


function OutputResetPasswordEntity:make()
  local opts = {}
...
function OutputResetPasswordEntity:mark_deleted()
  self._deleted = true
end


function OutputResetPasswordEntity:deleted()
  return true == self._deleted
end


function OutputResetPasswordEntity:data_set(args)
  if args ~= nil then
...
function OutputResetPasswordEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputResetPasswordEntity:match_set(args)
  if args ~= nil then
...
function OutputResetPasswordEntity:match_get()
...
function OutputResetPasswordEntity:stream(action, args, callopts)
...
---@param reqdata OutputResetPasswordCreateData
---@param ctrl? table
---@return OutputResetPassword
---@return string? err
function OutputResetPasswordEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputResetPasswordEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputResetPasswordEntity

...
local OutputUpdateConsumerEntity = {}
OutputUpdateConsumerEntity.__index = OutputUpdateConsumerEntity


function OutputUpdateConsumerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputUpdateConsumerEntity)
  self._name = "output_update_consumer"
  self._client = client
...
function OutputUpdateConsumerEntity:get_name()
  return self._name
end


function OutputUpdateConsumerEntity:make()
  local opts = {}
...
function OutputUpdateConsumerEntity:mark_deleted()
  self._deleted = true
end


function OutputUpdateConsumerEntity:deleted()
  return true == self._deleted
end


function OutputUpdateConsumerEntity:data_set(args)
  if args ~= nil then
...
function OutputUpdateConsumerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputUpdateConsumerEntity:match_set(args)
  if args ~= nil then
...
function OutputUpdateConsumerEntity:match_get()
...
function OutputUpdateConsumerEntity:stream(action, args, callopts)
...
---@param reqdata OutputUpdateConsumerCreateData
---@param ctrl? table
---@return OutputUpdateConsumer
---@return string? err
function OutputUpdateConsumerEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputUpdateConsumerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputUpdateConsumerEntity

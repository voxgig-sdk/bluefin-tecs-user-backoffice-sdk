...
local OutputCreateServiceUserEntity = {}
OutputCreateServiceUserEntity.__index = OutputCreateServiceUserEntity


function OutputCreateServiceUserEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputCreateServiceUserEntity)
  self._name = "output_create_service_user"
  self._client = client
...
function OutputCreateServiceUserEntity:get_name()
  return self._name
end


function OutputCreateServiceUserEntity:make()
  local opts = {}
...
function OutputCreateServiceUserEntity:mark_deleted()
  self._deleted = true
end


function OutputCreateServiceUserEntity:deleted()
  return true == self._deleted
end


function OutputCreateServiceUserEntity:data_set(args)
  if args ~= nil then
...
function OutputCreateServiceUserEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputCreateServiceUserEntity:match_set(args)
  if args ~= nil then
...
function OutputCreateServiceUserEntity:match_get()
...
function OutputCreateServiceUserEntity:stream(action, args, callopts)
...
---@param reqdata OutputCreateServiceUserCreateData
---@param ctrl? table
---@return OutputCreateServiceUser
---@return string? err
function OutputCreateServiceUserEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputCreateServiceUserEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputCreateServiceUserEntity

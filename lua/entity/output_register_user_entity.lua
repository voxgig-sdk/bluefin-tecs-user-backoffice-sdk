...
local OutputRegisterUserEntity = {}
OutputRegisterUserEntity.__index = OutputRegisterUserEntity


function OutputRegisterUserEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputRegisterUserEntity)
  self._name = "output_register_user"
  self._client = client
...
function OutputRegisterUserEntity:get_name()
  return self._name
end


function OutputRegisterUserEntity:make()
  local opts = {}
...
function OutputRegisterUserEntity:mark_deleted()
  self._deleted = true
end


function OutputRegisterUserEntity:deleted()
  return true == self._deleted
end


function OutputRegisterUserEntity:data_set(args)
  if args ~= nil then
...
function OutputRegisterUserEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputRegisterUserEntity:match_set(args)
  if args ~= nil then
...
function OutputRegisterUserEntity:match_get()
...
function OutputRegisterUserEntity:stream(action, args, callopts)
...
---@param reqdata OutputRegisterUserCreateData
---@param ctrl? table
---@return OutputRegisterUser
---@return string? err
function OutputRegisterUserEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputRegisterUserEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputRegisterUserEntity

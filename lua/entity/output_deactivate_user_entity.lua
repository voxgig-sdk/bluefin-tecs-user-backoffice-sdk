...
local OutputDeactivateUserEntity = {}
OutputDeactivateUserEntity.__index = OutputDeactivateUserEntity


function OutputDeactivateUserEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputDeactivateUserEntity)
  self._name = "output_deactivate_user"
  self._client = client
...
function OutputDeactivateUserEntity:get_name()
  return self._name
end


function OutputDeactivateUserEntity:make()
  local opts = {}
...
function OutputDeactivateUserEntity:mark_deleted()
  self._deleted = true
end


function OutputDeactivateUserEntity:deleted()
  return true == self._deleted
end


function OutputDeactivateUserEntity:data_set(args)
  if args ~= nil then
...
function OutputDeactivateUserEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputDeactivateUserEntity:match_set(args)
  if args ~= nil then
...
function OutputDeactivateUserEntity:match_get()
...
function OutputDeactivateUserEntity:stream(action, args, callopts)
...
---@param reqdata OutputDeactivateUserCreateData
---@param ctrl? table
---@return OutputDeactivateUser
---@return string? err
function OutputDeactivateUserEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputDeactivateUserEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputDeactivateUserEntity

...
local OutputGetKycDocumentEntity = {}
OutputGetKycDocumentEntity.__index = OutputGetKycDocumentEntity


function OutputGetKycDocumentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputGetKycDocumentEntity)
  self._name = "output_get_kyc_document"
  self._client = client
...
function OutputGetKycDocumentEntity:get_name()
  return self._name
end


function OutputGetKycDocumentEntity:make()
  local opts = {}
...
function OutputGetKycDocumentEntity:mark_deleted()
  self._deleted = true
end


function OutputGetKycDocumentEntity:deleted()
  return true == self._deleted
end


function OutputGetKycDocumentEntity:data_set(args)
  if args ~= nil then
...
function OutputGetKycDocumentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputGetKycDocumentEntity:match_set(args)
  if args ~= nil then
...
function OutputGetKycDocumentEntity:match_get()
...
function OutputGetKycDocumentEntity:stream(action, args, callopts)
...
---@param reqdata OutputGetKycDocumentCreateData
---@param ctrl? table
---@return OutputGetKycDocument
---@return string? err
function OutputGetKycDocumentEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputGetKycDocumentEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputGetKycDocumentEntity

...
local OutputListOfRoleGroupEntity = {}
OutputListOfRoleGroupEntity.__index = OutputListOfRoleGroupEntity


function OutputListOfRoleGroupEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputListOfRoleGroupEntity)
  self._name = "output_list_of_role_group"
  self._client = client
...
function OutputListOfRoleGroupEntity:get_name()
  return self._name
end


function OutputListOfRoleGroupEntity:make()
  local opts = {}
...
function OutputListOfRoleGroupEntity:mark_deleted()
  self._deleted = true
end


function OutputListOfRoleGroupEntity:deleted()
  return true == self._deleted
end


function OutputListOfRoleGroupEntity:data_set(args)
  if args ~= nil then
...
function OutputListOfRoleGroupEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputListOfRoleGroupEntity:match_set(args)
  if args ~= nil then
...
function OutputListOfRoleGroupEntity:match_get()
...
function OutputListOfRoleGroupEntity:stream(action, args, callopts)
...
---@param reqdata OutputListOfRoleGroupCreateData
---@param ctrl? table
---@return OutputListOfRoleGroup
---@return string? err
function OutputListOfRoleGroupEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputListOfRoleGroupEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputListOfRoleGroupEntity

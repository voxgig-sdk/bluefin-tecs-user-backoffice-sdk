...
local OutputActivatePortalModuleEntity = {}
OutputActivatePortalModuleEntity.__index = OutputActivatePortalModuleEntity


function OutputActivatePortalModuleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OutputActivatePortalModuleEntity)
  self._name = "output_activate_portal_module"
  self._client = client
...
function OutputActivatePortalModuleEntity:get_name()
  return self._name
end


function OutputActivatePortalModuleEntity:make()
  local opts = {}
...
function OutputActivatePortalModuleEntity:mark_deleted()
  self._deleted = true
end


function OutputActivatePortalModuleEntity:deleted()
  return true == self._deleted
end


function OutputActivatePortalModuleEntity:data_set(args)
  if args ~= nil then
...
function OutputActivatePortalModuleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OutputActivatePortalModuleEntity:match_set(args)
  if args ~= nil then
...
function OutputActivatePortalModuleEntity:match_get()
...
function OutputActivatePortalModuleEntity:stream(action, args, callopts)
...
---@param reqdata OutputActivatePortalModuleCreateData
---@param ctrl? table
---@return OutputActivatePortalModule
---@return string? err
function OutputActivatePortalModuleEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OutputActivatePortalModuleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OutputActivatePortalModuleEntity

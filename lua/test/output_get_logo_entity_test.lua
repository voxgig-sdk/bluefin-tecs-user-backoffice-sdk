...
describe("OutputGetLogoEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_GET_LOGO_ENTID JSON to run live")
      return
    end
...
function output_get_logo_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_GET_LOGO_ENTID")

...
describe("OutputGetLogoDirect", function()
  it("should direct-load-output_get_logo", function()
    local setup = output_get_logo_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-output_get_logo", setup.live and "live" or "unit")
...
function output_get_logo_direct_setup(mockres)

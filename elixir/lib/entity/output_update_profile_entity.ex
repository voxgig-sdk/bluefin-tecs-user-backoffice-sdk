...
defmodule BluefinTecsUserBackoffice.Entity.OutputUpdateProfile do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_update_profile", entopts)
  end
  ...
  # Returns the created output_update_profile entity map (BluefinTecsUserBackoffice.Types.output_update_profile/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_update_profile_create_data() | nil, map() | nil) :: term()

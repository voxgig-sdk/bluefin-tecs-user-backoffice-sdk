...
defmodule BluefinTecsUserBackoffice.Entity.OutputResendLink do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_resend_link", entopts)
  end
  ...
  # Returns the created output_resend_link entity map (BluefinTecsUserBackoffice.Types.output_resend_link/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_resend_link_create_data() | nil, map() | nil) :: term()

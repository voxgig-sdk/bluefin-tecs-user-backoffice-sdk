...
defmodule BluefinTecsUserBackoffice.Entity.OutputCreateServiceUser do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_create_service_user", entopts)
  end
  ...
  # Returns the created output_create_service_user entity map (BluefinTecsUserBackoffice.Types.output_create_service_user/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_create_service_user_create_data() | nil, map() | nil) :: term()

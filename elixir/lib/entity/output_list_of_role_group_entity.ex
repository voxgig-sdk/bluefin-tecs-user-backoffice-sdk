...
defmodule BluefinTecsUserBackoffice.Entity.OutputListOfRoleGroup do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_list_of_role_group", entopts)
  end
  ...
  # Returns the created output_list_of_role_group entity map (BluefinTecsUserBackoffice.Types.output_list_of_role_group/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_list_of_role_group_create_data() | nil, map() | nil) :: term()

...
defmodule BluefinTecsUserBackoffice.Entity.OutputListOfMandator do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_list_of_mandator", entopts)
  end
  ...
  # Returns the created output_list_of_mandator entity map (BluefinTecsUserBackoffice.Types.output_list_of_mandator/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_list_of_mandator_create_data() | nil, map() | nil) :: term()

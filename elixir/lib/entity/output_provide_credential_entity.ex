...
defmodule BluefinTecsUserBackoffice.Entity.OutputProvideCredential do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_provide_credential", entopts)
  end
  ...
  # Returns the created output_provide_credential entity map (BluefinTecsUserBackoffice.Types.output_provide_credential/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_provide_credential_create_data() | nil, map() | nil) :: term()

...
defmodule BluefinTecsUserBackoffice.Entity.OutputResetPassword do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_reset_password", entopts)
  end
  ...
  # Returns the created output_reset_password entity map (BluefinTecsUserBackoffice.Types.output_reset_password/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_reset_password_create_data() | nil, map() | nil) :: term()

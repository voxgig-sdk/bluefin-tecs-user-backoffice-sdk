...
defmodule BluefinTecsUserBackoffice.Entity.OutputGetKycDocument do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_get_kyc_document", entopts)
  end
  ...
  # Returns the created output_get_kyc_document entity map (BluefinTecsUserBackoffice.Types.output_get_kyc_document/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_get_kyc_document_create_data() | nil, map() | nil) :: term()

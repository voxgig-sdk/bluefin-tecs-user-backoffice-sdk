...
defmodule BluefinTecsUserBackoffice.Entity.OutputListOfAvailableRole do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_list_of_available_role", entopts)
  end
  ...
  # Returns the created output_list_of_available_role entity map (BluefinTecsUserBackoffice.Types.output_list_of_available_role/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_list_of_available_role_create_data() | nil, map() | nil) :: term()

...
defmodule BluefinTecsUserBackoffice.Entity.OutputActivatePortalModule do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_activate_portal_module", entopts)
  end
  ...
  # Returns the created output_activate_portal_module entity map (BluefinTecsUserBackoffice.Types.output_activate_portal_module/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_activate_portal_module_create_data() | nil, map() | nil) :: term()

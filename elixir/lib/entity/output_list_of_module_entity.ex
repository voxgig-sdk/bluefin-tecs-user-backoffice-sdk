...
defmodule BluefinTecsUserBackoffice.Entity.OutputListOfModule do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_list_of_module", entopts)
  end
  ...
  # Returns the created output_list_of_module entity map (BluefinTecsUserBackoffice.Types.output_list_of_module/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_list_of_module_create_data() | nil, map() | nil) :: term()

...
defmodule BluefinTecsUserBackoffice.Entity.Version do
  ...
  # Returns the version entity map (BluefinTecsUserBackoffice.Types.version/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinTecsUserBackoffice.Types.version_load_match() | nil, map() | nil) :: term()

...
defmodule BluefinTecsUserBackoffice.Entity.OutputListOfTransactionsHistory do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_list_of_transactions_history", entopts)
  end
  ...
  # Returns the created output_list_of_transactions_history entity map (BluefinTecsUserBackoffice.Types.output_list_of_transactions_history/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_list_of_transactions_history_create_data() | nil, map() | nil) :: term()

...
defmodule BluefinTecsUserBackoffice.Entity.OutputActivateUser do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_activate_user", entopts)
  end
  ...
  # Returns the created output_activate_user entity map (BluefinTecsUserBackoffice.Types.output_activate_user/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_activate_user_create_data() | nil, map() | nil) :: term()

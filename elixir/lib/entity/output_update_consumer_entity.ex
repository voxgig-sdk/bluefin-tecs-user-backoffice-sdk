...
defmodule BluefinTecsUserBackoffice.Entity.OutputUpdateConsumer do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_update_consumer", entopts)
  end
  ...
  # Returns the created output_update_consumer entity map (BluefinTecsUserBackoffice.Types.output_update_consumer/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_update_consumer_create_data() | nil, map() | nil) :: term()

...
defmodule BluefinTecsUserBackoffice.Entity.OutputGetLogo do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_get_logo", entopts)
  end
  ...
  # Returns the output_get_logo entity map (BluefinTecsUserBackoffice.Types.output_get_logo/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinTecsUserBackoffice.Types.output_get_logo_load_match() | nil, map() | nil) :: term()

...
defmodule BluefinTecsUserBackoffice.Entity.OutputDeactivateUser do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_deactivate_user", entopts)
  end
  ...
  # Returns the created output_deactivate_user entity map (BluefinTecsUserBackoffice.Types.output_deactivate_user/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_deactivate_user_create_data() | nil, map() | nil) :: term()

...
defmodule BluefinTecsUserBackoffice.Entity.OutputCreateMandator do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_create_mandator", entopts)
  end
  ...
  # Returns the created output_create_mandator entity map (BluefinTecsUserBackoffice.Types.output_create_mandator/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_create_mandator_create_data() | nil, map() | nil) :: term()

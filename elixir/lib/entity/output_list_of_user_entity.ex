...
defmodule BluefinTecsUserBackoffice.Entity.OutputListOfUser do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_list_of_user", entopts)
  end
  ...
  # Returns the created output_list_of_user entity map (BluefinTecsUserBackoffice.Types.output_list_of_user/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_list_of_user_create_data() | nil, map() | nil) :: term()

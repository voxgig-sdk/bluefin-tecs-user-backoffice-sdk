...
defmodule BluefinTecsUserBackoffice.Entity.OutputRegisterUser do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_register_user", entopts)
  end
  ...
  # Returns the created output_register_user entity map (BluefinTecsUserBackoffice.Types.output_register_user/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_register_user_create_data() | nil, map() | nil) :: term()

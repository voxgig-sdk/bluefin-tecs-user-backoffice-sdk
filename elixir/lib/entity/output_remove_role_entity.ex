...
defmodule BluefinTecsUserBackoffice.Entity.OutputRemoveRole do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_remove_role", entopts)
  end
  ...
  # Returns the created output_remove_role entity map (BluefinTecsUserBackoffice.Types.output_remove_role/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_remove_role_create_data() | nil, map() | nil) :: term()

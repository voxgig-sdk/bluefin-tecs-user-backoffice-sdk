...
defmodule BluefinTecsUserBackoffice.Entity.OutputAssignRole do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "output_assign_role", entopts)
  end
  ...
  # Returns the created output_assign_role entity map (BluefinTecsUserBackoffice.Types.output_assign_role/0)
  ...
  @spec create(map(), BluefinTecsUserBackoffice.Types.output_assign_role_create_data() | nil, map() | nil) :: term()

# BluefinTecsUserBackoffice SDK corpus test runner: the vendored @voxgig/omni engine driven
...
# and tm/swift/Tests/BluefinTecsUserBackofficeSDKTests/OmniResolver.swift.
#
...
defmodule BluefinTecsUserBackoffice.Omni do
  ...
  defp sdkprovider(client) do
    utility = BluefinTecsUserBackoffice.get_utility(client)
    ...
    %{
      ...
      client: fn options -> sdkprovider(BluefinTecsUserBackoffice.test(nil, tostruct(options))) end,
  ...
  def errify(%BluefinTecsUserBackoffice.Error{} = err) do

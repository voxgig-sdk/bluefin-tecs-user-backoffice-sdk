# OutputGetKycDocument entity test (offline, mock transport)

defmodule BluefinTecsUserBackoffice.OutputGetKycDocumentEntityTest do
  use ExUnit.Case
  ...
  defp fixture do
    Json.parse(File.read!("../.sdk/test/entity/output_get_kyc_document/OutputGetKycDocumentTestData.json"))
  end
  ...
  defp first_id do
    existing = H.or_(S.getpath(fixture(), "existing.output_get_kyc_document"), S.jm([]))

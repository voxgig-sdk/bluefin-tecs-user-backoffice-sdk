# OutputListOfRoleGroup entity test (offline, mock transport)

defmodule BluefinTecsUserBackoffice.OutputListOfRoleGroupEntityTest do
  use ExUnit.Case
  ...
  defp fixture do
    Json.parse(File.read!("../.sdk/test/entity/output_list_of_role_group/OutputListOfRoleGroupTestData.json"))
  end
  ...
  defp first_id do
    existing = H.or_(S.getpath(fixture(), "existing.output_list_of_role_group"), S.jm([]))

...
class OutputActivateStoreModuleEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("output_activate_store_module", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OutputActivateStoreModuleEntity(this.client, opts)
  }

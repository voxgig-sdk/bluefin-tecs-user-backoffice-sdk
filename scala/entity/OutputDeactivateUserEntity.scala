...
class OutputDeactivateUserEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("output_deactivate_user", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OutputDeactivateUserEntity(this.client, opts)
  }

...
class OutputListOfTransactionsHistoryEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("output_list_of_transactions_history", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OutputListOfTransactionsHistoryEntity(this.client, opts)
  }

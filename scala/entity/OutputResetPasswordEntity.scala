...
class OutputResetPasswordEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("output_reset_password", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OutputResetPasswordEntity(this.client, opts)
  }

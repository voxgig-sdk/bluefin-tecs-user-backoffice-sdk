...
class OutputCreateMandatorEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("output_create_mandator", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OutputCreateMandatorEntity(this.client, opts)
  }

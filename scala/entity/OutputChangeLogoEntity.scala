...
class OutputChangeLogoEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("output_change_logo", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OutputChangeLogoEntity(this.client, opts)
  }

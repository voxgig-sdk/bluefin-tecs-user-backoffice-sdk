...
class OutputListOfModuleEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("output_list_of_module", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OutputListOfModuleEntity(this.client, opts)
  }

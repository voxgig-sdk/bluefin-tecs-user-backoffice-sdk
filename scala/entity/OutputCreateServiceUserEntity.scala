...
class OutputCreateServiceUserEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("output_create_service_user", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OutputCreateServiceUserEntity(this.client, opts)
  }

...
class OutputUpdateProfileEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("output_update_profile", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OutputUpdateProfileEntity(this.client, opts)
  }

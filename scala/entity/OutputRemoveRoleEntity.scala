...
class OutputRemoveRoleEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("output_remove_role", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OutputRemoveRoleEntity(this.client, opts)
  }

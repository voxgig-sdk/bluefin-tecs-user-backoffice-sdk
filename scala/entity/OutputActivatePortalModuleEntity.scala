...
import voxgig.bluefintecsuserbackofficesdk.core.{Context, Entity, Helpers, SdkClient}
...
class OutputActivatePortalModuleEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("output_activate_portal_module", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OutputActivatePortalModuleEntity(this.client, opts)
  }

...
class OutputGetKycDocumentEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("output_get_kyc_document", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OutputGetKycDocumentEntity(this.client, opts)
  }

...
class OutputProvideCredentialEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("output_provide_credential", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OutputProvideCredentialEntity(this.client, opts)
  }

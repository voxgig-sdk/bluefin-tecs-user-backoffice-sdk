...
class OutputResendLinkEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("output_resend_link", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OutputResendLinkEntity(this.client, opts)
  }

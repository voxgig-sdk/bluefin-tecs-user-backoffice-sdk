...
class Utility private (noregister: Boolean) {
  ...
  val struct: voxgig.bluefintecsuserbackofficesdk.utility.StructUtility.type = voxgig.bluefintecsuserbackofficesdk.utility.StructUtility

  def this() = {
    this(false)
    voxgig.bluefintecsuserbackofficesdk.utility.Register.registerAll(this)
  }

...
object Config {
  ...
  def makeFeature(name: String): Feature = name match {
    case "audit" => new voxgig.bluefintecsuserbackofficesdk.feature.AuditFeature()
    case "clienttrack" => new voxgig.bluefintecsuserbackofficesdk.feature.ClienttrackFeature()
    case "debug" => new voxgig.bluefintecsuserbackofficesdk.feature.DebugFeature()
    case "idempotency" => new voxgig.bluefintecsuserbackofficesdk.feature.IdempotencyFeature()
    case "log" => new voxgig.bluefintecsuserbackofficesdk.feature.LogFeature()
    case "metrics" => new voxgig.bluefintecsuserbackofficesdk.feature.MetricsFeature()
    case "paging" => new voxgig.bluefintecsuserbackofficesdk.feature.PagingFeature()
    case "ratelimit" => new voxgig.bluefintecsuserbackofficesdk.feature.RatelimitFeature()
    case "retry" => new voxgig.bluefintecsuserbackofficesdk.feature.RetryFeature()
    case "telemetry" => new voxgig.bluefintecsuserbackofficesdk.feature.TelemetryFeature()
    case "test" => new voxgig.bluefintecsuserbackofficesdk.feature.TestFeature()
    case "timeout" => new voxgig.bluefintecsuserbackofficesdk.feature.TimeoutFeature()

package voxgig.bluefintecsuserbackofficesdk.feature

import java.util.{LinkedHashMap, Map => JMap}
import java.util.concurrent.ThreadLocalRandom
import voxgig.bluefintecsuserbackofficesdk.core.{Context, SdkClient}
...
class ClienttrackFeature extends BaseFeature("clienttrack", "0.0.1", true) {
  ...
  private def agentName(): String = {
    val name = FeatureOptions.foptStr(this.options, "clientName", "BluefinTecsUserBackoffice-SDK")

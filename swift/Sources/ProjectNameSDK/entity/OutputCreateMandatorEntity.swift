...
public final class OutputCreateMandatorEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_create_mandator")
  }

  public override func make() -> Entity {
    return OutputCreateMandatorEntity(client, cloneOpts())
  }

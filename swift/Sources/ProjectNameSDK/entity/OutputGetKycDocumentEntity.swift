...
public final class OutputGetKycDocumentEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_get_kyc_document")
  }

  public override func make() -> Entity {
    return OutputGetKycDocumentEntity(client, cloneOpts())
  }

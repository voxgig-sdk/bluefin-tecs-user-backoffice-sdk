...
public final class OutputActivateStoreModuleEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_activate_store_module")
  }

  public override func make() -> Entity {
    return OutputActivateStoreModuleEntity(client, cloneOpts())
  }

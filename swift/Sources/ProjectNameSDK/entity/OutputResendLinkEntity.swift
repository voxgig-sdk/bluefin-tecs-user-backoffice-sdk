...
public final class OutputResendLinkEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_resend_link")
  }

  public override func make() -> Entity {
    return OutputResendLinkEntity(client, cloneOpts())
  }

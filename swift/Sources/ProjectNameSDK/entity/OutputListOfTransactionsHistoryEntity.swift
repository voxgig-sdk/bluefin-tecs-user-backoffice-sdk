...
public final class OutputListOfTransactionsHistoryEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_list_of_transactions_history")
  }

  public override func make() -> Entity {
    return OutputListOfTransactionsHistoryEntity(client, cloneOpts())
  }

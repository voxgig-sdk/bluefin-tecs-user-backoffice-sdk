...
public final class OutputResetPasswordEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_reset_password")
  }

  public override func make() -> Entity {
    return OutputResetPasswordEntity(client, cloneOpts())
  }

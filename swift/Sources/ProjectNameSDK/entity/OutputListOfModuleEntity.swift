...
public final class OutputListOfModuleEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_list_of_module")
  }

  public override func make() -> Entity {
    return OutputListOfModuleEntity(client, cloneOpts())
  }

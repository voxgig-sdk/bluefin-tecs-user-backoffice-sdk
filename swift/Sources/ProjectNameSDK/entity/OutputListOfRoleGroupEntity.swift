...
public final class OutputListOfRoleGroupEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_list_of_role_group")
  }

  public override func make() -> Entity {
    return OutputListOfRoleGroupEntity(client, cloneOpts())
  }

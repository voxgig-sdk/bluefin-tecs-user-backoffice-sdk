...
public final class OutputCreateServiceUserEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_create_service_user")
  }

  public override func make() -> Entity {
    return OutputCreateServiceUserEntity(client, cloneOpts())
  }

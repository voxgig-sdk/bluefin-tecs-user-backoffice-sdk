...
public final class OutputRemoveRoleEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_remove_role")
  }

  public override func make() -> Entity {
    return OutputRemoveRoleEntity(client, cloneOpts())
  }

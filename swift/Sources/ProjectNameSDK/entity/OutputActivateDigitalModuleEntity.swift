...
public final class OutputActivateDigitalModuleEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_activate_digital_module")
  }

  public override func make() -> Entity {
    return OutputActivateDigitalModuleEntity(client, cloneOpts())
  }

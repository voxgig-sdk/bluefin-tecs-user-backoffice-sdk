...
public final class OutputProvideCredentialEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_provide_credential")
  }

  public override func make() -> Entity {
    return OutputProvideCredentialEntity(client, cloneOpts())
  }

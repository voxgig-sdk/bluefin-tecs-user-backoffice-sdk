...
public final class OutputGetLogoEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_get_logo")
  }

  public override func make() -> Entity {
    return OutputGetLogoEntity(client, cloneOpts())
  }

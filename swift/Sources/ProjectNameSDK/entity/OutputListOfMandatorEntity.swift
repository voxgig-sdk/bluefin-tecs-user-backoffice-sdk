...
public final class OutputListOfMandatorEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_list_of_mandator")
  }

  public override func make() -> Entity {
    return OutputListOfMandatorEntity(client, cloneOpts())
  }

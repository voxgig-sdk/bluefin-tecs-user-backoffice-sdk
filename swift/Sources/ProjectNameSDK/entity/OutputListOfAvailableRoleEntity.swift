...
public final class OutputListOfAvailableRoleEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_list_of_available_role")
  }

  public override func make() -> Entity {
    return OutputListOfAvailableRoleEntity(client, cloneOpts())
  }

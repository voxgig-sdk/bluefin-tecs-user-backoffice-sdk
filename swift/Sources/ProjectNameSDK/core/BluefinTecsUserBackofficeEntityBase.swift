// BluefinTecsUserBackofficeEntityBase - shared entity behaviour: construction, data/match
...
open class BluefinTecsUserBackofficeEntityBase: Entity {
  var name: String
  var client: BluefinTecsUserBackofficeSDK
  var utility: Utility
  var entopts: VMap
  var data = VMap()
  var match = VMap()
  ...
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entoptsIn: VMap?, _ name: String) {
  ...
  open func make() -> Entity {
    return BluefinTecsUserBackofficeEntityBase(client, cloneOpts(), name)
  }

...
public final class BluefinTecsUserBackofficeSDK {
  ...
  private func opDenied(_ op: String) -> VMap {
    ...
    r.entries["err"] = .nat(BluefinTecsUserBackofficeError(
      op + "_allow",
      "BluefinTecsUserBackofficeSDK: \(op): operation not allowed by SDK option "
  ...
  public func graphql(
    ...
    res.entries["err"] = .nat(BluefinTecsUserBackofficeError(
      "graphql_error", "BluefinTecsUserBackofficeSDK: graphql: " + msg, nil))

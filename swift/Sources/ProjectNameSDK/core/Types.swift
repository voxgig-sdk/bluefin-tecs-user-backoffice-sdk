// BluefinTecsUserBackoffice SDK - core contracts.
...
// BluefinTecsUserBackofficeEntityBase which implements this.
...
// Throws (typically BluefinTecsUserBackofficeError) on transport-level failure. A returned

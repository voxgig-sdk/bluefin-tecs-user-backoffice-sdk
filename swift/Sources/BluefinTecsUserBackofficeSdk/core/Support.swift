// BluefinTecsUserBackoffice SDK - shared value helpers for the loose object model.
//
...
// does not define.
func unsupportedOp(_ opname: String, _ entityname: String) -> BluefinTecsUserBackofficeError {
...
func errMessage(_ e: Error) -> String {
  if let se = e as? BluefinTecsUserBackofficeError { return se.message }

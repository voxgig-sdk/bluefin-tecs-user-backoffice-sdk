...
public final class OutputActivateUserEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_activate_user")
  }

  public override func make() -> Entity {
    return OutputActivateUserEntity(client, cloneOpts())
  }

...
public final class OutputChangeLogoEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_change_logo")
  }

  public override func make() -> Entity {
    return OutputChangeLogoEntity(client, cloneOpts())
  }

...
public final class OutputUpdateProfileEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_update_profile")
  }

  public override func make() -> Entity {
    return OutputUpdateProfileEntity(client, cloneOpts())
  }

...
public final class OutputUpdateConsumerEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_update_consumer")
  }

  public override func make() -> Entity {
    return OutputUpdateConsumerEntity(client, cloneOpts())
  }

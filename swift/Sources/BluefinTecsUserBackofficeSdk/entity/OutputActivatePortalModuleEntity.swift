...
public final class OutputActivatePortalModuleEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_activate_portal_module")
  }

  public override func make() -> Entity {
    return OutputActivatePortalModuleEntity(client, cloneOpts())
  }

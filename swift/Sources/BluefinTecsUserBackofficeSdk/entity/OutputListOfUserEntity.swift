...
public final class OutputListOfUserEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_list_of_user")
  }

  public override func make() -> Entity {
    return OutputListOfUserEntity(client, cloneOpts())
  }

...
public final class OutputAssignRoleEntity: BluefinTecsUserBackofficeEntityBase {
  public init(_ client: BluefinTecsUserBackofficeSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "output_assign_role")
  }

  public override func make() -> Entity {
    return OutputAssignRoleEntity(client, cloneOpts())
  }

// BluefinTecsUserBackoffice SDK utility: makeError - the single error surface of the
// pipeline. Throws the wrapped BluefinTecsUserBackofficeError unless the per-call ctrl
...
func makeErrorUtil(_ ctx: Context, _ err: Error?) throws -> Value {
  ...
  var msg = "BluefinTecsUserBackofficeSDK: " + opname + ": " + errmsg
  ...
  let code = (e as? BluefinTecsUserBackofficeError)?.code ?? ""
  let sdkErr = BluefinTecsUserBackofficeError(code, msg, ctx)

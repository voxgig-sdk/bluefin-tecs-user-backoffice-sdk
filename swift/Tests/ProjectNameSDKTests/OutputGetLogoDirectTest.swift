// output_get_logo direct API test (generated from the API model).

import XCTest

@testable import BluefinTecsUserBackofficeSdk

final class OutputGetLogoDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let sdk = BluefinTecsUserBackofficeSDK(opts)

    let args = VMap()
    args.entries["path"] = .string("/output_get_logo")

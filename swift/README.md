...
├── Sources/BluefinTecsUserBackofficeSdk/
...
└── Tests/BluefinTecsUserBackofficeSdkTests/    -- Test suites (XCTest)
```

The main client class (`BluefinTecsUserBackofficeSDK`, under `Sources/BluefinTecsUserBackofficeSdk/core`)

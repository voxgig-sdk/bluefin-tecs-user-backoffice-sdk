...
Object created = client.outputActivateDigitalModule(null).create(Map.of("responseCode", 1L, "responseMessage", "example_responseMessage"), null);
...
| `roles` | `List<Object>` | List of roles to assign to the consumer. |

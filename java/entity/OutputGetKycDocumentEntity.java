...
public class OutputGetKycDocumentEntity extends EntityBase {

  public OutputGetKycDocumentEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_get_kyc_document", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputGetKycDocumentEntity(this.client, opts);
  }

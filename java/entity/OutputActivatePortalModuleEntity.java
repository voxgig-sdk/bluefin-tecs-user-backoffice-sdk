...
public class OutputActivatePortalModuleEntity extends EntityBase {

  public OutputActivatePortalModuleEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_activate_portal_module", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputActivatePortalModuleEntity(this.client, opts);
  }

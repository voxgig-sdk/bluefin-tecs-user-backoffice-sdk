...
public class OutputDeactivateUserEntity extends EntityBase {

  public OutputDeactivateUserEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_deactivate_user", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputDeactivateUserEntity(this.client, opts);
  }

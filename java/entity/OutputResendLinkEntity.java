...
public class OutputResendLinkEntity extends EntityBase {

  public OutputResendLinkEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_resend_link", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputResendLinkEntity(this.client, opts);
  }

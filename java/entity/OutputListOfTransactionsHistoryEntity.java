...
public class OutputListOfTransactionsHistoryEntity extends EntityBase {

  public OutputListOfTransactionsHistoryEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_list_of_transactions_history", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputListOfTransactionsHistoryEntity(this.client, opts);
  }

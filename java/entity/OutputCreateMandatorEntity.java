...
public class OutputCreateMandatorEntity extends EntityBase {

  public OutputCreateMandatorEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_create_mandator", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputCreateMandatorEntity(this.client, opts);
  }

...
public class OutputCreateServiceUserEntity extends EntityBase {

  public OutputCreateServiceUserEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_create_service_user", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputCreateServiceUserEntity(this.client, opts);
  }

...
public class OutputActivateUserEntity extends EntityBase {

  public OutputActivateUserEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_activate_user", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputActivateUserEntity(this.client, opts);
  }

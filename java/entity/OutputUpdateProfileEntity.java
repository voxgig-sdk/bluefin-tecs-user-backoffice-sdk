...
public class OutputUpdateProfileEntity extends EntityBase {

  public OutputUpdateProfileEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_update_profile", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputUpdateProfileEntity(this.client, opts);
  }

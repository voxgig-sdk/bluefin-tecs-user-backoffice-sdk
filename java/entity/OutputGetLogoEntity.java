...
public class OutputGetLogoEntity extends EntityBase {

  public OutputGetLogoEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_get_logo", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputGetLogoEntity(this.client, opts);
  }

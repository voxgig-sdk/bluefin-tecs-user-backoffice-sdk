...
public class OutputListOfUserEntity extends EntityBase {

  public OutputListOfUserEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_list_of_user", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputListOfUserEntity(this.client, opts);
  }

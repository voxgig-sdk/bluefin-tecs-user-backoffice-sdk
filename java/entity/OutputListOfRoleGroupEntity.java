...
public class OutputListOfRoleGroupEntity extends EntityBase {

  public OutputListOfRoleGroupEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_list_of_role_group", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputListOfRoleGroupEntity(this.client, opts);
  }

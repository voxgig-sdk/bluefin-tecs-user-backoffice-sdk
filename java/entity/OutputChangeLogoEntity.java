...
public class OutputChangeLogoEntity extends EntityBase {

  public OutputChangeLogoEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_change_logo", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputChangeLogoEntity(this.client, opts);
  }

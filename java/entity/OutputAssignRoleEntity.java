...
public class OutputAssignRoleEntity extends EntityBase {

  public OutputAssignRoleEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_assign_role", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputAssignRoleEntity(this.client, opts);
  }

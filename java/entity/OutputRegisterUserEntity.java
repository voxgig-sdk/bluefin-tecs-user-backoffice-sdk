...
public class OutputRegisterUserEntity extends EntityBase {

  public OutputRegisterUserEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_register_user", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputRegisterUserEntity(this.client, opts);
  }

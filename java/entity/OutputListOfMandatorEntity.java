...
public class OutputListOfMandatorEntity extends EntityBase {

  public OutputListOfMandatorEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_list_of_mandator", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputListOfMandatorEntity(this.client, opts);
  }

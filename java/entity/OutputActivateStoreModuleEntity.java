...
public class OutputActivateStoreModuleEntity extends EntityBase {

  public OutputActivateStoreModuleEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_activate_store_module", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputActivateStoreModuleEntity(this.client, opts);
  }

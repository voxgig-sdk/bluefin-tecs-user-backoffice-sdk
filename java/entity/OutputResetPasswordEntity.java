...
public class OutputResetPasswordEntity extends EntityBase {

  public OutputResetPasswordEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_reset_password", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputResetPasswordEntity(this.client, opts);
  }

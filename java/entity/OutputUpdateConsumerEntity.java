...
public class OutputUpdateConsumerEntity extends EntityBase {

  public OutputUpdateConsumerEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_update_consumer", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputUpdateConsumerEntity(this.client, opts);
  }

...
public class OutputListOfAvailableRoleEntity extends EntityBase {

  public OutputListOfAvailableRoleEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_list_of_available_role", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputListOfAvailableRoleEntity(this.client, opts);
  }

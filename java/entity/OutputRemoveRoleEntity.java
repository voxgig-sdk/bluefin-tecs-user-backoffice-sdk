...
public class OutputRemoveRoleEntity extends EntityBase {

  public OutputRemoveRoleEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_remove_role", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputRemoveRoleEntity(this.client, opts);
  }

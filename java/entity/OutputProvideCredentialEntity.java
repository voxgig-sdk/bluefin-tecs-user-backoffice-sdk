...
public class OutputProvideCredentialEntity extends EntityBase {

  public OutputProvideCredentialEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_provide_credential", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputProvideCredentialEntity(this.client, opts);
  }

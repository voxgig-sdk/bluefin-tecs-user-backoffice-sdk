...
public class OutputListOfModuleEntity extends EntityBase {

  public OutputListOfModuleEntity(SdkClient client, Map<String, Object> entopts) {
    super("output_list_of_module", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OutputListOfModuleEntity(this.client, opts);
  }

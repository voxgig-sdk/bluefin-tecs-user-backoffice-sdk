...
public class NetsimTest {
  ...
  public void offlineSimulationFailsRequest() {
    BluefinTecsUserBackofficeSDK client = BluefinTecsUserBackofficeSDK.testSDK(fhMap(
  ...
  public void plainTestSdkWorksWithoutNet() {
    BluefinTecsUserBackofficeSDK client = BluefinTecsUserBackofficeSDK.testSDK();

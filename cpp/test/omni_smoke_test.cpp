// BluefinTecsUserBackoffice SDK — smoke tests for the VENDORED omni runner itself
...
static res::Run smokeRun() {
  res::NamedRunner runner = res::makeRunnerSpec(smokeSpec(), BluefinTecsUserBackofficeSDK::testSDK());

// BluefinTecsUserBackoffice SDK — the corpus test runner: vendored @voxgig/omni driven
...
//    state (a CtxPtr, a live BluefinTecsUserBackofficeSDK, an Injector closure) never
...
inline std::shared_ptr<::omni::Provider> sdk_provider(std::shared_ptr<BluefinTecsUserBackofficeSDK> client);
...
public:
  ...
  Run(const ::omni::RunPack& pack, std::shared_ptr<BluefinTecsUserBackofficeSDK> client_)
...
class NamedRunner {
public:
  NamedRunner(const ::omni::Runner& runner, std::shared_ptr<BluefinTecsUserBackofficeSDK> client)
...
private:
  ::omni::Runner runner_;
  std::shared_ptr<BluefinTecsUserBackofficeSDK> client_;
};
...
inline std::shared_ptr<::omni::Provider> sdk_provider(std::shared_ptr<BluefinTecsUserBackofficeSDK> client) {
  ...
  provider->client = [](const Json& options) -> std::shared_ptr<::omni::Provider> {
    ...
    return sdk_provider(BluefinTecsUserBackofficeSDK::testSDK(Value::undef(), opts));
  };
 ...
 */
inline NamedRunner makeRunner(const std::string& path, std::shared_ptr<BluefinTecsUserBackofficeSDK> client) {
 ...
 */
inline NamedRunner makeRunnerSpec(const Value& spec, std::shared_ptr<BluefinTecsUserBackofficeSDK> client) {
 ...
 */
inline CtxPtr omni_ctx(const Value& arg, std::shared_ptr<BluefinTecsUserBackofficeSDK> client,
                       UtilityPtr utility) {

// OutputActivateDigitalModule entity client (generated). Shared entity runtime (data/match
...
class OutputActivateDigitalModuleEntity : public EntityBase {
public:
  OutputActivateDigitalModuleEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_activate_digital_module", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputActivateDigitalModuleEntity>(this->client, opts);
  }

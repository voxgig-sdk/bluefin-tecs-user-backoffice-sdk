// OutputRegisterUser entity client (generated). Shared entity runtime (data/match
...
class OutputRegisterUserEntity : public EntityBase {
public:
  OutputRegisterUserEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_register_user", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputRegisterUserEntity>(this->client, opts);
  }

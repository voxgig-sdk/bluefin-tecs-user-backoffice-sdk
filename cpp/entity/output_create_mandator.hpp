// OutputCreateMandator entity client (generated). Shared entity runtime (data/match
...
class OutputCreateMandatorEntity : public EntityBase {
public:
  OutputCreateMandatorEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_create_mandator", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputCreateMandatorEntity>(this->client, opts);
  }

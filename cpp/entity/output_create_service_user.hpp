// OutputCreateServiceUser entity client (generated). Shared entity runtime (data/match
...
class OutputCreateServiceUserEntity : public EntityBase {
public:
  OutputCreateServiceUserEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_create_service_user", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputCreateServiceUserEntity>(this->client, opts);
  }

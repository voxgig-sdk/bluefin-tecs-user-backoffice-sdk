// OutputListOfTransactionsHistory entity client (generated). Shared entity runtime (data/match
...
class OutputListOfTransactionsHistoryEntity : public EntityBase {
public:
  OutputListOfTransactionsHistoryEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_list_of_transactions_history", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputListOfTransactionsHistoryEntity>(this->client, opts);
  }

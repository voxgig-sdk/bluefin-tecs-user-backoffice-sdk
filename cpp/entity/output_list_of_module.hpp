// OutputListOfModule entity client (generated). Shared entity runtime (data/match
...
class OutputListOfModuleEntity : public EntityBase {
public:
  OutputListOfModuleEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_list_of_module", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputListOfModuleEntity>(this->client, opts);
  }

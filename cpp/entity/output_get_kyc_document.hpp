// OutputGetKycDocument entity client (generated). Shared entity runtime (data/match
...
class OutputGetKycDocumentEntity : public EntityBase {
public:
  OutputGetKycDocumentEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_get_kyc_document", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputGetKycDocumentEntity>(this->client, opts);
  }

// OutputActivateUser entity client (generated). Shared entity runtime (data/match
...
class OutputActivateUserEntity : public EntityBase {
public:
  OutputActivateUserEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_activate_user", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputActivateUserEntity>(this->client, opts);
  }

// OutputListOfRoleGroup entity client (generated). Shared entity runtime (data/match
...
class OutputListOfRoleGroupEntity : public EntityBase {
public:
  OutputListOfRoleGroupEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_list_of_role_group", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputListOfRoleGroupEntity>(this->client, opts);
  }

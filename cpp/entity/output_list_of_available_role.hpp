// OutputListOfAvailableRole entity client (generated). Shared entity runtime (data/match
...
class OutputListOfAvailableRoleEntity : public EntityBase {
public:
  OutputListOfAvailableRoleEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_list_of_available_role", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputListOfAvailableRoleEntity>(this->client, opts);
  }

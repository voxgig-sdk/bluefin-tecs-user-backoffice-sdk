// OutputUpdateProfile entity client (generated). Shared entity runtime (data/match
...
class OutputUpdateProfileEntity : public EntityBase {
public:
  OutputUpdateProfileEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_update_profile", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputUpdateProfileEntity>(this->client, opts);
  }

// OutputProvideCredential entity client (generated). Shared entity runtime (data/match
...
class OutputProvideCredentialEntity : public EntityBase {
public:
  OutputProvideCredentialEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_provide_credential", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputProvideCredentialEntity>(this->client, opts);
  }

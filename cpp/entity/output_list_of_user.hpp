// OutputListOfUser entity client (generated). Shared entity runtime (data/match
...
class OutputListOfUserEntity : public EntityBase {
public:
  OutputListOfUserEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_list_of_user", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputListOfUserEntity>(this->client, opts);
  }

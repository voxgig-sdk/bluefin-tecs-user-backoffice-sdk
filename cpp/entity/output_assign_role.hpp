// OutputAssignRole entity client (generated). Shared entity runtime (data/match
...
class OutputAssignRoleEntity : public EntityBase {
public:
  OutputAssignRoleEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_assign_role", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputAssignRoleEntity>(this->client, opts);
  }

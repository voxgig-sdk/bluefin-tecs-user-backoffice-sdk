// Version entity client (generated). Shared entity runtime (data/match
...
public:
  VersionEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("version", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<VersionEntity>(this->client, opts);
  }

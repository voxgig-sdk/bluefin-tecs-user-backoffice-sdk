// OutputChangeLogo entity client (generated). Shared entity runtime (data/match
...
class OutputChangeLogoEntity : public EntityBase {
public:
  OutputChangeLogoEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_change_logo", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputChangeLogoEntity>(this->client, opts);
  }

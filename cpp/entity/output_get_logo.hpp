// OutputGetLogo entity client (generated). Shared entity runtime (data/match
...
class OutputGetLogoEntity : public EntityBase {
public:
  OutputGetLogoEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_get_logo", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputGetLogoEntity>(this->client, opts);
  }

// OutputResendLink entity client (generated). Shared entity runtime (data/match
...
class OutputResendLinkEntity : public EntityBase {
public:
  OutputResendLinkEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_resend_link", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputResendLinkEntity>(this->client, opts);
  }

// OutputActivatePortalModule entity client (generated). Shared entity runtime (data/match
...
class OutputActivatePortalModuleEntity : public EntityBase {
public:
  OutputActivatePortalModuleEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_activate_portal_module", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputActivatePortalModuleEntity>(this->client, opts);
  }

// OutputActivateStoreModule entity client (generated). Shared entity runtime (data/match
...
class OutputActivateStoreModuleEntity : public EntityBase {
public:
  OutputActivateStoreModuleEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_activate_store_module", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputActivateStoreModuleEntity>(this->client, opts);
  }

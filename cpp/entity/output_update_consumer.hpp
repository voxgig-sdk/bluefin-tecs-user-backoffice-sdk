// OutputUpdateConsumer entity client (generated). Shared entity runtime (data/match
...
class OutputUpdateConsumerEntity : public EntityBase {
public:
  OutputUpdateConsumerEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_update_consumer", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputUpdateConsumerEntity>(this->client, opts);
  }

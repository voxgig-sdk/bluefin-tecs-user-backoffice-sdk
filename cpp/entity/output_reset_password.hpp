// OutputResetPassword entity client (generated). Shared entity runtime (data/match
...
class OutputResetPasswordEntity : public EntityBase {
public:
  OutputResetPasswordEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_reset_password", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputResetPasswordEntity>(this->client, opts);
  }

// OutputListOfMandator entity client (generated). Shared entity runtime (data/match
...
class OutputListOfMandatorEntity : public EntityBase {
public:
  OutputListOfMandatorEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_list_of_mandator", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputListOfMandatorEntity>(this->client, opts);
  }

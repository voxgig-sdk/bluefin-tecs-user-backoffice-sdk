// OutputDeactivateUser entity client (generated). Shared entity runtime (data/match
...
class OutputDeactivateUserEntity : public EntityBase {
public:
  OutputDeactivateUserEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("output_deactivate_user", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OutputDeactivateUserEntity>(this->client, opts);
  }

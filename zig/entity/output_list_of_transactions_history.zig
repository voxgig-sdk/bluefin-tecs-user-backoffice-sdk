// OutputListOfTransactionsHistory entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *OutputListOfTransactionsHistoryEntity,
    err: *errmod.BluefinTecsUserBackofficeError,
};
...
pub const OutputListOfTransactionsHistoryEntity = struct {
    name: []const u8 = "output_list_of_transactions_history",
    client: *sdk.BluefinTecsUserBackofficeSDK,
    utility: *Utility,
    entopts: Value,
    data: Value,
    mtch: Value,
    ...
    pub fn new(client: *sdk.BluefinTecsUserBackofficeSDK, entopts_in: Value) *OutputListOfTransactionsHistoryEntity {
        ...
        const e = h.A().create(OutputListOfTransactionsHistoryEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *OutputListOfTransactionsHistoryEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputListOfTransactionsHistoryEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputListOfTransactionsHistoryEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputListOfTransactionsHistoryEntity, ctx: *Context, post_done: *const fn (*OutputListOfTransactionsHistoryEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputListOfTransactionsHistoryEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputListOfTransactionsHistoryEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputListOfTransactionsHistoryEntity, ctx: *Context, post_done: *const fn (*OutputListOfTransactionsHistoryEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputListOfTransactionsHistoryEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputListOfTransactionsHistoryEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputListOfTransactionsHistoryEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputListOfTransactionsHistoryEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputListOfTransactionsHistoryEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputListOfTransactionsHistoryEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputListOfTransactionsHistoryEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputListOfTransactionsHistoryEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputListOfTransactionsHistoryEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *OutputListOfTransactionsHistoryEntity, ctx: *Context) void {
    ...
    pub fn update(self: *OutputListOfTransactionsHistoryEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputListOfTransactionsHistoryEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;

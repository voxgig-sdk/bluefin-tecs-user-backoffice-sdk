// OutputListOfRoleGroup entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *OutputListOfRoleGroupEntity,
...
pub const OutputListOfRoleGroupEntity = struct {
    name: []const u8 = "output_list_of_role_group",
    ...
    pub fn new(client: *sdk.BluefinTecsUserBackofficeSDK, entopts_in: Value) *OutputListOfRoleGroupEntity {
        ...
        const e = h.A().create(OutputListOfRoleGroupEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *OutputListOfRoleGroupEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputListOfRoleGroupEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputListOfRoleGroupEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputListOfRoleGroupEntity, ctx: *Context, post_done: *const fn (*OutputListOfRoleGroupEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputListOfRoleGroupEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputListOfRoleGroupEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputListOfRoleGroupEntity, ctx: *Context, post_done: *const fn (*OutputListOfRoleGroupEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputListOfRoleGroupEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputListOfRoleGroupEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputListOfRoleGroupEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputListOfRoleGroupEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputListOfRoleGroupEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputListOfRoleGroupEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputListOfRoleGroupEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputListOfRoleGroupEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputListOfRoleGroupEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *OutputListOfRoleGroupEntity, ctx: *Context) void {
    ...
    pub fn update(self: *OutputListOfRoleGroupEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputListOfRoleGroupEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;

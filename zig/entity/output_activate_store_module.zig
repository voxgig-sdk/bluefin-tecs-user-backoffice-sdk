// OutputActivateStoreModule entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *OutputActivateStoreModuleEntity,
...
pub const OutputActivateStoreModuleEntity = struct {
    name: []const u8 = "output_activate_store_module",
    ...
    pub fn new(client: *sdk.BluefinTecsUserBackofficeSDK, entopts_in: Value) *OutputActivateStoreModuleEntity {
        ...
        const e = h.A().create(OutputActivateStoreModuleEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *OutputActivateStoreModuleEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputActivateStoreModuleEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputActivateStoreModuleEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputActivateStoreModuleEntity, ctx: *Context, post_done: *const fn (*OutputActivateStoreModuleEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputActivateStoreModuleEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputActivateStoreModuleEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputActivateStoreModuleEntity, ctx: *Context, post_done: *const fn (*OutputActivateStoreModuleEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputActivateStoreModuleEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputActivateStoreModuleEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputActivateStoreModuleEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputActivateStoreModuleEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputActivateStoreModuleEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputActivateStoreModuleEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputActivateStoreModuleEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputActivateStoreModuleEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputActivateStoreModuleEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *OutputActivateStoreModuleEntity, ctx: *Context) void {
    ...
    pub fn update(self: *OutputActivateStoreModuleEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputActivateStoreModuleEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;

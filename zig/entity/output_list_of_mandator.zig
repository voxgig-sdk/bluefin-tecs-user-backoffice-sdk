// OutputListOfMandator entity client (generated — mirrors the go/rust Entity fragment).
...
pub const OutputListOfMandatorEntity = struct {
    name: []const u8 = "output_list_of_mandator",
    ...
    pub fn new(client: *sdk.BluefinTecsUserBackofficeSDK, entopts_in: Value) *OutputListOfMandatorEntity {
        ...
        const e = h.A().create(OutputListOfMandatorEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *OutputListOfMandatorEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputListOfMandatorEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputListOfMandatorEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputListOfMandatorEntity, ctx: *Context, post_done: *const fn (*OutputListOfMandatorEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputListOfMandatorEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputListOfMandatorEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputListOfMandatorEntity, ctx: *Context, post_done: *const fn (*OutputListOfMandatorEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputListOfMandatorEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputListOfMandatorEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputListOfMandatorEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputListOfMandatorEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputListOfMandatorEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputListOfMandatorEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputListOfMandatorEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputListOfMandatorEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputListOfMandatorEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *OutputListOfMandatorEntity, ctx: *Context) void {
    ...
    pub fn update(self: *OutputListOfMandatorEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputListOfMandatorEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;

// OutputListOfUser entity client (generated — mirrors the go/rust Entity fragment).
...
pub const OutputListOfUserEntity = struct {
    name: []const u8 = "output_list_of_user",
    ...
    pub fn new(client: *sdk.BluefinTecsUserBackofficeSDK, entopts_in: Value) *OutputListOfUserEntity {
        ...
        const e = h.A().create(OutputListOfUserEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *OutputListOfUserEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputListOfUserEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputListOfUserEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputListOfUserEntity, ctx: *Context, post_done: *const fn (*OutputListOfUserEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputListOfUserEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputListOfUserEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputListOfUserEntity, ctx: *Context, post_done: *const fn (*OutputListOfUserEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputListOfUserEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputListOfUserEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputListOfUserEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputListOfUserEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputListOfUserEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputListOfUserEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputListOfUserEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputListOfUserEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputListOfUserEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *OutputListOfUserEntity, ctx: *Context) void {
    ...
    pub fn update(self: *OutputListOfUserEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputListOfUserEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;

...
pub const OutputActivatePortalModuleEntity = struct {
    ...
    pub fn load(self: *OutputActivatePortalModuleEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputActivatePortalModuleEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputActivatePortalModuleEntity, reqdata: Value, ctrl: Value) OpResult {
    ...
    pub fn update(self: *OutputActivatePortalModuleEntity, _reqdata: Value, _ctrl: Value) OpResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputActivatePortalModuleEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;

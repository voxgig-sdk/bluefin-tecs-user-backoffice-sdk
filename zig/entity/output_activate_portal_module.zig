// OutputActivatePortalModule entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *OutputActivatePortalModuleEntity,
...
pub const OutputActivatePortalModuleEntity = struct {
    name: []const u8 = "output_activate_portal_module",
    ...
    pub fn new(client: *sdk.BluefinTecsUserBackofficeSDK, entopts_in: Value) *OutputActivatePortalModuleEntity {
        ...
        const e = h.A().create(OutputActivatePortalModuleEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *OutputActivatePortalModuleEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputActivatePortalModuleEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputActivatePortalModuleEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputActivatePortalModuleEntity, ctx: *Context, post_done: *const fn (*OutputActivatePortalModuleEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputActivatePortalModuleEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputActivatePortalModuleEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputActivatePortalModuleEntity, ctx: *Context, post_done: *const fn (*OutputActivatePortalModuleEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputActivatePortalModuleEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputActivatePortalModuleEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputActivatePortalModuleEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputActivatePortalModuleEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputActivatePortalModuleEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputActivatePortalModuleEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputActivatePortalModuleEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputActivatePortalModuleEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputActivatePortalModuleEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *OutputActivatePortalModuleEntity, ctx: *Context) void {
    ...
    pub fn update(self: *OutputActivatePortalModuleEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputActivatePortalModuleEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;

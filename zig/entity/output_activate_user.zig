...
pub const OutputActivateUserEntity = struct {
    ...
    pub fn load(self: *OutputActivateUserEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputActivateUserEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputActivateUserEntity, reqdata: Value, ctrl: Value) OpResult {
    ...
    pub fn update(self: *OutputActivateUserEntity, _reqdata: Value, _ctrl: Value) OpResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputActivateUserEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;

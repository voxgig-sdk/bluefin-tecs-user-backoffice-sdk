// OutputActivateUser entity client (generated — mirrors the go/rust Entity fragment).
...
pub const OutputActivateUserEntity = struct {
    name: []const u8 = "output_activate_user",
    ...
    pub fn new(client: *sdk.BluefinTecsUserBackofficeSDK, entopts_in: Value) *OutputActivateUserEntity {
        ...
        const e = h.A().create(OutputActivateUserEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *OutputActivateUserEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputActivateUserEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputActivateUserEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputActivateUserEntity, ctx: *Context, post_done: *const fn (*OutputActivateUserEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputActivateUserEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputActivateUserEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputActivateUserEntity, ctx: *Context, post_done: *const fn (*OutputActivateUserEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputActivateUserEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputActivateUserEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputActivateUserEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputActivateUserEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputActivateUserEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputActivateUserEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputActivateUserEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputActivateUserEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputActivateUserEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *OutputActivateUserEntity, ctx: *Context) void {
    ...
    pub fn update(self: *OutputActivateUserEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputActivateUserEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;

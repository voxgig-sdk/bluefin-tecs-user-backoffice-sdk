// OutputUpdateProfile entity client (generated — mirrors the go/rust Entity fragment).
...
pub const OutputUpdateProfileEntity = struct {
    name: []const u8 = "output_update_profile",
    ...
    pub fn new(client: *sdk.BluefinTecsUserBackofficeSDK, entopts_in: Value) *OutputUpdateProfileEntity {
        ...
        const e = h.A().create(OutputUpdateProfileEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *OutputUpdateProfileEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputUpdateProfileEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputUpdateProfileEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputUpdateProfileEntity, ctx: *Context, post_done: *const fn (*OutputUpdateProfileEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputUpdateProfileEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputUpdateProfileEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputUpdateProfileEntity, ctx: *Context, post_done: *const fn (*OutputUpdateProfileEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputUpdateProfileEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputUpdateProfileEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputUpdateProfileEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputUpdateProfileEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputUpdateProfileEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputUpdateProfileEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputUpdateProfileEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputUpdateProfileEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputUpdateProfileEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *OutputUpdateProfileEntity, ctx: *Context) void {
    ...
    pub fn update(self: *OutputUpdateProfileEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputUpdateProfileEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;

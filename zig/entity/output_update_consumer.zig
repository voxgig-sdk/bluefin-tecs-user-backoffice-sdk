// OutputUpdateConsumer entity client (generated — mirrors the go/rust Entity fragment).
...
pub const OutputUpdateConsumerEntity = struct {
    name: []const u8 = "output_update_consumer",
    ...
    pub fn new(client: *sdk.BluefinTecsUserBackofficeSDK, entopts_in: Value) *OutputUpdateConsumerEntity {
        ...
        const e = h.A().create(OutputUpdateConsumerEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *OutputUpdateConsumerEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputUpdateConsumerEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputUpdateConsumerEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputUpdateConsumerEntity, ctx: *Context, post_done: *const fn (*OutputUpdateConsumerEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputUpdateConsumerEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputUpdateConsumerEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputUpdateConsumerEntity, ctx: *Context, post_done: *const fn (*OutputUpdateConsumerEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputUpdateConsumerEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputUpdateConsumerEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputUpdateConsumerEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputUpdateConsumerEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputUpdateConsumerEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputUpdateConsumerEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputUpdateConsumerEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputUpdateConsumerEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputUpdateConsumerEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *OutputUpdateConsumerEntity, ctx: *Context) void {
    ...
    pub fn update(self: *OutputUpdateConsumerEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputUpdateConsumerEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;

...
pub const OutputActivateDigitalModuleEntity = struct {
    ...
    pub fn load(self: *OutputActivateDigitalModuleEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputActivateDigitalModuleEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputActivateDigitalModuleEntity, reqdata: Value, ctrl: Value) OpResult {
    ...
    pub fn update(self: *OutputActivateDigitalModuleEntity, _reqdata: Value, _ctrl: Value) OpResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputActivateDigitalModuleEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;

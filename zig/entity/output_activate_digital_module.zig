// OutputActivateDigitalModule entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *OutputActivateDigitalModuleEntity,
...
pub const OutputActivateDigitalModuleEntity = struct {
    name: []const u8 = "output_activate_digital_module",
    ...
    pub fn new(client: *sdk.BluefinTecsUserBackofficeSDK, entopts_in: Value) *OutputActivateDigitalModuleEntity {
        ...
        const e = h.A().create(OutputActivateDigitalModuleEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *OutputActivateDigitalModuleEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputActivateDigitalModuleEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputActivateDigitalModuleEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputActivateDigitalModuleEntity, ctx: *Context, post_done: *const fn (*OutputActivateDigitalModuleEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputActivateDigitalModuleEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputActivateDigitalModuleEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputActivateDigitalModuleEntity, ctx: *Context, post_done: *const fn (*OutputActivateDigitalModuleEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputActivateDigitalModuleEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputActivateDigitalModuleEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputActivateDigitalModuleEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputActivateDigitalModuleEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputActivateDigitalModuleEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputActivateDigitalModuleEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputActivateDigitalModuleEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputActivateDigitalModuleEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputActivateDigitalModuleEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *OutputActivateDigitalModuleEntity, ctx: *Context) void {
    ...
    pub fn update(self: *OutputActivateDigitalModuleEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputActivateDigitalModuleEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;

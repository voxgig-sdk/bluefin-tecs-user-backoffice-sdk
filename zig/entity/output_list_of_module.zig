// OutputListOfModule entity client (generated — mirrors the go/rust Entity fragment).
...
pub const OutputListOfModuleEntity = struct {
    name: []const u8 = "output_list_of_module",
    ...
    pub fn new(client: *sdk.BluefinTecsUserBackofficeSDK, entopts_in: Value) *OutputListOfModuleEntity {
        ...
        const e = h.A().create(OutputListOfModuleEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *OutputListOfModuleEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *OutputListOfModuleEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *OutputListOfModuleEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *OutputListOfModuleEntity, ctx: *Context, post_done: *const fn (*OutputListOfModuleEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *OutputListOfModuleEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *OutputListOfModuleEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *OutputListOfModuleEntity, ctx: *Context, post_done: *const fn (*OutputListOfModuleEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *OutputListOfModuleEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *OutputListOfModuleEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return OutputListOfModuleEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *OutputListOfModuleEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *OutputListOfModuleEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *OutputListOfModuleEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *OutputListOfModuleEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *OutputListOfModuleEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *OutputListOfModuleEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *OutputListOfModuleEntity, ctx: *Context) void {
    ...
    pub fn update(self: *OutputListOfModuleEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *OutputListOfModuleEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;

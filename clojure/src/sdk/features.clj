;; BluefinTecsUserBackoffice SDK features (generated by @voxgig/sdkgen).
;;
...
(defn clienttrack-feature []
  (let [fa (new-feature "clienttrack" false "0.0.1")
        client-name (fn [] (str (opt fa "clientName" "BluefinTecsUserBackoffice-SDK") "/" (opt fa "clientVersion" "0.0.1")))
        gen-id (fn [kind]
                 (let [idgen (opt fa "idgen")]
                   (if (fn? idgen) (idgen kind)
                       (let [h (fn [] (Long/toHexString (long (rand-int 0x10000000))))

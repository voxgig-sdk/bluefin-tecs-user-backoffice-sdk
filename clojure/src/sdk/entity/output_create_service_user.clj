...
(ns sdk.entity.output_create_service_user
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_create_service_user" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_create_service_user")
...
;; Canonical facade: (OutputCreateServiceUser client data) accessor delegates here.
...
;; Create a new OutputCreateServiceUser (reqdata: body data).

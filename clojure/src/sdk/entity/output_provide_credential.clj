...
(ns sdk.entity.output_provide_credential
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_provide_credential" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_provide_credential")
...
;; Canonical facade: (OutputProvideCredential client data) accessor delegates here.
...
;; Create a new OutputProvideCredential (reqdata: body data).

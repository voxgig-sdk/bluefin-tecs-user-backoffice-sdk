...
(ns sdk.entity.output_update_profile
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_update_profile" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_update_profile")
...
;; Canonical facade: (OutputUpdateProfile client data) accessor delegates here.
...
;; Create a new OutputUpdateProfile (reqdata: body data).

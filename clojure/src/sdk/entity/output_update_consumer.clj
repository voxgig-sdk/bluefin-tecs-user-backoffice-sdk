...
(ns sdk.entity.output_update_consumer
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_update_consumer" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_update_consumer")
...
;; Canonical facade: (OutputUpdateConsumer client data) accessor delegates here.
...
;; Create a new OutputUpdateConsumer (reqdata: body data).

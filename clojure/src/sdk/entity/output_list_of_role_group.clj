...
(ns sdk.entity.output_list_of_role_group
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_list_of_role_group" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_list_of_role_group")
...
;; Canonical facade: (OutputListOfRoleGroup client data) accessor delegates here.
...
;; Create a new OutputListOfRoleGroup (reqdata: body data).

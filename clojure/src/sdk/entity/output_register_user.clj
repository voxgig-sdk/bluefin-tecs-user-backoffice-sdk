...
(ns sdk.entity.output_register_user
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_register_user" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_register_user")
...
;; Canonical facade: (OutputRegisterUser client data) accessor delegates here.
...
;; Create a new OutputRegisterUser (reqdata: body data).

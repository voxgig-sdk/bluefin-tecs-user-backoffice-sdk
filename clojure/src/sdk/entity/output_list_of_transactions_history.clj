...
(ns sdk.entity.output_list_of_transactions_history
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_list_of_transactions_history" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_list_of_transactions_history")
...
;; Canonical facade: (OutputListOfTransactionsHistory client data) accessor delegates here.
...
;; Create a new OutputListOfTransactionsHistory (reqdata: body data).

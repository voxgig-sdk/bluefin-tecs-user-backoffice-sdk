...
(ns sdk.entity.output_resend_link
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_resend_link" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_resend_link")
...
;; Canonical facade: (OutputResendLink client data) accessor delegates here.
...
;; Create a new OutputResendLink (reqdata: body data).

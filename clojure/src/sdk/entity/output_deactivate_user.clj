...
(ns sdk.entity.output_deactivate_user
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_deactivate_user" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_deactivate_user")
...
;; Canonical facade: (OutputDeactivateUser client data) accessor delegates here.
...
;; Create a new OutputDeactivateUser (reqdata: body data).

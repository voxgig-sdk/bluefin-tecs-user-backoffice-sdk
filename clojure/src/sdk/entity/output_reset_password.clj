...
(ns sdk.entity.output_reset_password
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_reset_password" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_reset_password")
...
;; Canonical facade: (OutputResetPassword client data) accessor delegates here.
...
;; Create a new OutputResetPassword (reqdata: body data).

;; BluefinTecsUserBackoffice SDK OutputGetLogo entity (generated by @voxgig/sdkgen).
(ns sdk.entity.output_get_logo
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_get_logo" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_get_logo")
...
;; Canonical facade: (OutputGetLogo client data) accessor delegates here.
...
;; Load a single OutputGetLogo (reqmatch: id/query fields; nil = empty match).

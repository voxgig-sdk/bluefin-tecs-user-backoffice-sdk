...
(ns sdk.entity.output_activate_user
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_activate_user" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_activate_user")
...
;; Canonical facade: (OutputActivateUser client data) accessor delegates here.
...
;; Create a new OutputActivateUser (reqdata: body data).

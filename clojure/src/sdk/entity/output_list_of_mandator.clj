...
(ns sdk.entity.output_list_of_mandator
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_list_of_mandator" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_list_of_mandator")
...
;; Canonical facade: (OutputListOfMandator client data) accessor delegates here.
...
;; Create a new OutputListOfMandator (reqdata: body data).

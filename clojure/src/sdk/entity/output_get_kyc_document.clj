...
(ns sdk.entity.output_get_kyc_document
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_get_kyc_document" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_get_kyc_document")
...
;; Canonical facade: (OutputGetKycDocument client data) accessor delegates here.
...
;; Create a new OutputGetKycDocument (reqdata: body data).

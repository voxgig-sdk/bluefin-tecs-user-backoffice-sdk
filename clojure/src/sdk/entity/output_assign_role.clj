...
(ns sdk.entity.output_assign_role
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_assign_role" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_assign_role")
...
;; Canonical facade: (OutputAssignRole client data) accessor delegates here.
...
;; Create a new OutputAssignRole (reqdata: body data).

...
(ns sdk.entity.output_list_of_available_role
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_list_of_available_role" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_list_of_available_role")
...
;; Canonical facade: (OutputListOfAvailableRole client data) accessor delegates here.
...
;; Create a new OutputListOfAvailableRole (reqdata: body data).

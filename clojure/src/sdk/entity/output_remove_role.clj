...
(ns sdk.entity.output_remove_role
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_remove_role" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_remove_role")
...
;; Canonical facade: (OutputRemoveRole client data) accessor delegates here.
...
;; Create a new OutputRemoveRole (reqdata: body data).

...
(ns sdk.entity.output_change_logo
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_change_logo" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_change_logo")
...
;; Canonical facade: (OutputChangeLogo client data) accessor delegates here.
...
;; Create a new OutputChangeLogo (reqdata: body data).

...
(ns sdk.entity.output_create_mandator
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_create_mandator" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_create_mandator")
...
;; Canonical facade: (OutputCreateMandator client data) accessor delegates here.
...
;; Create a new OutputCreateMandator (reqdata: body data).

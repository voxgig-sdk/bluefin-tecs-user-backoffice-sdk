...
(ns sdk.entity.output_activate_store_module
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "output_activate_store_module" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "output_activate_store_module")
...
;; Canonical facade: (OutputActivateStoreModule client data) accessor delegates here.
...
;; Create a new OutputActivateStoreModule (reqdata: body data).

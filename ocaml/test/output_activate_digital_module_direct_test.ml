(* Generated output_activate_digital_module direct-call test. *)
...
let () =
  test "output_activate_digital_module.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/output_activate_digital_module"); ("method", Str "GET")]) in

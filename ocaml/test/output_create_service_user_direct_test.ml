(* Generated output_create_service_user direct-call test. *)
...
let () =
  test "output_create_service_user.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/output_create_service_user"); ("method", Str "GET")]) in

(* Generated output_provide_credential direct-call test. *)
...
let () =
  test "output_provide_credential.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/output_provide_credential"); ("method", Str "GET")]) in

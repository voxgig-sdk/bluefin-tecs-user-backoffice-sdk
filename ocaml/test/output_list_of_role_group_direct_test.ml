(* Generated output_list_of_role_group direct-call test. *)
...
let () =
  test "output_list_of_role_group.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/output_list_of_role_group"); ("method", Str "GET")]) in

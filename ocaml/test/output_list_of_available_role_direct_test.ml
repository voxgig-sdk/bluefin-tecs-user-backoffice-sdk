(* Generated output_list_of_available_role direct-call test. *)
...
let () =
  test "output_list_of_available_role.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/output_list_of_available_role"); ("method", Str "GET")]) in

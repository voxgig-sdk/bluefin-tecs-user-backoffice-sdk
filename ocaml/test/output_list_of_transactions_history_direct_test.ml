(* Generated output_list_of_transactions_history direct-call test. *)
...
let () =
  test "output_list_of_transactions_history.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/output_list_of_transactions_history"); ("method", Str "GET")]) in

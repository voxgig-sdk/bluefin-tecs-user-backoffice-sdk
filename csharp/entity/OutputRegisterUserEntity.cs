...
public class OutputRegisterUserEntity : BluefinTecsUserBackofficeEntityBase
{
    public OutputRegisterUserEntity(BluefinTecsUserBackofficeSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "output_register_user")
    {
    }

    public override IEntity Make()
    {
        return new OutputRegisterUserEntity(client, CloneOpts());
    }

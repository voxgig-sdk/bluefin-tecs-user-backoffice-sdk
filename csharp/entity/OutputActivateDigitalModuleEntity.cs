...
public class OutputActivateDigitalModuleEntity : BluefinTecsUserBackofficeEntityBase
{
    public OutputActivateDigitalModuleEntity(BluefinTecsUserBackofficeSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "output_activate_digital_module")
    {
    }

    public override IEntity Make()
    {
        return new OutputActivateDigitalModuleEntity(client, CloneOpts());
    }

// OutputGetLogo entity client for the BluefinTecsUserBackoffice SDK.

using Voxgig.Struct;

namespace BluefinTecsUserBackofficeSdk.Entity;

public class OutputGetLogoEntity : BluefinTecsUserBackofficeEntityBase
{
    public OutputGetLogoEntity(BluefinTecsUserBackofficeSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "output_get_logo")
    {
    }

    public override IEntity Make()
    {
        return new OutputGetLogoEntity(client, CloneOpts());
    }

...
public class VersionEntity : BluefinTecsUserBackofficeEntityBase
{
    public VersionEntity(BluefinTecsUserBackofficeSDK client, Dictionary<string, object?>? entopts = null)

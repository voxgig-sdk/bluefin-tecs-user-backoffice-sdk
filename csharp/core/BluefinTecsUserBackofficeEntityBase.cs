...
public abstract class BluefinTecsUserBackofficeEntityBase : IEntity
{
    protected string name;
    protected BluefinTecsUserBackofficeSDK client;
    ...
    protected BluefinTecsUserBackofficeEntityBase(BluefinTecsUserBackofficeSDK client,

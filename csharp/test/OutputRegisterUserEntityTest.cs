...
public class OutputRegisterUserEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_REGISTER_USER_ENTID JSON to run live.
        ...
        outputRegisterUserRef01Data = Helpers.ToMapAny(outputRegisterUserRef01DataResult is IEntity ce ? ce.Data() : outputRegisterUserRef01DataResult);

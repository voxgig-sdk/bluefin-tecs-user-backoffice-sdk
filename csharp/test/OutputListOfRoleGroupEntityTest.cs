...
public class OutputListOfRoleGroupEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_LIST_OF_ROLE_GROUP_ENTID JSON to run live.
        ...
        outputListOfRoleGroupRef01Data = Helpers.ToMapAny(outputListOfRoleGroupRef01DataResult is IEntity ce ? ce.Data() : outputListOfRoleGroupRef01DataResult);

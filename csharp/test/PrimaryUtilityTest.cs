...
public class PrimaryUtilityTest
{
    ...
    private static OmniResolver.Run Run()
    {
        lock (RunLock)
        {
            if (RUN == null)
            {
                CLIENT = BluefinTecsUserBackofficeSDK.TestSDK(null, null);
    ...
    private static BluefinTecsUserBackofficeSDK GetClient()
    {
        Run();
        return CLIENT!;
    }
    ...
    private static Context MakeTestCtx(BluefinTecsUserBackofficeSDK client, Utility utility,
    ...
    private static Context MakeTestFullCtx(BluefinTecsUserBackofficeSDK client, Utility utility)
    {
    ...
    {
        var hookClient = BluefinTecsUserBackofficeSDK.TestSDK(null, null);
    ...
    {
        var initClient = BluefinTecsUserBackofficeSDK.TestSDK(null, null);
    ...
    public void FetcherBlockedTestMode()
    {
        ...
        var blockedClient = new BluefinTecsUserBackofficeSDK(new Dictionary<string, object?>
        {
            ["base"] = "http://localhost:8080",
            ["system"] = new Dictionary<string, object?>
            {
    ...
    public void MakeSpecBasic()
    {
        ...
        var specClient = BluefinTecsUserBackofficeSDK.TestSDK(null, setupOpts);
    ...
    // BluefinTecsUserBackofficeError. The corpus says `match: out: code` for both, so
    ...
    public void MakePointBasic()
    {
        runsection("makePoint", args =>
        {
            ...
            catch (BluefinTecsUserBackofficeError e)
            {
    ...
    public void PrepareAuthBasic()
    {
        ...
        var authClient = BluefinTecsUserBackofficeSDK.TestSDK(null, setupOpts);

...
public class OutputResendLinkEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_RESEND_LINK_ENTID JSON to run live.
        ...
        outputResendLinkRef01Data = Helpers.ToMapAny(outputResendLinkRef01DataResult is IEntity ce ? ce.Data() : outputResendLinkRef01DataResult);

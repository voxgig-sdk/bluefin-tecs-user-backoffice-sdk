...
public class OutputActivateUserEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_ACTIVATE_USER_ENTID JSON to run live.
        ...
        outputActivateUserRef01Data = Helpers.ToMapAny(outputActivateUserRef01DataResult is IEntity ce ? ce.Data() : outputActivateUserRef01DataResult);

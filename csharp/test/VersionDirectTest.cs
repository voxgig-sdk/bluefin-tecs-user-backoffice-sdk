...
public class VersionDirectTest
{
    ...
    private static VersionDirectSetupResult VersionDirectSetup(object? mockres)
    {
        ...
        {
            ["BLUEFIN_TECS_USER_BACKOFFICE_TEST_VERSION_ENTID"] = new Dictionary<string, object?>(),
        ...
        if (live)
        {
            ...
            var liveClient = new BluefinTecsUserBackofficeSDK(liveOpts);

            var idmap = new Dictionary<string, object?>();
            var entidRaw = env["BLUEFIN_TECS_USER_BACKOFFICE_TEST_VERSION_ENTID"];

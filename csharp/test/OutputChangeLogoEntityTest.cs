...
public class OutputChangeLogoEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_CHANGE_LOGO_ENTID JSON to run live.
        ...
        outputChangeLogoRef01Data = Helpers.ToMapAny(outputChangeLogoRef01DataResult is IEntity ce ? ce.Data() : outputChangeLogoRef01DataResult);

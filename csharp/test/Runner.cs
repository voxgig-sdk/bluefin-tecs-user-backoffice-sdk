// BluefinTecsUserBackoffice SDK test-runner SUPPORT (vendor-tag rollout): env overrides,
...
public static class TestRunner
{
    ...
    {
        if (Environment.GetEnvironmentVariable("BLUEFIN_TECS_USER_BACKOFFICE_TEST_LIVE") == "TRUE" ||
            Environment.GetEnvironmentVariable("BLUEFIN_TECS_USER_BACKOFFICE_TEST_OVERRIDE") == "TRUE")
        {
        ...
        var explain = Environment.GetEnvironmentVariable("BLUEFIN_TECS_USER_BACKOFFICE_TEST_EXPLAIN");
    ...
    public static int LiveDelayMs()
    {
        ...
        {
            var n = BluefinTecsUserBackofficeSdk.Helpers.ToInt(v);
            if (n >= 0)
            {
                return n;
            }
    ...
    public static Context MakeCtxFromMap(Dictionary<string, object?>? ctxmap,
        BluefinTecsUserBackofficeSDK? client, Utility? utility)
    {
            ...
            resRaw is Dictionary<string, object?> resMap)
        {
            ...
            {
                ctx.Result.Err = new BluefinTecsUserBackofficeError("", msg, null);
            }
        }
    ...
    public static void FixCtx(Context ctx, BluefinTecsUserBackofficeSDK client)
    {
    ...
    public static Exception? ErrFromMap(Dictionary<string, object?>? m)
    {
        ...
        return new BluefinTecsUserBackofficeError(code, msg, null);
    }

...
public static class TestRunner
{
    ...
    {
        if (Environment.GetEnvironmentVariable("BLUEFINTECSUSERBACKOFFICE_TEST_LIVE") == "TRUE" ||
            Environment.GetEnvironmentVariable("BLUEFINTECSUSERBACKOFFICE_TEST_OVERRIDE") == "TRUE")
        {
        ...
        var explain = Environment.GetEnvironmentVariable("BLUEFINTECSUSERBACKOFFICE_TEST_EXPLAIN");

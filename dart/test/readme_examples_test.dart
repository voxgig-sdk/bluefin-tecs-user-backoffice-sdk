// BluefinTecsUserBackoffice SDK — documentation dart-examples presence & completeness gate.
...
const String _sdkClass = 'BluefinTecsUserBackofficeSDK';

// The API's capitalised semantic entities, used to spot a client.<Entity>()
// factory call inside a block.
const List<String> _entities = <String>['OutputActivateDigitalModule', 'OutputActivatePortalModule', 'OutputActivateStoreModule', 'OutputActivateUser', 'OutputAssignRole', 'OutputChangeLogo', 'OutputCreateMandator', 'OutputCreateServiceUser', 'OutputDeactivateUser', 'OutputGetKycDocument', 'OutputGetLogo', 'OutputListOfAvailableRole', 'OutputListOfMandator', 'OutputListOfModule', 'OutputListOfRoleGroup', 'OutputListOfTransactionsHistory', 'OutputListOfUser', 'OutputProvideCredential', 'OutputRegisterUser', 'OutputRemoveRole', 'OutputResendLink', 'OutputResetPassword', 'OutputUpdateConsumer', 'OutputUpdateProfile', 'Version'];

...
import '../lib/BluefinTecsUserBackofficeError.dart';
...
void tests() {
  ...
  describe('pipeline:makeRequest', () {
    ...
    test('an Error transport result is carried on the response', (t) async {
      final boom = BluefinTecsUserBackofficeError('boom', 'boom', null);
      final ctx = base({
    ...
    test('a fetchdef error surfaces as a response error', (t) async {
      final u = Utility();
      u.makeFetchDef = (dynamic c) => BluefinTecsUserBackofficeError('fetchdef_boom', 'boom', null);
      final ctx = base({
        'utility': u,
        'spec': {'step': 's', 'method': 'GET', 'headers': {}}
      });

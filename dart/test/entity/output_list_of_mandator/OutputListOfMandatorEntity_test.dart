...
void tests() {
  describe('OutputListOfMandatorEntity', () {
    test('instance', (t) async {
      final testsdk = BluefinTecsUserBackofficeSDK.test();
      final ent = testsdk.OutputListOfMandator();
      ok(null != ent);
    });
    ...
    test('stream', (t) async {
      ...
      final plainent = plainsdk.OutputListOfMandator();
      final seen2 = [];
    ...
    test('basic', (t) async {
      ...
      for (final op in ['create']) {
        if (maybeSkipControl(t, 'entityOp', 'output_list_of_mandator.' + op, live)) {
          return;
        }
      }
      ...
      // CREATE
      final output_list_of_mandator_ref01_ent = client.OutputListOfMandator();
      dynamic output_list_of_mandator_ref01_data = setup['data']['new']['output_list_of_mandator']['output_list_of_mandator_ref01'];

      output_list_of_mandator_ref01_data = await output_list_of_mandator_ref01_ent.create(output_list_of_mandator_ref01_data);
      ok(null != output_list_of_mandator_ref01_data);
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['output_list_of_mandator01', 'output_list_of_mandator02', 'output_list_of_mandator03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_LIST_OF_MANDATOR_ENTID'];

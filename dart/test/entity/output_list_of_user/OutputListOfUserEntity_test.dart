...
void tests() {
  describe('OutputListOfUserEntity', () {
    ...
    test('stream', (t) async {
      ...
      final plainent = plainsdk.OutputListOfUser();
      final seen2 = [];
    ...
    test('basic', (t) async {
      ...
      for (final op in ['create']) {
        if (maybeSkipControl(t, 'entityOp', 'output_list_of_user.' + op, live)) {
          return;
        }
      }
      ...
      // CREATE
      final output_list_of_user_ref01_ent = client.OutputListOfUser();
      dynamic output_list_of_user_ref01_data = setup['data']['new']['output_list_of_user']['output_list_of_user_ref01'];

      output_list_of_user_ref01_data = await output_list_of_user_ref01_ent.create(output_list_of_user_ref01_data);
      ok(null != output_list_of_user_ref01_data);
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['output_list_of_user01', 'output_list_of_user02', 'output_list_of_user03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_LIST_OF_USER_ENTID'];

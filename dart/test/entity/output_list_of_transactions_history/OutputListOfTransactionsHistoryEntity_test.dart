...
void tests() {
  describe('OutputListOfTransactionsHistoryEntity', () {
    test('instance', (t) async {
      final testsdk = BluefinTecsUserBackofficeSDK.test();
      final ent = testsdk.OutputListOfTransactionsHistory();
      ok(null != ent);
    });
    ...
    test('stream', (t) async {
      ...
      final plainent = plainsdk.OutputListOfTransactionsHistory();
      final seen2 = [];
    ...
    test('basic', (t) async {
      ...
      for (final op in ['create']) {
        if (maybeSkipControl(t, 'entityOp', 'output_list_of_transactions_history.' + op, live)) {
          return;
        }
      }
      ...
      // CREATE
      final output_list_of_transactions_history_ref01_ent = client.OutputListOfTransactionsHistory();
      dynamic output_list_of_transactions_history_ref01_data = setup['data']['new']['output_list_of_transactions_history']['output_list_of_transactions_history_ref01'];
      ...
      ok(null != output_list_of_transactions_history_ref01_data);
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['output_list_of_transactions_history01', 'output_list_of_transactions_history02', 'output_list_of_transactions_history03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_LIST_OF_TRANSACTIONS_HISTORY_ENTID'];

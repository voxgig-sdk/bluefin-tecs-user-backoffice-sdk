...
void tests() {
  describe('OutputRemoveRoleEntity', () {
    ...
    test('stream', (t) async {
      ...
      final plainent = plainsdk.OutputRemoveRole();
      final seen2 = [];
    ...
    test('basic', (t) async {
      ...
      for (final op in ['create']) {
        if (maybeSkipControl(t, 'entityOp', 'output_remove_role.' + op, live)) {
          return;
        }
      }
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['output_remove_role01', 'output_remove_role02', 'output_remove_role03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_REMOVE_ROLE_ENTID'];

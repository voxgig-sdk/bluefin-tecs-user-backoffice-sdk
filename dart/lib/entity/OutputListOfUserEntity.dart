...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputListOfUser and the per-op request/match types).
class OutputListOfUserEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputListOfUserEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_list_of_user';
    name_ = 'output_list_of_user';
    Name = 'OutputListOfUser';
  }

  OutputListOfUserEntity make() {
    return OutputListOfUserEntity(client, entopts());
  }




  /// Create a OutputListOfUser (see OutputListOfUserCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputListOfUser).

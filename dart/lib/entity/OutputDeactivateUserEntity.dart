...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputDeactivateUser and the per-op request/match types).
class OutputDeactivateUserEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputDeactivateUserEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_deactivate_user';
    name_ = 'output_deactivate_user';
    Name = 'OutputDeactivateUser';
  }

  OutputDeactivateUserEntity make() {
    return OutputDeactivateUserEntity(client, entopts());
  }




  /// Create a OutputDeactivateUser (see OutputDeactivateUserCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputDeactivateUser).

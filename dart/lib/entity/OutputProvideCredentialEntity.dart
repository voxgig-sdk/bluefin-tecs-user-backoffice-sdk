...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputProvideCredential and the per-op request/match types).
class OutputProvideCredentialEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputProvideCredentialEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_provide_credential';
    name_ = 'output_provide_credential';
    Name = 'OutputProvideCredential';
  }

  OutputProvideCredentialEntity make() {
    return OutputProvideCredentialEntity(client, entopts());
  }




  /// Create a OutputProvideCredential (see OutputProvideCredentialCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputProvideCredential).

...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputCreateServiceUser and the per-op request/match types).
class OutputCreateServiceUserEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputCreateServiceUserEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_create_service_user';
    name_ = 'output_create_service_user';
    Name = 'OutputCreateServiceUser';
  }

  OutputCreateServiceUserEntity make() {
    return OutputCreateServiceUserEntity(client, entopts());
  }




  /// Create a OutputCreateServiceUser (see OutputCreateServiceUserCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputCreateServiceUser).

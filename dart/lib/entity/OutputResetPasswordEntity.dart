...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputResetPassword and the per-op request/match types).
class OutputResetPasswordEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputResetPasswordEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_reset_password';
    name_ = 'output_reset_password';
    Name = 'OutputResetPassword';
  }

  OutputResetPasswordEntity make() {
    return OutputResetPasswordEntity(client, entopts());
  }




  /// Create a OutputResetPassword (see OutputResetPasswordCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputResetPassword).

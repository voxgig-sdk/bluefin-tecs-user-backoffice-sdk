...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputRemoveRole and the per-op request/match types).
class OutputRemoveRoleEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputRemoveRoleEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_remove_role';
    name_ = 'output_remove_role';
    Name = 'OutputRemoveRole';
  }

  OutputRemoveRoleEntity make() {
    return OutputRemoveRoleEntity(client, entopts());
  }




  /// Create a OutputRemoveRole (see OutputRemoveRoleCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputRemoveRole).

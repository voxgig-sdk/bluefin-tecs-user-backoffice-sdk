...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputActivateDigitalModule and the per-op request/match types).
class OutputActivateDigitalModuleEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputActivateDigitalModuleEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_activate_digital_module';
    name_ = 'output_activate_digital_module';
    Name = 'OutputActivateDigitalModule';
  }

  OutputActivateDigitalModuleEntity make() {
    return OutputActivateDigitalModuleEntity(client, entopts());
  }




  /// Create a OutputActivateDigitalModule (see OutputActivateDigitalModuleCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputActivateDigitalModule).

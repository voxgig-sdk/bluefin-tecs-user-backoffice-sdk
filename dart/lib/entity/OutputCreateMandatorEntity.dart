...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputCreateMandator and the per-op request/match types).
class OutputCreateMandatorEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputCreateMandatorEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_create_mandator';
    name_ = 'output_create_mandator';
    Name = 'OutputCreateMandator';
  }

  OutputCreateMandatorEntity make() {
    return OutputCreateMandatorEntity(client, entopts());
  }




  /// Create a OutputCreateMandator (see OutputCreateMandatorCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputCreateMandator).

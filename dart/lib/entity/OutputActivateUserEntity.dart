...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputActivateUser and the per-op request/match types).
class OutputActivateUserEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputActivateUserEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_activate_user';
    name_ = 'output_activate_user';
    Name = 'OutputActivateUser';
  }

  OutputActivateUserEntity make() {
    return OutputActivateUserEntity(client, entopts());
  }




  /// Create a OutputActivateUser (see OutputActivateUserCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputActivateUser).

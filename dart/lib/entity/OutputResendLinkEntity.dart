...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputResendLink and the per-op request/match types).
class OutputResendLinkEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputResendLinkEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_resend_link';
    name_ = 'output_resend_link';
    Name = 'OutputResendLink';
  }

  OutputResendLinkEntity make() {
    return OutputResendLinkEntity(client, entopts());
  }




  /// Create a OutputResendLink (see OutputResendLinkCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputResendLink).

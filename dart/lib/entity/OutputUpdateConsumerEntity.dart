...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputUpdateConsumer and the per-op request/match types).
class OutputUpdateConsumerEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputUpdateConsumerEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_update_consumer';
    name_ = 'output_update_consumer';
    Name = 'OutputUpdateConsumer';
  }

  OutputUpdateConsumerEntity make() {
    return OutputUpdateConsumerEntity(client, entopts());
  }




  /// Create a OutputUpdateConsumer (see OutputUpdateConsumerCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputUpdateConsumer).

...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputGetLogo and the per-op request/match types).
class OutputGetLogoEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputGetLogoEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_get_logo';
    name_ = 'output_get_logo';
    Name = 'OutputGetLogo';
  }

  OutputGetLogoEntity make() {
    return OutputGetLogoEntity(client, entopts());
  }


  /// Load a OutputGetLogo by match (see OutputGetLogoLoadMatch in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputGetLogo).

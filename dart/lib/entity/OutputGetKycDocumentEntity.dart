...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputGetKycDocument and the per-op request/match types).
class OutputGetKycDocumentEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputGetKycDocumentEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_get_kyc_document';
    name_ = 'output_get_kyc_document';
    Name = 'OutputGetKycDocument';
  }

  OutputGetKycDocumentEntity make() {
    return OutputGetKycDocumentEntity(client, entopts());
  }




  /// Create a OutputGetKycDocument (see OutputGetKycDocumentCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputGetKycDocument).

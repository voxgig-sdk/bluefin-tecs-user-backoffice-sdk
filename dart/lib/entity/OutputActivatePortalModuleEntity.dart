...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputActivatePortalModule and the per-op request/match types).
class OutputActivatePortalModuleEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputActivatePortalModuleEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_activate_portal_module';
    name_ = 'output_activate_portal_module';
    Name = 'OutputActivatePortalModule';
  }

  OutputActivatePortalModuleEntity make() {
    return OutputActivatePortalModuleEntity(client, entopts());
  }




  /// Create a OutputActivatePortalModule (see OutputActivatePortalModuleCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputActivatePortalModule).

...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputActivateStoreModule and the per-op request/match types).
class OutputActivateStoreModuleEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputActivateStoreModuleEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_activate_store_module';
    name_ = 'output_activate_store_module';
    Name = 'OutputActivateStoreModule';
  }

  OutputActivateStoreModuleEntity make() {
    return OutputActivateStoreModuleEntity(client, entopts());
  }




  /// Create a OutputActivateStoreModule (see OutputActivateStoreModuleCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputActivateStoreModule).

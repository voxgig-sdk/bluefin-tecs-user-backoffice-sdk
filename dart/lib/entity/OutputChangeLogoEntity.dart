...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputChangeLogo and the per-op request/match types).
class OutputChangeLogoEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputChangeLogoEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_change_logo';
    name_ = 'output_change_logo';
    Name = 'OutputChangeLogo';
  }

  OutputChangeLogoEntity make() {
    return OutputChangeLogoEntity(client, entopts());
  }




  /// Create a OutputChangeLogo (see OutputChangeLogoCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputChangeLogo).

...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputListOfModule and the per-op request/match types).
class OutputListOfModuleEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputListOfModuleEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_list_of_module';
    name_ = 'output_list_of_module';
    Name = 'OutputListOfModule';
  }

  OutputListOfModuleEntity make() {
    return OutputListOfModuleEntity(client, entopts());
  }




  /// Create a OutputListOfModule (see OutputListOfModuleCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputListOfModule).

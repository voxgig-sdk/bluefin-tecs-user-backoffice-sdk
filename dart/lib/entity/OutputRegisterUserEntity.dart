...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputRegisterUser and the per-op request/match types).
class OutputRegisterUserEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputRegisterUserEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_register_user';
    name_ = 'output_register_user';
    Name = 'OutputRegisterUser';
  }

  OutputRegisterUserEntity make() {
    return OutputRegisterUserEntity(client, entopts());
  }




  /// Create a OutputRegisterUser (see OutputRegisterUserCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputRegisterUser).

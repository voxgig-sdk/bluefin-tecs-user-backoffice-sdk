...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputAssignRole and the per-op request/match types).
class OutputAssignRoleEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputAssignRoleEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_assign_role';
    name_ = 'output_assign_role';
    Name = 'OutputAssignRole';
  }

  OutputAssignRoleEntity make() {
    return OutputAssignRoleEntity(client, entopts());
  }




  /// Create a OutputAssignRole (see OutputAssignRoleCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputAssignRole).

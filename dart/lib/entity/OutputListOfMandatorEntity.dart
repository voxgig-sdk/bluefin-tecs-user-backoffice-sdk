...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputListOfMandator and the per-op request/match types).
class OutputListOfMandatorEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputListOfMandatorEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_list_of_mandator';
    name_ = 'output_list_of_mandator';
    Name = 'OutputListOfMandator';
  }

  OutputListOfMandatorEntity make() {
    return OutputListOfMandatorEntity(client, entopts());
  }




  /// Create a OutputListOfMandator (see OutputListOfMandatorCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputListOfMandator).

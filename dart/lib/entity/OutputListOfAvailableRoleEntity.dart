...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputListOfAvailableRole and the per-op request/match types).
class OutputListOfAvailableRoleEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputListOfAvailableRoleEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_list_of_available_role';
    name_ = 'output_list_of_available_role';
    Name = 'OutputListOfAvailableRole';
  }

  OutputListOfAvailableRoleEntity make() {
    return OutputListOfAvailableRoleEntity(client, entopts());
  }




  /// Create a OutputListOfAvailableRole (see OutputListOfAvailableRoleCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputListOfAvailableRole).

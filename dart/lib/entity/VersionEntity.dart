...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (Version and the per-op request/match types).
class VersionEntity extends BluefinTecsUserBackofficeEntityBase {
  ...
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (Version).

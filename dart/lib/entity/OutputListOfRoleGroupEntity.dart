...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputListOfRoleGroup and the per-op request/match types).
class OutputListOfRoleGroupEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputListOfRoleGroupEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_list_of_role_group';
    name_ = 'output_list_of_role_group';
    Name = 'OutputListOfRoleGroup';
  }

  OutputListOfRoleGroupEntity make() {
    return OutputListOfRoleGroupEntity(client, entopts());
  }




  /// Create a OutputListOfRoleGroup (see OutputListOfRoleGroupCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputListOfRoleGroup).

...
// Typed models: see ../BluefinTecsUserBackofficeTypes.dart (OutputListOfTransactionsHistory and the per-op request/match types).
class OutputListOfTransactionsHistoryEntity extends BluefinTecsUserBackofficeEntityBase {
  OutputListOfTransactionsHistoryEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'output_list_of_transactions_history';
    name_ = 'output_list_of_transactions_history';
    Name = 'OutputListOfTransactionsHistory';
  }

  OutputListOfTransactionsHistoryEntity make() {
    return OutputListOfTransactionsHistoryEntity(client, entopts());
  }




  /// Create a OutputListOfTransactionsHistory (see OutputListOfTransactionsHistoryCreateData in
  /// BluefinTecsUserBackofficeTypes.dart). Returns the entity data map (OutputListOfTransactionsHistory).

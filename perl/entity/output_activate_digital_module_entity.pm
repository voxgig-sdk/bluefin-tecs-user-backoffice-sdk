# BluefinTecsUserBackoffice SDK OutputActivateDigitalModule entity
...
package OutputActivateDigitalModuleEntity;
...
sub new {
  ...
  my $self = bless {
    _name => 'output_activate_digital_module',
    _client => $client,
...
sub make {
  ...
  return OutputActivateDigitalModuleEntity->new($self->{_client}, $opts);
}
...
# Returns the current OutputActivateDigitalModule data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of OutputActivateDigitalModule fields).
sub match_get {
  my ($self) = @_;
...
# Create a new OutputActivateDigitalModule.
#
# reqdata: body data hashref (OutputActivateDigitalModuleCreateData shape). ctrl: optional
# per-call control. Returns the created OutputActivateDigitalModule data (hashref); dies

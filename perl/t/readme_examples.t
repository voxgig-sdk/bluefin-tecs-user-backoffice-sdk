...
#      (BluefinTecsUserBackofficeSDK->test) against the real SDK. Captured output is scanned for
...
my $SDK_CLASS = 'BluefinTecsUserBackofficeSDK';
...
# becomes BluefinTecsUserBackofficeSDK->test(<fixtures>); a block that only uses $client gets

...
BASIC_FLOW: {
  ...
  if ($setup->{synthetic_only}) {
    note('live entity test uses synthetic IDs from fixture - set BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_GET_LOGO_ENTID JSON to run live');
...
sub output_get_logo_basic_setup {
  ...
  # skip.
  my $entid_env_raw = $ENV{'BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_GET_LOGO_ENTID'};
  ...
  my $idmap_resolved = BluefinTecsUserBackofficeHelpers::to_map($env->{'BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_GET_LOGO_ENTID'});

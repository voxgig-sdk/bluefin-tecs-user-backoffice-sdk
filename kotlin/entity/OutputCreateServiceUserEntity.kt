...
class OutputCreateServiceUserEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("output_create_service_user", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return OutputCreateServiceUserEntity(this.client, opts)
  }

...
class OutputListOfMandatorEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("output_list_of_mandator", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return OutputListOfMandatorEntity(this.client, opts)
  }

...
class OutputListOfTransactionsHistoryEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("output_list_of_transactions_history", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return OutputListOfTransactionsHistoryEntity(this.client, opts)
  }

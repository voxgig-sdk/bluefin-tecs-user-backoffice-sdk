...
class OutputGetKycDocumentEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("output_get_kyc_document", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return OutputGetKycDocumentEntity(this.client, opts)
  }

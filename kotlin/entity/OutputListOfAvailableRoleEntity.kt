...
class OutputListOfAvailableRoleEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("output_list_of_available_role", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return OutputListOfAvailableRoleEntity(this.client, opts)
  }

...
class OutputActivateDigitalModuleEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("output_activate_digital_module", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return OutputActivateDigitalModuleEntity(this.client, opts)
  }

...
class OutputActivatePortalModuleEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("output_activate_portal_module", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return OutputActivatePortalModuleEntity(this.client, opts)
  }

...
class OutputUpdateConsumerEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("output_update_consumer", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return OutputUpdateConsumerEntity(this.client, opts)
  }

...
class OutputActivateStoreModuleEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("output_activate_store_module", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return OutputActivateStoreModuleEntity(this.client, opts)
  }

...
fun resultBasic(ctx: Context): voxgig.bluefintecsuserbackofficesdk.core.Result {
...
fun resultBody(ctx: Context): voxgig.bluefintecsuserbackofficesdk.core.Result {
  val response = ctx.response
  val result = ctx.result
...
fun resultHeaders(ctx: Context): voxgig.bluefintecsuserbackofficesdk.core.Result {
  val response = ctx.response
  val result = ctx.result

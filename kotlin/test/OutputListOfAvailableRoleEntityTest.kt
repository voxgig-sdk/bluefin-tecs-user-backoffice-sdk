...
class OutputListOfAvailableRoleEntityTest {
  ...
  fun basic() {
    ...
    outputListOfAvailableRoleRef01Data = Helpers.toMapAny(outputListOfAvailableRoleRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun outputListOfAvailableRoleBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_LIST_OF_AVAILABLE_ROLE_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_LIST_OF_AVAILABLE_ROLE_ENTID"] = idmap

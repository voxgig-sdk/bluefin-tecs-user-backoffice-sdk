...
class OutputCreateServiceUserEntityTest {
  ...
  fun basic() {
    ...
    outputCreateServiceUserRef01Data = Helpers.toMapAny(outputCreateServiceUserRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun outputCreateServiceUserBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_CREATE_SERVICE_USER_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_CREATE_SERVICE_USER_ENTID"] = idmap

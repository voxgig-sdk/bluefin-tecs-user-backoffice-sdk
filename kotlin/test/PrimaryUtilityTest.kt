...
import voxgig.bluefintecsuserbackofficesdk.sdktest.RunnerSupport.getSpec
import voxgig.bluefintecsuserbackofficesdk.sdktest.RunnerSupport.loadTestSpec
import voxgig.bluefintecsuserbackofficesdk.sdktest.RunnerSupport.makeCtxFromMap
import voxgig.bluefintecsuserbackofficesdk.sdktest.RunnerSupport.runset
...
class PrimaryUtilityTest {
  ...
  private fun client(): BluefinTecsUserBackofficeSDK = BluefinTecsUserBackofficeSDK.testSDK()

  private fun makeTestCtx(client: BluefinTecsUserBackofficeSDK, utility: Utility, overrides: MutableMap<String, Any?>?): Context {
  ...
  private fun makeTestFullCtx(client: BluefinTecsUserBackofficeSDK, utility: Utility): Context {
  ...
  fun fetcherLive() {
    ...
    val liveClient = BluefinTecsUserBackofficeSDK(
      fhMap(
        "system",
        fhMap(
          "fetch",
  ...
  fun fetcherBlockedTestMode() {
    val blockedClient = BluefinTecsUserBackofficeSDK(
      fhMap(
        "system",
  ...
  fun makeSpecBasic() {
    ...
    val specClient = BluefinTecsUserBackofficeSDK.testSDK(null, setupOpts)
  ...
  fun prepareAuthBasic() {
    ...
    val authClient = BluefinTecsUserBackofficeSDK.testSDK(null, setupOpts)

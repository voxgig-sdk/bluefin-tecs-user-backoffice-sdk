...
class PrimaryUtilityTest {
  ...
  companion object {
    ...
    private var CLIENT: BluefinTecsUserBackofficeSDK? = null
    ...
    fun run(): OmniResolver.Run {
      var r = RUN
      if (null == r) {
        val client = BluefinTecsUserBackofficeSDK.testSDK()
        CLIENT = client
    ...
    fun client(): BluefinTecsUserBackofficeSDK {
      run()
      return CLIENT!!
    }
  ...
  fun featureHookBasic() {
    val hookClient = BluefinTecsUserBackofficeSDK.testSDK()
  ...
  fun featureInitBasic() {
    val initClient = BluefinTecsUserBackofficeSDK.testSDK()

...
class OutputProvideCredentialEntityTest {
  ...
  fun basic() {
    ...
    outputProvideCredentialRef01Data = Helpers.toMapAny(outputProvideCredentialRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun outputProvideCredentialBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_PROVIDE_CREDENTIAL_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_PROVIDE_CREDENTIAL_ENTID"] = idmap

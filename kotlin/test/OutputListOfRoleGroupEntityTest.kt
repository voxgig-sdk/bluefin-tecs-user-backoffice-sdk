...
class OutputListOfRoleGroupEntityTest {
  ...
  fun basic() {
    ...
    outputListOfRoleGroupRef01Data = Helpers.toMapAny(outputListOfRoleGroupRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun outputListOfRoleGroupBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_LIST_OF_ROLE_GROUP_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_LIST_OF_ROLE_GROUP_ENTID"] = idmap

...
class OutputChangeLogoEntityTest {
  ...
  fun basic() {
    ...
    outputChangeLogoRef01Data = Helpers.toMapAny(outputChangeLogoRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun outputChangeLogoBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_CHANGE_LOGO_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_CHANGE_LOGO_ENTID"] = idmap

...
class OutputGetKycDocumentEntityTest {
  ...
  fun basic() {
    ...
    outputGetKycDocumentRef01Data = Helpers.toMapAny(if (outputGetKycDocumentRef01DataResult is SdkEntity) outputGetKycDocumentRef01DataResult.data() else outputGetKycDocumentRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun outputGetKycDocumentBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_GET_KYC_DOCUMENT_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_GET_KYC_DOCUMENT_ENTID"] = idmap

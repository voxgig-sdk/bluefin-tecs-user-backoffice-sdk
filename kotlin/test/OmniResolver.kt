...
object OmniResolver {
  ...
  class Run internal constructor(
    ...
    val client: BluefinTecsUserBackofficeSDK?,
  ) {
   ...
   */
  fun makeRunner(testfile: Any?, client: BluefinTecsUserBackofficeSDK?): NamedRunner {
  ...
  private fun sdkProvider(client: BluefinTecsUserBackofficeSDK?): Provider = Provider(
    ...
    client = { options ->
      ...
      sdkProvider(BluefinTecsUserBackofficeSDK.testSDK(null, opts ?: linkedMapOf()))
    },
   ...
   * per section, by hand.)
   */
  fun omniCtx(arg: Any?, client: BluefinTecsUserBackofficeSDK?, utility: Utility?): Context {

...
class OutputActivateUserEntityTest {
  ...
  fun basic() {
    ...
    outputActivateUserRef01Data = Helpers.toMapAny(outputActivateUserRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun outputActivateUserBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_ACTIVATE_USER_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_ACTIVATE_USER_ENTID"] = idmap

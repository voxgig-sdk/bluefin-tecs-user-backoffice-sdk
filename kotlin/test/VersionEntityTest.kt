...
class VersionEntityTest {
  ...
  companion object {
    fun versionBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFIN_TECS_USER_BACKOFFICE_TEST_VERSION_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFIN_TECS_USER_BACKOFFICE_TEST_VERSION_ENTID"] = idmap
      ...
      var idmapResolved = Helpers.toMapAny(env["BLUEFIN_TECS_USER_BACKOFFICE_TEST_VERSION_ENTID"])

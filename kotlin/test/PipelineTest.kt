...
class PipelineTest {
  ...
  private fun plClient(sdkopts: MutableMap<String, Any?>?): BluefinTecsUserBackofficeSDK {
    return BluefinTecsUserBackofficeSDK.testSDK(null, sdkopts)
  }

  private fun plCtx(client: BluefinTecsUserBackofficeSDK, utility: Utility, ctrl: MutableMap<String, Any?>?): Context {
  ...
  private fun names(client: BluefinTecsUserBackofficeSDK): String {

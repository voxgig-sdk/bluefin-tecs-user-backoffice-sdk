...
class OutputCreateMandatorEntityTest {
  ...
  fun basic() {
    ...
    outputCreateMandatorRef01Data = Helpers.toMapAny(if (outputCreateMandatorRef01DataResult is SdkEntity) outputCreateMandatorRef01DataResult.data() else outputCreateMandatorRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun outputCreateMandatorBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_CREATE_MANDATOR_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_CREATE_MANDATOR_ENTID"] = idmap

...
object RunnerSupport {
  ...
  fun makeCtxFromMap(ctxmapIn: MutableMap<String, Any?>?, client: BluefinTecsUserBackofficeSDK?, utility: Utility?): Context {
  ...
  fun fixctx(ctx: Context?, client: BluefinTecsUserBackofficeSDK?) {

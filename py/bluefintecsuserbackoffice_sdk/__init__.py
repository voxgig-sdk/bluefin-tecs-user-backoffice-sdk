...
from bluefintecsuserbackoffice_sdk.core.utility_type import BluefinTecsUserBackofficeUtility
...
from bluefintecsuserbackoffice_sdk.utility import register

# Load features
from bluefintecsuserbackoffice_sdk.feature.base_feature import BluefinTecsUserBackofficeBaseFeature
from bluefintecsuserbackoffice_sdk.features import _has_feature, _make_feature
...
class BluefinTecsUserBackofficeSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "BluefinTecsUserBackofficeSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BluefinTecsUserBackofficeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def OutputActivateDigitalModule(self, data=None) -> "OutputActivateDigitalModuleEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_activate_digital_module_entity import OutputActivateDigitalModuleEntity
    ...
    def OutputActivatePortalModule(self, data=None) -> "OutputActivatePortalModuleEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_activate_portal_module_entity import OutputActivatePortalModuleEntity
    ...
    def OutputActivateStoreModule(self, data=None) -> "OutputActivateStoreModuleEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_activate_store_module_entity import OutputActivateStoreModuleEntity
    ...
    def OutputActivateUser(self, data=None) -> "OutputActivateUserEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_activate_user_entity import OutputActivateUserEntity
    ...
    def OutputAssignRole(self, data=None) -> "OutputAssignRoleEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_assign_role_entity import OutputAssignRoleEntity
    ...
    def OutputChangeLogo(self, data=None) -> "OutputChangeLogoEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_change_logo_entity import OutputChangeLogoEntity
    ...
    def OutputCreateMandator(self, data=None) -> "OutputCreateMandatorEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_create_mandator_entity import OutputCreateMandatorEntity
    ...
    def OutputCreateServiceUser(self, data=None) -> "OutputCreateServiceUserEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_create_service_user_entity import OutputCreateServiceUserEntity
    ...
    def OutputDeactivateUser(self, data=None) -> "OutputDeactivateUserEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_deactivate_user_entity import OutputDeactivateUserEntity
    ...
    def OutputGetKycDocument(self, data=None) -> "OutputGetKycDocumentEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_get_kyc_document_entity import OutputGetKycDocumentEntity
    ...
    def OutputGetLogo(self, data=None) -> "OutputGetLogoEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_get_logo_entity import OutputGetLogoEntity
    ...
    def OutputListOfAvailableRole(self, data=None) -> "OutputListOfAvailableRoleEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_list_of_available_role_entity import OutputListOfAvailableRoleEntity
    ...
    def OutputListOfMandator(self, data=None) -> "OutputListOfMandatorEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_list_of_mandator_entity import OutputListOfMandatorEntity
    ...
    def OutputListOfModule(self, data=None) -> "OutputListOfModuleEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_list_of_module_entity import OutputListOfModuleEntity
    ...
    def OutputListOfRoleGroup(self, data=None) -> "OutputListOfRoleGroupEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_list_of_role_group_entity import OutputListOfRoleGroupEntity
    ...
    def OutputListOfTransactionsHistory(self, data=None) -> "OutputListOfTransactionsHistoryEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_list_of_transactions_history_entity import OutputListOfTransactionsHistoryEntity
    ...
    def OutputListOfUser(self, data=None) -> "OutputListOfUserEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_list_of_user_entity import OutputListOfUserEntity
    ...
    def OutputProvideCredential(self, data=None) -> "OutputProvideCredentialEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_provide_credential_entity import OutputProvideCredentialEntity
    ...
    def OutputRegisterUser(self, data=None) -> "OutputRegisterUserEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_register_user_entity import OutputRegisterUserEntity
    ...
    def OutputRemoveRole(self, data=None) -> "OutputRemoveRoleEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_remove_role_entity import OutputRemoveRoleEntity
    ...
    def OutputResendLink(self, data=None) -> "OutputResendLinkEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_resend_link_entity import OutputResendLinkEntity
    ...
    def OutputResetPassword(self, data=None) -> "OutputResetPasswordEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_reset_password_entity import OutputResetPasswordEntity
    ...
    def OutputUpdateConsumer(self, data=None) -> "OutputUpdateConsumerEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_update_consumer_entity import OutputUpdateConsumerEntity
    ...
    def OutputUpdateProfile(self, data=None) -> "OutputUpdateProfileEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.output_update_profile_entity import OutputUpdateProfileEntity
    ...
    def Version(self, data=None) -> "VersionEntity":
        ...
        from bluefintecsuserbackoffice_sdk.entity.version_entity import VersionEntity

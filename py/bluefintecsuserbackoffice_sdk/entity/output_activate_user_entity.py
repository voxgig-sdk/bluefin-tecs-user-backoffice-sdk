...
class OutputActivateUserEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputActivateUserEntity(self._client, opts)
    ...
    def data_get(self) -> OutputActivateUser:
    ...
    def match_get(self) -> OutputActivateUser:
    ...
    def create(self, reqdata: OutputActivateUserCreateData, ctrl=None) -> OutputActivateUser:
        utility = self._utility

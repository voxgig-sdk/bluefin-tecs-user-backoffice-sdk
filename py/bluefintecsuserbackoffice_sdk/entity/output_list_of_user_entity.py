...
class OutputListOfUserEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputListOfUserEntity(self._client, opts)
    ...
    def data_get(self) -> OutputListOfUser:
    ...
    def match_get(self) -> OutputListOfUser:
    ...
    def create(self, reqdata: OutputListOfUserCreateData, ctrl=None) -> OutputListOfUser:
        utility = self._utility

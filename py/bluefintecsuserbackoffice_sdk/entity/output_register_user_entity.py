...
class OutputRegisterUserEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputRegisterUserEntity(self._client, opts)
    ...
    def data_get(self) -> OutputRegisterUser:
    ...
    def match_get(self) -> OutputRegisterUser:
    ...
    def create(self, reqdata: OutputRegisterUserCreateData, ctrl=None) -> OutputRegisterUser:
        utility = self._utility

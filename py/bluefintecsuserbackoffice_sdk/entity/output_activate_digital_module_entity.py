...
class OutputActivateDigitalModuleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputActivateDigitalModuleEntity(self._client, opts)
    ...
    def data_get(self) -> OutputActivateDigitalModule:
    ...
    def match_get(self) -> OutputActivateDigitalModule:
    ...
    def create(self, reqdata: OutputActivateDigitalModuleCreateData, ctrl=None) -> OutputActivateDigitalModule:
        utility = self._utility

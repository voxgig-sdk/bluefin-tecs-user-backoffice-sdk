...
class OutputAssignRoleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputAssignRoleEntity(self._client, opts)
    ...
    def data_get(self) -> OutputAssignRole:
    ...
    def match_get(self) -> OutputAssignRole:
    ...
    def create(self, reqdata: OutputAssignRoleCreateData, ctrl=None) -> OutputAssignRole:
        utility = self._utility

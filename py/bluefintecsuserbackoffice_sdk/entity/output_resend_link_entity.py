...
class OutputResendLinkEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputResendLinkEntity(self._client, opts)
    ...
    def data_get(self) -> OutputResendLink:
    ...
    def match_get(self) -> OutputResendLink:
    ...
    def create(self, reqdata: OutputResendLinkCreateData, ctrl=None) -> OutputResendLink:
        utility = self._utility

...
class OutputCreateServiceUserEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputCreateServiceUserEntity(self._client, opts)
    ...
    def data_get(self) -> OutputCreateServiceUser:
    ...
    def match_get(self) -> OutputCreateServiceUser:
    ...
    def create(self, reqdata: OutputCreateServiceUserCreateData, ctrl=None) -> OutputCreateServiceUser:
        utility = self._utility

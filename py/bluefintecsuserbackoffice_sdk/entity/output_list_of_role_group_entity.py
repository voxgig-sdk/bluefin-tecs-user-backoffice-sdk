...
class OutputListOfRoleGroupEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputListOfRoleGroupEntity(self._client, opts)
    ...
    def data_get(self) -> OutputListOfRoleGroup:
    ...
    def match_get(self) -> OutputListOfRoleGroup:
    ...
    def create(self, reqdata: OutputListOfRoleGroupCreateData, ctrl=None) -> OutputListOfRoleGroup:
        utility = self._utility

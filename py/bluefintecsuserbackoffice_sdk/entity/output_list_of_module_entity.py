...
class OutputListOfModuleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputListOfModuleEntity(self._client, opts)
    ...
    def data_get(self) -> OutputListOfModule:
    ...
    def match_get(self) -> OutputListOfModule:
    ...
    def create(self, reqdata: OutputListOfModuleCreateData, ctrl=None) -> OutputListOfModule:
        utility = self._utility

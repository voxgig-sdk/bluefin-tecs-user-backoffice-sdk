...
class OutputActivateStoreModuleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputActivateStoreModuleEntity(self._client, opts)
    ...
    def data_get(self) -> OutputActivateStoreModule:
    ...
    def match_get(self) -> OutputActivateStoreModule:
    ...
    def create(self, reqdata: OutputActivateStoreModuleCreateData, ctrl=None) -> OutputActivateStoreModule:
        utility = self._utility

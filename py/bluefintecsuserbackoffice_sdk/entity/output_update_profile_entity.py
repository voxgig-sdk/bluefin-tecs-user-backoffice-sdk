...
class OutputUpdateProfileEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputUpdateProfileEntity(self._client, opts)
    ...
    def data_get(self) -> OutputUpdateProfile:
    ...
    def match_get(self) -> OutputUpdateProfile:
    ...
    def create(self, reqdata: OutputUpdateProfileCreateData, ctrl=None) -> OutputUpdateProfile:
        utility = self._utility

...
class OutputActivatePortalModuleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputActivatePortalModuleEntity(self._client, opts)
    ...
    def data_get(self) -> OutputActivatePortalModule:
    ...
    def match_get(self) -> OutputActivatePortalModule:
    ...
    def create(self, reqdata: OutputActivatePortalModuleCreateData, ctrl=None) -> OutputActivatePortalModule:
        utility = self._utility

...
class OutputProvideCredentialEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputProvideCredentialEntity(self._client, opts)
    ...
    def data_get(self) -> OutputProvideCredential:
    ...
    def match_get(self) -> OutputProvideCredential:
    ...
    def create(self, reqdata: OutputProvideCredentialCreateData, ctrl=None) -> OutputProvideCredential:
        utility = self._utility

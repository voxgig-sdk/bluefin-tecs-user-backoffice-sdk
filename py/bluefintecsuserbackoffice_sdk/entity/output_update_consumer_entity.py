...
class OutputUpdateConsumerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputUpdateConsumerEntity(self._client, opts)
    ...
    def data_get(self) -> OutputUpdateConsumer:
    ...
    def match_get(self) -> OutputUpdateConsumer:
    ...
    def create(self, reqdata: OutputUpdateConsumerCreateData, ctrl=None) -> OutputUpdateConsumer:
        utility = self._utility

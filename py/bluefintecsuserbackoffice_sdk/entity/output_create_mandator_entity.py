...
class OutputCreateMandatorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputCreateMandatorEntity(self._client, opts)
    ...
    def data_get(self) -> OutputCreateMandator:
    ...
    def match_get(self) -> OutputCreateMandator:
    ...
    def create(self, reqdata: OutputCreateMandatorCreateData, ctrl=None) -> OutputCreateMandator:
        utility = self._utility

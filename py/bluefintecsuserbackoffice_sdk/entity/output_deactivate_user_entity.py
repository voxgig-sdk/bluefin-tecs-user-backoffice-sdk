...
class OutputDeactivateUserEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputDeactivateUserEntity(self._client, opts)
    ...
    def data_get(self) -> OutputDeactivateUser:
    ...
    def match_get(self) -> OutputDeactivateUser:
    ...
    def create(self, reqdata: OutputDeactivateUserCreateData, ctrl=None) -> OutputDeactivateUser:
        utility = self._utility

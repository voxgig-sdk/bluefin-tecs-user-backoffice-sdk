...
class OutputListOfAvailableRoleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputListOfAvailableRoleEntity(self._client, opts)
    ...
    def data_get(self) -> OutputListOfAvailableRole:
    ...
    def match_get(self) -> OutputListOfAvailableRole:
    ...
    def create(self, reqdata: OutputListOfAvailableRoleCreateData, ctrl=None) -> OutputListOfAvailableRole:
        utility = self._utility

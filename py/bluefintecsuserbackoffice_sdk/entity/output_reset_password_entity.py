...
class OutputResetPasswordEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputResetPasswordEntity(self._client, opts)
    ...
    def data_get(self) -> OutputResetPassword:
    ...
    def match_get(self) -> OutputResetPassword:
    ...
    def create(self, reqdata: OutputResetPasswordCreateData, ctrl=None) -> OutputResetPassword:
        utility = self._utility

...
class OutputGetKycDocumentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputGetKycDocumentEntity(self._client, opts)
    ...
    def data_get(self) -> OutputGetKycDocument:
    ...
    def match_get(self) -> OutputGetKycDocument:
    ...
    def create(self, reqdata: OutputGetKycDocumentCreateData, ctrl=None) -> OutputGetKycDocument:
        utility = self._utility

...
class OutputGetLogoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputGetLogoEntity(self._client, opts)
    ...
    def data_get(self) -> OutputGetLogo:
    ...
    def match_get(self) -> OutputGetLogo:
    ...
    def load(self, reqmatch=None, ctrl=None) -> OutputGetLogo:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.OutputGetLogo().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}

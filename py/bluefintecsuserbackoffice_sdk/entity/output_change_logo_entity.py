...
class OutputChangeLogoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputChangeLogoEntity(self._client, opts)
    ...
    def data_get(self) -> OutputChangeLogo:
    ...
    def match_get(self) -> OutputChangeLogo:
    ...
    def create(self, reqdata: OutputChangeLogoCreateData, ctrl=None) -> OutputChangeLogo:
        utility = self._utility

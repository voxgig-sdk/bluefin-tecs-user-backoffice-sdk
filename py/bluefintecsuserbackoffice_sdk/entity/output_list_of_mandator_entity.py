...
class OutputListOfMandatorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputListOfMandatorEntity(self._client, opts)
    ...
    def data_get(self) -> OutputListOfMandator:
    ...
    def match_get(self) -> OutputListOfMandator:
    ...
    def create(self, reqdata: OutputListOfMandatorCreateData, ctrl=None) -> OutputListOfMandator:
        utility = self._utility

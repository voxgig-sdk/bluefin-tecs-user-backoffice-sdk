...
class OutputRemoveRoleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputRemoveRoleEntity(self._client, opts)
    ...
    def data_get(self) -> OutputRemoveRole:
    ...
    def match_get(self) -> OutputRemoveRole:
    ...
    def create(self, reqdata: OutputRemoveRoleCreateData, ctrl=None) -> OutputRemoveRole:
        utility = self._utility

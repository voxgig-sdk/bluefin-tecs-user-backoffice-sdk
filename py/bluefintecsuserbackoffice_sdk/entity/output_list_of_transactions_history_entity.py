...
from bluefintecsuserbackoffice_sdk.bluefintecsuserbackoffice_types import (
...
class OutputListOfTransactionsHistoryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OutputListOfTransactionsHistoryEntity(self._client, opts)
    ...
    def data_get(self) -> OutputListOfTransactionsHistory:
    ...
    def match_get(self) -> OutputListOfTransactionsHistory:
    ...
    def create(self, reqdata: OutputListOfTransactionsHistoryCreateData, ctrl=None) -> OutputListOfTransactionsHistory:
        utility = self._utility

# BluefinTecsUserBackoffice SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BluefinTecsUserBackofficeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BluefinTecsUserBackofficeSDK(...) and BluefinTecsUserBackofficeSDK.test(...) become
#      BluefinTecsUserBackofficeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bluefintecsuserbackoffice_sdk"
_SDK_CLASS = "BluefinTecsUserBackofficeSDK"
...
_ENTITIES = {
    "OutputActivateDigitalModule": "output_activate_digital_module",
    "OutputActivatePortalModule": "output_activate_portal_module",
    "OutputActivateStoreModule": "output_activate_store_module",
    "OutputActivateUser": "output_activate_user",
    "OutputAssignRole": "output_assign_role",
    "OutputChangeLogo": "output_change_logo",
    "OutputCreateMandator": "output_create_mandator",
    "OutputCreateServiceUser": "output_create_service_user",
    "OutputDeactivateUser": "output_deactivate_user",
    "OutputGetKycDocument": "output_get_kyc_document",
    "OutputGetLogo": "output_get_logo",
    "OutputListOfAvailableRole": "output_list_of_available_role",
    "OutputListOfMandator": "output_list_of_mandator",
    "OutputListOfModule": "output_list_of_module",
    "OutputListOfRoleGroup": "output_list_of_role_group",
    "OutputListOfTransactionsHistory": "output_list_of_transactions_history",
    "OutputListOfUser": "output_list_of_user",
    "OutputProvideCredential": "output_provide_credential",
    "OutputRegisterUser": "output_register_user",
    "OutputRemoveRole": "output_remove_role",
    "OutputResendLink": "output_resend_link",
    "OutputResetPassword": "output_reset_password",
    "OutputUpdateConsumer": "output_update_consumer",
    "OutputUpdateProfile": "output_update_profile",
    "Version": "version",
}

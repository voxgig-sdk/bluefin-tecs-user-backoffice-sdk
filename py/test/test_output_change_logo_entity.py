    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_CHANGE_LOGO_ENTID JSON to run live")
        client = setup["client"]
        ...
        output_change_logo_ref01_data = helpers.to_map(output_change_logo_ref01_ent.create(output_change_logo_ref01_data, None))
...
def _output_change_logo_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUEFINTECSUSERBACKOFFICE_TEST_OUTPUT_CHANGE_LOGO_ENTID"))

// Command BluefinTecsUserBackoffice-mcp is an MCP server exposing the BluefinTecsUserBackoffice
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BluefinTecsUserBackoffice_list  — list records of an entity
//	BluefinTecsUserBackoffice_load  — load a single record of an entity
//

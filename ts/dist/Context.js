...
const BluefinTecsUserBackofficeError_1 = require("./BluefinTecsUserBackofficeError");
...
class Context {
    ...
    error(code, msg) {
        return new BluefinTecsUserBackofficeError_1.BluefinTecsUserBackofficeError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,

...
exports.BluefinTecsUserBackofficeEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends BluefinTecsUserBackofficeEntityBase<Advice>`.
class BluefinTecsUserBackofficeEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.BluefinTecsUserBackofficeEntityBase = BluefinTecsUserBackofficeEntityBase;
//# sourceMappingURL=BluefinTecsUserBackofficeEntityBase.js.map
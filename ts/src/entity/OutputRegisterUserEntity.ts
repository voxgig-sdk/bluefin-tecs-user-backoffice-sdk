...
class OutputRegisterUserEntity extends BluefinTecsUserBackofficeEntityBase<OutputRegisterUser> {
  ...
  make(this: OutputRegisterUserEntity) {
  ...
  async create(this: any, reqdata?: OutputRegisterUserCreateData, ctrl?: Control): Promise<OutputRegisterUserEntity> {

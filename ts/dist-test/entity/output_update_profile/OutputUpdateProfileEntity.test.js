...
(0, node_test_1.describe)('OutputUpdateProfileEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != output_update_profile_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/output_update_profile/OutputUpdateProfileTestData.json');
    ...
    let idmap = transform(['output_update_profile01', 'output_update_profile02', 'output_update_profile03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=OutputUpdateProfileEntity.test.js.map
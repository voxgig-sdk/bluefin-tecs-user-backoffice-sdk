...
(0, node_test_1.describe)('OutputActivatePortalModuleEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'output_activate_portal_module.' + op, live))
                return;
        }
        const setup = basicSetup();
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [{ "active": true, "name": "clientSecret", "req": true, "type": "`$STRING`", "index$": 0 }, { "active": true, "name": "notificationEmail", "req": true, "type": "`$STRING`", "index$": 1 }, { "active": true, "format": "int32", "name": "responseCode", "req": false, "type": "`$INTEGER`", "index$": 2 }, { "active": true, "name": "responseMessage", "req": false, "type": "`$STRING`", "index$": 3 }], "name": "output_activate_portal_module", "op": { "create": { "input": "data", "name": "create", "points": [{ "active": true, "args": { "header": [{ "active": true, "kind": "header", "name": "authorization", "orig": "authorization", "reqd": true, "type": "`$STRING`" }] }, "contract": { "id": "POST /activateMerchantPortalModule", "json": "{\"operationId\":\"activatePortalModule\",\"parameters\":[{\"in\":\"header\",\"name\":\"Authorization\",\"required\":true,\"schema\":{\"type\":\"string\"}}],\"protocol\":\"http\",\"requestBody\":{\"content\":{\"application/json\":{\"schema\":{\"properties\":{\"clientSecret\":{\"type\":\"string\"},\"notificationEmail\":{\"type\":\"string\"}},\"required\":[\"clientSecret\",\"notificationEmail\"],\"type\":\"object\"}}},\"required\":true},\"responses\":{\"200\":{\"content\":{\"application/json\":{\"schema\":{\"properties\":{\"responseCode\":{\"format\":\"int32\",\"type\":\"integer\"},\"responseMessage\":{\"type\":\"string\"}},\"type\":\"object\"}}},\"description\":\"OK\"}},\"security\":[{\"bearer-auth-header\":[]},{\"basic-auth-header\":[]}],\"securitySchemes\":{\"basic-auth-header\":{\"scheme\":\"basic\",\"type\":\"http\"},\"bearer-auth-header\":{\"scheme\":\"bearer\",\"type\":\"http\"}},\"securitySource\":\"operation\"}", "source": "openapi3", "version": 1 }, "kind": "http", "method": "POST", "orig": "/activateMerchantPortalModule", "segments": [{ "lit": "activateMerchantPortalModule" }], "select": { "exist": ["authorization"] }, "transform": { "req": "`reqdata`", "res": "`body`" }, "index$": 0 }], "key$": "create" } }, "relations": { "ancestors": [] }, "key$": "output_activate_portal_module", "name__orig": "output_activate_portal_module", "Name": "OutputActivatePortalModule", "name_": "output_activate_portal_module", "name-": "output-activate-portal-module", "NAME": "OUTPUT_ACTIVATE_PORTAL_MODULE", "index$": 1 }, { "active": true, "entity": "output_activate_portal_module", "key$": "BasicOutputActivatePortalModuleFlow", "kind": "basic", "name": "BasicOutputActivatePortalModuleFlow", "param": {}, "step": [{ "active": true, "data": {}, "input": { "ref": "output_activate_portal_module_ref01" }, "match": {}, "op": "create", "spec": [], "valid": [], "index$": 0 }] }, 'OutputActivatePortalModule');
        }
        ...
        (0, node_assert_1.default)(null != output_activate_portal_module_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/output_activate_portal_module/OutputActivatePortalModuleTestData.json');
    ...
    let idmap = transform(['output_activate_portal_module01', 'output_activate_portal_module02', 'output_activate_portal_module03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=OutputActivatePortalModuleEntity.test.js.map
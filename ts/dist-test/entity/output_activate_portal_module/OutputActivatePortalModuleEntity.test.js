...
(0, node_test_1.describe)('OutputActivatePortalModuleEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'output_activate_portal_module.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_ACTIVATE_PORTAL_MODULE_ENTID'];

...
(0, node_test_1.describe)('OutputGetLogoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.BluefinTecsUserBackofficeSDK({
    ...
    (0, node_test_1.test)('direct-load-output_get_logo', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-output_get_logo', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.BLUEFIN_TECS_USER_BACKOFFICE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BluefinTecsUserBackofficeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
    ...
    const client = new __1.BluefinTecsUserBackofficeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=OutputGetLogoDirect.test.js.map
...
(0, node_test_1.describe)('OutputGetLogoEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'output_get_logo.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_GET_LOGO_ENTID JSON to run live');
            return;
        }
        ...
        let output_get_logo_ref01_data = Object.values(setup.data.existing.output_get_logo)[0];
        // LOAD
        const output_get_logo_ref01_ent = client.OutputGetLogo();
        const output_get_logo_ref01_match_dt0 = {};
        const output_get_logo_ref01_data_dt0 = (await output_get_logo_ref01_ent.load(output_get_logo_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != output_get_logo_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/output_get_logo/OutputGetLogoTestData.json');
    ...
    let idmap = transform(['output_get_logo01', 'output_get_logo02', 'output_get_logo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_GET_LOGO_ENTID'];
...
//# sourceMappingURL=OutputGetLogoEntity.test.js.map
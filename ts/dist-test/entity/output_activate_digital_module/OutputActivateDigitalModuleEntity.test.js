...
(0, node_test_1.describe)('OutputActivateDigitalModuleEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'output_activate_digital_module.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != output_activate_digital_module_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/output_activate_digital_module/OutputActivateDigitalModuleTestData.json');
    ...
    let idmap = transform(['output_activate_digital_module01', 'output_activate_digital_module02', 'output_activate_digital_module03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_ACTIVATE_DIGITAL_MODULE_ENTID'];
...
//# sourceMappingURL=OutputActivateDigitalModuleEntity.test.js.map
...
(0, node_test_1.describe)('OutputListOfAvailableRoleEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'output_list_of_available_role.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_LIST_OF_AVAILABLE_ROLE_ENTID JSON to run live');
            return;
        }
        ...
        (0, node_assert_1.default)(null != output_list_of_available_role_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/output_list_of_available_role/OutputListOfAvailableRoleTestData.json');
    ...
    let idmap = transform(['output_list_of_available_role01', 'output_list_of_available_role02', 'output_list_of_available_role03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_LIST_OF_AVAILABLE_ROLE_ENTID'];
...
//# sourceMappingURL=OutputListOfAvailableRoleEntity.test.js.map
...
(0, node_test_1.describe)('OutputListOfTransactionsHistoryEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'output_list_of_transactions_history.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != output_list_of_transactions_history_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/output_list_of_transactions_history/OutputListOfTransactionsHistoryTestData.json');
    ...
    let idmap = transform(['output_list_of_transactions_history01', 'output_list_of_transactions_history02', 'output_list_of_transactions_history03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_LIST_OF_TRANSACTIONS_HISTORY_ENTID'];
...
//# sourceMappingURL=OutputListOfTransactionsHistoryEntity.test.js.map
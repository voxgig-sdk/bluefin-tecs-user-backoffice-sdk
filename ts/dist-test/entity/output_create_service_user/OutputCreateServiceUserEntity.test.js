...
(0, node_test_1.describe)('OutputCreateServiceUserEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'output_create_service_user.' + op, live))
                return;
        }
        const setup = basicSetup();
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [{ "active": true, "name": "mandatorName", "req": true, "type": "`$STRING`", "index$": 0 }, { "active": true, "format": "int32", "name": "responseCode", "req": false, "type": "`$INTEGER`", "index$": 1 }, { "active": true, "name": "responseMessage", "req": false, "type": "`$STRING`", "index$": 2 }], "name": "output_create_service_user", "op": { "create": { "input": "data", "name": "create", "points": [{ "active": true, "args": { "header": [{ "active": true, "kind": "header", "name": "authorization", "orig": "authorization", "reqd": true, "type": "`$STRING`" }] }, "contract": { "id": "POST /createServiceUser", "json": "{\"operationId\":\"createServiceUser\",\"parameters\":[{\"in\":\"header\",\"name\":\"Authorization\",\"required\":true,\"schema\":{\"type\":\"string\"}}],\"protocol\":\"http\",\"requestBody\":{\"content\":{\"application/json\":{\"schema\":{\"properties\":{\"mandatorName\":{\"type\":\"string\"}},\"required\":[\"mandatorName\"],\"type\":\"object\"}}},\"required\":true},\"responses\":{\"200\":{\"content\":{\"application/json\":{\"schema\":{\"properties\":{\"responseCode\":{\"format\":\"int32\",\"type\":\"integer\"},\"responseMessage\":{\"type\":\"string\"}},\"type\":\"object\"}}},\"description\":\"OK\"}},\"security\":[{\"bearer-auth-header\":[]},{\"basic-auth-header\":[]}],\"securitySchemes\":{\"basic-auth-header\":{\"scheme\":\"basic\",\"type\":\"http\"},\"bearer-auth-header\":{\"scheme\":\"bearer\",\"type\":\"http\"}},\"securitySource\":\"operation\"}", "source": "openapi3", "version": 1 }, "kind": "http", "method": "POST", "orig": "/createServiceUser", "segments": [{ "lit": "createServiceUser" }], "select": { "exist": ["authorization"] }, "transform": { "req": "`reqdata`", "res": "`body`" }, "index$": 0 }], "key$": "create" } }, "relations": { "ancestors": [] }, "key$": "output_create_service_user", "name__orig": "output_create_service_user", "Name": "OutputCreateServiceUser", "name_": "output_create_service_user", "name-": "output-create-service-user", "NAME": "OUTPUT_CREATE_SERVICE_USER", "index$": 7 }, { "active": true, "entity": "output_create_service_user", "key$": "BasicOutputCreateServiceUserFlow", "kind": "basic", "name": "BasicOutputCreateServiceUserFlow", "param": {}, "step": [{ "active": true, "data": {}, "input": { "ref": "output_create_service_user_ref01" }, "match": {}, "op": "create", "spec": [], "valid": [], "index$": 0 }] }, 'OutputCreateServiceUser');
        }
        ...
        (0, node_assert_1.default)(null != output_create_service_user_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/output_create_service_user/OutputCreateServiceUserTestData.json');
    ...
    let idmap = transform(['output_create_service_user01', 'output_create_service_user02', 'output_create_service_user03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=OutputCreateServiceUserEntity.test.js.map
...
(0, node_test_1.describe)('OutputDeactivateUserEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != output_deactivate_user_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/output_deactivate_user/OutputDeactivateUserTestData.json');
    ...
    let idmap = transform(['output_deactivate_user01', 'output_deactivate_user02', 'output_deactivate_user03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_DEACTIVATE_USER_ENTID'];
    const live = 'TRUE' === env.BLUEFIN_TECS_USER_BACKOFFICE_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_DEACTIVATE_USER_ENTID'];
...
//# sourceMappingURL=OutputDeactivateUserEntity.test.js.map
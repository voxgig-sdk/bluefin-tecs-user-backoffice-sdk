...
(0, node_test_1.describe)('OutputChangeLogoEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'output_change_logo.' + op, live))
                return;
        }
        const setup = basicSetup();
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [{ "active": true, "name": "contentAsBase64", "req": true, "short": "The content of the image as base64 encoded string", "type": "`$STRING`", "index$": 0 }, { "active": true, "name": "mimeType", "req": true, "short": "The MIME type of the image", "type": "`$STRING`", "index$": 1 }, { "active": true, "format": "int32", "name": "responseCode", "req": false, "type": "`$INTEGER`", "index$": 2 }, { "active": true, "name": "responseMessage", "req": false, "type": "`$STRING`", "index$": 3 }], "name": "output_change_logo", "op": { "create": { "input": "data", "name": "create", "points": [{ "active": true, "args": { "header": [{ "active": true, "kind": "header", "name": "authorization", "orig": "authorization", "reqd": true, "type": "`$STRING`" }] }, "contract": { "id": "POST /changeLogo", "json": "{\"operationId\":\"changeLogo\",\"parameters\":[{\"in\":\"header\",\"name\":\"Authorization\",\"required\":true,\"schema\":{\"type\":\"string\"}}],\"protocol\":\"http\",\"requestBody\":{\"content\":{\"application/json\":{\"schema\":{\"properties\":{\"contentAsBase64\":{\"description\":\"The content of the image as base64 encoded string\",\"example\":\"iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAABaElEQVR42mNk\",\"type\":\"string\"},\"mimeType\":{\"description\":\"The MIME type of the image\",\"example\":\"image/png\",\"type\":\"string\"}},\"required\":[\"contentAsBase64\",\"mimeType\"],\"type\":\"object\"}}},\"required\":true},\"responses\":{\"200\":{\"content\":{\"application/json\":{\"schema\":{\"properties\":{\"responseCode\":{\"format\":\"int32\",\"type\":\"integer\"},\"responseMessage\":{\"type\":\"string\"}},\"type\":\"object\"}}},\"description\":\"OK\"}},\"security\":[{\"bearer-auth-header\":[]},{\"basic-auth-header\":[]}],\"securitySchemes\":{\"basic-auth-header\":{\"scheme\":\"basic\",\"type\":\"http\"},\"bearer-auth-header\":{\"scheme\":\"bearer\",\"type\":\"http\"}},\"securitySource\":\"operation\"}", "source": "openapi3", "version": 1 }, "kind": "http", "method": "POST", "orig": "/changeLogo", "segments": [{ "lit": "changeLogo" }], "select": { "exist": ["authorization"] }, "transform": { "req": "`reqdata`", "res": "`body`" }, "index$": 0 }], "key$": "create" } }, "relations": { "ancestors": [] }, "key$": "output_change_logo", "name__orig": "output_change_logo", "Name": "OutputChangeLogo", "name_": "output_change_logo", "name-": "output-change-logo", "NAME": "OUTPUT_CHANGE_LOGO", "index$": 5 }, { "active": true, "entity": "output_change_logo", "key$": "BasicOutputChangeLogoFlow", "kind": "basic", "name": "BasicOutputChangeLogoFlow", "param": {}, "step": [{ "active": true, "data": {}, "input": { "ref": "output_change_logo_ref01" }, "match": {}, "op": "create", "spec": [], "valid": [], "index$": 0 }] }, 'OutputChangeLogo');
        }
        ...
        (0, node_assert_1.default)(null != output_change_logo_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/output_change_logo/OutputChangeLogoTestData.json');
    ...
    let idmap = transform(['output_change_logo01', 'output_change_logo02', 'output_change_logo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=OutputChangeLogoEntity.test.js.map
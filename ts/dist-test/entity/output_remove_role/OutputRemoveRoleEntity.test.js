...
(0, node_test_1.describe)('OutputRemoveRoleEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'output_remove_role.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != output_remove_role_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/output_remove_role/OutputRemoveRoleTestData.json');
    ...
    let idmap = transform(['output_remove_role01', 'output_remove_role02', 'output_remove_role03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_TECS_USER_BACKOFFICE_TEST_OUTPUT_REMOVE_ROLE_ENTID'];
...
//# sourceMappingURL=OutputRemoveRoleEntity.test.js.map
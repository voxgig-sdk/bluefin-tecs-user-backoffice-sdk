...
const __1 = require("..");
const SDK_NAME = 'BluefinTecsUserBackofficeSDK';
...
const TEST_SEED = { "entity": { "output_activate_digital_module": { "test01": { "id": "test01" } }, "output_activate_portal_module": { "test01": { "id": "test01" } }, "output_activate_store_module": { "test01": { "id": "test01" } }, "output_activate_user": { "test01": { "id": "test01" } }, "output_assign_role": { "test01": { "id": "test01" } }, "output_change_logo": { "test01": { "id": "test01" } }, "output_create_mandator": { "test01": { "id": "test01" } }, "output_create_service_user": { "test01": { "id": "test01" } }, "output_deactivate_user": { "test01": { "id": "test01" } }, "output_get_kyc_document": { "test01": { "id": "test01" } }, "output_get_logo": { "test01": { "id": "test01" } }, "output_list_of_available_role": { "test01": { "id": "test01" } }, "output_list_of_mandator": { "test01": { "id": "test01" } }, "output_list_of_module": { "test01": { "id": "test01" } }, "output_list_of_role_group": { "test01": { "id": "test01" } }, "output_list_of_transactions_history": { "test01": { "id": "test01" } }, "output_list_of_user": { "test01": { "id": "test01" } }, "output_provide_credential": { "test01": { "id": "test01" } }, "output_register_user": { "test01": { "id": "test01" } }, "output_remove_role": { "test01": { "id": "test01" } }, "output_resend_link": { "test01": { "id": "test01" } }, "output_reset_password": { "test01": { "id": "test01" } }, "output_update_consumer": { "test01": { "id": "test01" } }, "output_update_profile": { "test01": { "id": "test01" } }, "version": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+BluefinTecsUserBackofficeSDK\b/.test(code) ||
        /\bBluefinTecsUserBackofficeSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+BluefinTecsUserBackofficeSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/BluefinTecsUserBackofficeSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);

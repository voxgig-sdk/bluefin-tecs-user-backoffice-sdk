...
|---|---|---|
| `js/` | @voxgig-sdk/bluefin-tecs-user-backoffice-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/bluefin-tecs-user-backoffice | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/bluefin-tecs-user-backoffice-js \
      --repository voxgig-sdk/bluefin-tecs-user-backoffice-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/bluefin-tecs-user-backoffice-js` shows it, and
`npm trust revoke @voxgig-sdk/bluefin-tecs-user-backoffice-js --id=<id>` removes it.

...
class PrimaryUtilityTest < Minitest::Test
  ...
  def test_feature_add_basic
    ...
    feature = BluefinTecsUserBackofficeBaseFeature.new
  ...
  def test_feature_hook_basic
    hook_client = BluefinTecsUserBackofficeSDK.test(nil, nil)
  ...
  def test_feature_init_basic
    init_client = BluefinTecsUserBackofficeSDK.test(nil, nil)
  ...
  def test_fetcher_live
    calls = []
    live_client = BluefinTecsUserBackofficeSDK.new({
      "system" => {
        "fetch" => ->(url, fetchdef) {
  ...
  def test_fetcher_blocked_test_mode
    blocked_client = BluefinTecsUserBackofficeSDK.new({
      "system" => {
        "fetch" => ->(url, fetchdef) {
          return {}, nil
        },
  ...
  def test_make_spec_basic
    ...
    spec_client = BluefinTecsUserBackofficeSDK.test(nil, setup_opts)
  ...
  def test_operator_basic
    runset(get_spec(@primary, "operator", "basic")) do |entry|
      in_val = entry["in"] || {}
      op = BluefinTecsUserBackofficeOperation.new(in_val)
      {
        "entity" => op.entity,
        "name" => op.name,
        "input" => op.input,
  ...
  def test_prepare_auth_basic
    ...
    auth_client = BluefinTecsUserBackofficeSDK.test(nil, setup_opts)
  ...
  def make_ctx_from_map(ctxmap, client, utility)
    ...
    ctx = BluefinTecsUserBackofficeContext.new(ctxmap, nil)
  ...
  def err_from_map(m)
    ...
    code = m["code"] || ""
    BluefinTecsUserBackofficeError.new(code, msg)
  end
end

...
internal static class Fh
{
    ...
    {
        return err is BluefinTecsUserBackofficeError se ? se.Code : "";
    }
}
...
public class FeaturePagingTest
{
    ...
    public void StampsPageLimitAndReadsHeaders()
    {
        ...
        Assert.Equal(2, BluefinTecsUserBackofficeSdk.Helpers.ToInt(paging["nextPage"]));
        Assert.Equal(5, BluefinTecsUserBackofficeSdk.Helpers.ToInt(paging["totalCount"]));

...
public class PipelineTest
{
    ...
    private static (BluefinTecsUserBackofficeSDK, Utility) PlClient(Dictionary<string, object?>? sdkopts)
    {
        var client = BluefinTecsUserBackofficeSDK.TestSDK(null, sdkopts);
        return (client, client.GetUtility());
    }

    private static Context PlCtx(BluefinTecsUserBackofficeSDK client, Utility utility,
    ...
    private static string ErrCode(Action act)
    {
        ...
        catch (BluefinTecsUserBackofficeError err)
        {
            return err.Code;
        }
        catch (Exception)
    ...
    private class PlEntity : IEntity
    {
        ...
        // BluefinTecsUserBackofficeEntityBase: `remove` marks the instance, which keeps the
    ...
    private static Utility UtilWith(BluefinTecsUserBackofficeSDK client, FetcherFunc fetcher)
    {
    ...
    public void MakeRequestTransportErrorCarriedOnResponse()
    {
        ...
        Assert.True(resp.Err is BluefinTecsUserBackofficeError pe && pe.Code == "boom",

...
public class PrimaryUtilityTest
{
    ...
    private readonly BluefinTecsUserBackofficeSDK _client;
    ...
    public PrimaryUtilityTest()
    {
        ...
        _client = BluefinTecsUserBackofficeSDK.TestSDK(null, null);
        _utility = _client.GetUtility();
    }

    // Helper: create basic test context.
    private Context MakeTestCtx(BluefinTecsUserBackofficeSDK client, Utility utility,
    ...
    private Context MakeTestFullCtx(BluefinTecsUserBackofficeSDK client, Utility utility)
    {

// BluefinTecsUserBackofficeError: the SDK error type (mirrors go core/error.go / the rust
...
pub const BluefinTecsUserBackofficeError = struct {
    sdk: []const u8 = "BluefinTecsUserBackoffice",
    code: []const u8,
    msg: []const u8,
    ...
    pub fn make(code: []const u8, msg: []const u8) *BluefinTecsUserBackofficeError {
        const e = mem.a().create(BluefinTecsUserBackofficeError) catch unreachable;
        e.* = .{ .sdk = "BluefinTecsUserBackoffice", .code = code, .msg = msg };
        return e;
    }
};

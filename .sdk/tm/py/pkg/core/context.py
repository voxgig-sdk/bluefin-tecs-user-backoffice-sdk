...
from projectname_sdk.core.control import BluefinTecsUserBackofficeControl
...
class BluefinTecsUserBackofficeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BluefinTecsUserBackofficeControl()
        ...
        if isinstance(sp, BluefinTecsUserBackofficeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BluefinTecsUserBackofficeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BluefinTecsUserBackofficeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BluefinTecsUserBackofficeOperation({})
        ...
        op = BluefinTecsUserBackofficeOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return BluefinTecsUserBackofficeError(code, msg, self)

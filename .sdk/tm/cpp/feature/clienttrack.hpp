// BluefinTecsUserBackoffice SDK — clienttrack feature (mirrors java feature/ClienttrackFeature.java).
...
private:
  std::string name() {
    std::string nm = fopt::foptStr(options, "clientName", "BluefinTecsUserBackoffice-SDK");

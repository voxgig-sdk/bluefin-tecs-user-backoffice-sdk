...
pub trait BluefinTecsUserBackofficeEntity: Entity {
    fn load(&self, reqmatch: Value, ctrl: Value) -> Result<Value, BluefinTecsUserBackofficeError>;
    fn list(&self, reqmatch: Value, ctrl: Value) -> Result<Value, BluefinTecsUserBackofficeError>;
    fn create(&self, reqdata: Value, ctrl: Value) -> Result<Value, BluefinTecsUserBackofficeError>;
    fn update(&self, reqdata: Value, ctrl: Value) -> Result<Value, BluefinTecsUserBackofficeError>;
    fn remove(&self, reqmatch: Value, ctrl: Value) -> Result<Value, BluefinTecsUserBackofficeError>;
}

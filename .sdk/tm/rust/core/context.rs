...
pub struct CtxSpec {
    ...
    pub client: Option<Rc<BluefinTecsUserBackofficeSDK>>,
...
pub struct Context {
    ...
    pub client: RefCell<Option<Rc<BluefinTecsUserBackofficeSDK>>>,
...
impl Context {
    ...
    pub fn make_error(&self, code: &str, msg: &str) -> BluefinTecsUserBackofficeError {

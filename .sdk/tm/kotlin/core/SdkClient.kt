...
/**
 * Shared client runtime for the BluefinTecsUserBackoffice SDK. The generated
 * BluefinTecsUserBackofficeSDK class extends this with the API-specific entity accessors;
  ...
  fun graphql(
    ...
    if (null != errors && errors.isNotEmpty()) {
      ...
      res["err"] = SdkError("graphql_error",
        "BluefinTecsUserBackofficeSDK: graphql: " + msg, null)
      res["graphql"] = errors
    }

# BluefinTecsUserBackoffice SDK clienttrack feature
#
...
package BluefinTecsUserBackofficeClienttrackFeature;
...
sub _client_name {
  ...
  my $name = defined $self->{options}{clientName}
    ? $self->{options}{clientName} : 'BluefinTecsUserBackoffice-SDK';

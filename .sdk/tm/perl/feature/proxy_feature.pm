# BluefinTecsUserBackoffice SDK proxy feature
#
...
package BluefinTecsUserBackofficeProxyFeature;
...
sub init {
  ...
  if (BluefinTecsUserBackofficeHelpers::is_true($self->{options}{fromEnv})) {
    $self->{url} = $self->{url}

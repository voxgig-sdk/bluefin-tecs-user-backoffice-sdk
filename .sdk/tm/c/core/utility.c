...
// ---- SDK client-base generic helpers (Main.fragment BluefinTecsUserBackofficeSDK) -------
...
voxgig_value* sdk_options_map(BluefinTecsUserBackofficeSDK* sdk) { return voxgig_clone(sdk->options); }

Utility* sdk_get_utility(BluefinTecsUserBackofficeSDK* sdk) { return utility_copy(sdk->utility); }

Context* sdk_get_root_ctx(BluefinTecsUserBackofficeSDK* sdk) { return sdk->rootctx; }

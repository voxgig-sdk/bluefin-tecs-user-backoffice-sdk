...
static void test_primary_fetcher_live(void) {
  ...
  BluefinTecsUserBackofficeSDK* live = projectname_sdk_new(
...
static void test_primary_fetcher_blocked_test_mode(void) {
  BluefinTecsUserBackofficeSDK* blocked = projectname_sdk_new(
...
static void test_primary_new_sdk_smoke(void) {
  BluefinTecsUserBackofficeSDK* client = projectname_sdk_new(v_undef());

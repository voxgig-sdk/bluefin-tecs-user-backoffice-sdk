...
static Context* corpus_ctx(BluefinTecsUserBackofficeSDK* cl, voxgig_value* ctxmap) {
  CtxSpec cs;
...
static void runset(const char* name, BluefinTecsUserBackofficeSDK* cl,
                        ctxfn cf, argfn af) {
...
static BluefinTecsUserBackofficeSDK* SHARED = NULL;
...
static BluefinTecsUserBackofficeSDK* client_for(const char* section) {

...
final class PrimaryUtilityTest: XCTestCase {
  ...
  private static func primaryRun() throws -> OmniResolver.Run {
    ...
    let run = try OmniResolver.makeRunner(
      SdkRunner.testJsonPath(), BluefinTecsUserBackofficeSDK.testSDK(nil, nil))("primary")
    RUN = run
    return run
  }

  // XCTestCase has no custom init; set these up per test.
  private var client: BluefinTecsUserBackofficeSDK!
  private var utility: Utility!

  override func setUp() {
    super.setUp()
    client = BluefinTecsUserBackofficeSDK.testSDK(nil, nil)
  ...
  private func makeTestCtx(_ client: BluefinTecsUserBackofficeSDK, _ utility: Utility,
  ...
  private func makeTestFullCtx(_ client: BluefinTecsUserBackofficeSDK, _ utility: Utility) -> Context {
  ...
  func testFeatureHookBasic() {
    let hookClient = BluefinTecsUserBackofficeSDK.testSDK(nil, nil)
  ...
  func testFeatureInitBasic() {
    let initClient = BluefinTecsUserBackofficeSDK.testSDK(nil, nil)
  ...
  func testExtendOptionInstallsAndInitialisesTheFeature() {
    ...
    let client = BluefinTecsUserBackofficeSDK.testSDK(nil, opts)
  ...
  func testFetcherLive() throws {
    ...
    let liveClient = BluefinTecsUserBackofficeSDK(opts)
  ...
  func testFetcherBlockedTestMode() {
    ...
    let opts = VMap()
    opts.entries["system"] = .map(vm(("fetch", .nat(fetch))))
    let blockedClient = BluefinTecsUserBackofficeSDK(opts)
  ...
  func testMakeSpecBasic() throws {
    ...
    let specClient = BluefinTecsUserBackofficeSDK.testSDK(nil, setupOpts)
  ...
  func testPrepareAuthBasic() throws {
    ...
    let authClient = BluefinTecsUserBackofficeSDK.testSDK(nil, setupOpts)

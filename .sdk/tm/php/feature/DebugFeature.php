...
class BluefinTecsUserBackofficeDebugFeature extends BluefinTecsUserBackofficeBaseFeature
{
    ...
    private function _finish(BluefinTecsUserBackofficeContext $ctx, bool $ok): void
    {

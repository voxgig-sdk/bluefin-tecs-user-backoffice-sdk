...
class BluefinTecsUserBackofficeTestFeature extends BluefinTecsUserBackofficeBaseFeature
{
    ...
    public function init(BluefinTecsUserBackofficeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BluefinTecsUserBackofficeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = BluefinTecsUserBackofficeParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BluefinTecsUserBackofficeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BluefinTecsUserBackofficeContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = BluefinTecsUserBackofficeParam::call($ctx, $k);

...
// BluefinTecsUserBackoffice SDK retry feature
...
class BluefinTecsUserBackofficeRetryFeature extends BluefinTecsUserBackofficeBaseFeature
{
    ...
    public function init(BluefinTecsUserBackofficeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BluefinTecsUserBackofficeContext $ctx2, string $url, array $fetchdef) use ($inner): array {
            return $this->_with_retry($ctx2, $url, $fetchdef, $inner);
        };
    }

    private function _with_retry(BluefinTecsUserBackofficeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
    ...
    private function _track(BluefinTecsUserBackofficeContext $_ctx, int $attempt, mixed $res, mixed $err, float $wait): void
    {
        $client = $this->client;

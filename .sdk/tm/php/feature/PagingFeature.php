...
class BluefinTecsUserBackofficePagingFeature extends BluefinTecsUserBackofficeBaseFeature
{
    ...
    private function _graphql_pre_request(BluefinTecsUserBackofficeContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(BluefinTecsUserBackofficeContext $ctx): bool
    {

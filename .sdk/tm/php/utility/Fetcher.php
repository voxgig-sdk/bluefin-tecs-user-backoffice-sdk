...
class BluefinTecsUserBackofficeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BluefinTecsUserBackofficeSDK/1.0)';
    ...
    public static function call(BluefinTecsUserBackofficeContext $ctx, string $fullurl, array $fetchdef): array
    {

...
// BluefinTecsUserBackoffice SDK pipeline test
//
...
{
    private static function utility(): BluefinTecsUserBackofficeUtility
    {
        return new BluefinTecsUserBackofficeUtility();
    }
    ...
    private static function ctx(array $over = []): BluefinTecsUserBackofficeContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BluefinTecsUserBackofficeContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BluefinTecsUserBackofficeOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BluefinTecsUserBackofficeError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BluefinTecsUserBackofficeOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BluefinTecsUserBackofficeMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BluefinTecsUserBackofficeOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BluefinTecsUserBackofficeMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BluefinTecsUserBackofficeOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BluefinTecsUserBackofficeMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BluefinTecsUserBackofficeSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BluefinTecsUserBackofficeMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BluefinTecsUserBackofficeResponse([]),
            'result' => new BluefinTecsUserBackofficeResult([]),
        ]);
        [, $err] = BluefinTecsUserBackofficeMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BluefinTecsUserBackofficeSpec([]),
            'response' => null,
            'result' => new BluefinTecsUserBackofficeResult([]),
        ]);
        [, $err] = BluefinTecsUserBackofficeMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BluefinTecsUserBackofficeSpec(['step' => 's']),
            'response' => new BluefinTecsUserBackofficeResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BluefinTecsUserBackofficeResult([]),
        ]);
        [, $err] = BluefinTecsUserBackofficeMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BluefinTecsUserBackofficeSpec(['step' => 's']),
            'response' => new BluefinTecsUserBackofficeResponse(self::resp(200, ['v' => 1])),
            'result' => new BluefinTecsUserBackofficeResult([]),
        ]);
        [, $err] = BluefinTecsUserBackofficeMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BluefinTecsUserBackofficeSpec(['step' => 's']),
            'response' => new BluefinTecsUserBackofficeResponse(self::resp(200, ['v' => 2])),
            'result' => new BluefinTecsUserBackofficeResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BluefinTecsUserBackofficeMakeResponse::call($ctx);
    ...
    {
        $preset = new BluefinTecsUserBackofficeResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BluefinTecsUserBackofficeSpec([]),
            'response' => new BluefinTecsUserBackofficeResponse([]),
            'result' => new BluefinTecsUserBackofficeResult([]),
        ...
        [$got, $err] = BluefinTecsUserBackofficeMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BluefinTecsUserBackofficeResult([])]);
        [, $err] = BluefinTecsUserBackofficeMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BluefinTecsUserBackofficeSpec([]), 'result' => null]);
        [, $err] = BluefinTecsUserBackofficeMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BluefinTecsUserBackofficeSpec(['step' => 's']),
            'result' => new BluefinTecsUserBackofficeResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BluefinTecsUserBackofficeOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BluefinTecsUserBackofficeMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BluefinTecsUserBackofficeSpec(['step' => 's']),
            'result' => new BluefinTecsUserBackofficeResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BluefinTecsUserBackofficeOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BluefinTecsUserBackofficeMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BluefinTecsUserBackofficeResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BluefinTecsUserBackofficeSpec([]),
            'result' => new BluefinTecsUserBackofficeResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BluefinTecsUserBackofficeMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BluefinTecsUserBackofficeMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BluefinTecsUserBackofficeError('boom', 'boom');
        $utility->fetcher = function (BluefinTecsUserBackofficeContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BluefinTecsUserBackofficeSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BluefinTecsUserBackofficeMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BluefinTecsUserBackofficeContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BluefinTecsUserBackofficeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BluefinTecsUserBackofficeResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BluefinTecsUserBackofficeMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BluefinTecsUserBackofficeContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BluefinTecsUserBackofficeSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BluefinTecsUserBackofficeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BluefinTecsUserBackofficeResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BluefinTecsUserBackofficeSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BluefinTecsUserBackofficeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BluefinTecsUserBackofficeMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BluefinTecsUserBackofficeMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BluefinTecsUserBackofficeResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BluefinTecsUserBackofficeDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BluefinTecsUserBackofficeResult(['ok' => false])]);
        $this->expectException(BluefinTecsUserBackofficeError::class);
        BluefinTecsUserBackofficeDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BluefinTecsUserBackofficeResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BluefinTecsUserBackofficeMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BluefinTecsUserBackofficeMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BluefinTecsUserBackofficeBaseFeature();
        $b = new BluefinTecsUserBackofficeBaseFeature();
        BluefinTecsUserBackofficeFeatureAdd::call($ctx, $a);
        BluefinTecsUserBackofficeFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BluefinTecsUserBackofficeBaseFeature
    {
        $f = new BluefinTecsUserBackofficeBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BluefinTecsUserBackofficeFeatureAdd::call($ctx, self::named_feature('a'));
        BluefinTecsUserBackofficeFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        BluefinTecsUserBackofficeFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        BluefinTecsUserBackofficeFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        BluefinTecsUserBackofficeFeatureAdd::call($ctx, $replace);
        ...
        BluefinTecsUserBackofficeFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BluefinTecsUserBackofficeContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BluefinTecsUserBackofficeSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BluefinTecsUserBackofficePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BluefinTecsUserBackofficePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BluefinTecsUserBackofficeResponse(['headers' => null]),
            'result' => new BluefinTecsUserBackofficeResult([]),
        ]);
        BluefinTecsUserBackofficeResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BluefinTecsUserBackofficeResultBody::call($ctx);

...
// BluefinTecsUserBackoffice SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BluefinTecsUserBackofficeOmni::makeStructRunner(
    ...
    {
        return BluefinTecsUserBackofficeOmni::objmodel(BluefinTecsUserBackofficeOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return BluefinTecsUserBackofficeOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return BluefinTecsUserBackofficeOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BluefinTecsUserBackofficeOmni::structfix($now, Struct::undef()))
                        !== json_encode(BluefinTecsUserBackofficeOmni::structfix($val, Struct::undef()))) {

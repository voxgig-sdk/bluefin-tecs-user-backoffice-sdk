...
// BluefinTecsUserBackoffice SDK feature test
//
...
class FtCtrl extends BluefinTecsUserBackofficeControl
{
...
class FtClient
{
    ...
    private BluefinTecsUserBackofficeUtility $utility;

    public function __construct(BluefinTecsUserBackofficeUtility $utility, array $options)
    {
    ...
    public function get_utility(): BluefinTecsUserBackofficeUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (BluefinTecsUserBackofficeContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public BluefinTecsUserBackofficeContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (BluefinTecsUserBackofficeContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = BluefinTecsUserBackofficeConfig::make_feature($name);
    ...
    private static function buildUrl(BluefinTecsUserBackofficeSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof BluefinTecsUserBackofficeError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new BluefinTecsUserBackofficeResponse($fetched);
        }
    ...
    private function fail(BluefinTecsUserBackofficeContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (BluefinTecsUserBackofficeContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;

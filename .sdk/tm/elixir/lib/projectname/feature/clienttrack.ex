...
defmodule BluefinTecsUserBackoffice.Feature.Clienttrack do
  alias Voxgig.Struct, as: S
  alias BluefinTecsUserBackoffice.Feature
  ...
  defp name(f) do
    opts = Feature.opts(f)
    n = por(S.getprop(opts, "clientName"), "BluefinTecsUserBackoffice-SDK")

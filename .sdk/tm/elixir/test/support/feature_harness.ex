...
defmodule BluefinTecsUserBackoffice.FeatureHarness do
  alias Voxgig.Struct, as: S
  alias BluefinTecsUserBackoffice.Helpers, as: H
  alias BluefinTecsUserBackoffice.{Control, Spec, Result, Context, Features}

  # True when this SDK was generated with the named feature.
  def has_feature(name) do
    feature = S.getprop(BluefinTecsUserBackoffice.Config.make_config(), "feature")

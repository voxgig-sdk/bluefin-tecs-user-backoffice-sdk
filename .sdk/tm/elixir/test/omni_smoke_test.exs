# BluefinTecsUserBackoffice SDK omni runner smoke test
#
...
defmodule BluefinTecsUserBackoffice.OmniSmokeTest do
  use ExUnit.Case
  ...
  defp pack do
    runner = O.make_runner(@spec_smoke, BluefinTecsUserBackoffice.test())
    runner.("smoke")
  end

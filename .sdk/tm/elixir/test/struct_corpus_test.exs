# BluefinTecsUserBackoffice SDK struct corpus test
#
...
defmodule BluefinTecsUserBackoffice.StructCorpusTest do
  use ExUnit.Case
  ...
  setup_all do
    ...
    runner = O.make_runner(testfile, BluefinTecsUserBackoffice.test())

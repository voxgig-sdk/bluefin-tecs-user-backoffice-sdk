// OutputRegisterUser entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputRegisterUserEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputRegisterUserEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputRegisterUserEntity> {
        ...
        let e = Rc::new(OutputRegisterUserEntity {
            name: "output_register_user".to_string(),
            client: client.clone(),
...
impl Entity for OutputRegisterUserEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputRegisterUserEntity::new(&self.client, opts) as Rc<dyn Entity>
    }

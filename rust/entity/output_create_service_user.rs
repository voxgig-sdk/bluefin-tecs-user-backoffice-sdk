// OutputCreateServiceUser entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputCreateServiceUserEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputCreateServiceUserEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputCreateServiceUserEntity> {
        ...
        let e = Rc::new(OutputCreateServiceUserEntity {
            name: "output_create_service_user".to_string(),
            client: client.clone(),
...
impl Entity for OutputCreateServiceUserEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputCreateServiceUserEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputCreateServiceUserEntity {

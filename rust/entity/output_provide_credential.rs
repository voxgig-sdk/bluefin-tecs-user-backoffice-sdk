// OutputProvideCredential entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputProvideCredentialEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputProvideCredentialEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputProvideCredentialEntity> {
        ...
        let e = Rc::new(OutputProvideCredentialEntity {
            name: "output_provide_credential".to_string(),
            client: client.clone(),
...
impl Entity for OutputProvideCredentialEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputProvideCredentialEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputProvideCredentialEntity {

// OutputListOfUser entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputListOfUserEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputListOfUserEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputListOfUserEntity> {
        ...
        let e = Rc::new(OutputListOfUserEntity {
            name: "output_list_of_user".to_string(),
            client: client.clone(),
...
impl Entity for OutputListOfUserEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputListOfUserEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputListOfUserEntity {

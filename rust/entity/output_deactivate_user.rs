// OutputDeactivateUser entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputDeactivateUserEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputDeactivateUserEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputDeactivateUserEntity> {
        ...
        let e = Rc::new(OutputDeactivateUserEntity {
            name: "output_deactivate_user".to_string(),
            client: client.clone(),
...
impl Entity for OutputDeactivateUserEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputDeactivateUserEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputDeactivateUserEntity {

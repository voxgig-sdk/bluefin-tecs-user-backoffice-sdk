// OutputResetPassword entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputResetPasswordEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputResetPasswordEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputResetPasswordEntity> {
        ...
        let e = Rc::new(OutputResetPasswordEntity {
            name: "output_reset_password".to_string(),
            client: client.clone(),
...
impl Entity for OutputResetPasswordEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputResetPasswordEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputResetPasswordEntity {

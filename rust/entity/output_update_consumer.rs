// OutputUpdateConsumer entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputUpdateConsumerEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputUpdateConsumerEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputUpdateConsumerEntity> {
        ...
        let e = Rc::new(OutputUpdateConsumerEntity {
            name: "output_update_consumer".to_string(),
            client: client.clone(),
...
impl Entity for OutputUpdateConsumerEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputUpdateConsumerEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputUpdateConsumerEntity {

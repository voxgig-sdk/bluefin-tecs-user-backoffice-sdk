// OutputAssignRole entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputAssignRoleEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputAssignRoleEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputAssignRoleEntity> {
        ...
        let e = Rc::new(OutputAssignRoleEntity {
            name: "output_assign_role".to_string(),
            client: client.clone(),
...
impl Entity for OutputAssignRoleEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputAssignRoleEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputAssignRoleEntity {

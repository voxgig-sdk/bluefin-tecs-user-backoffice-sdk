// OutputListOfModule entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputListOfModuleEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputListOfModuleEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputListOfModuleEntity> {
        ...
        let e = Rc::new(OutputListOfModuleEntity {
            name: "output_list_of_module".to_string(),
            client: client.clone(),
...
impl Entity for OutputListOfModuleEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputListOfModuleEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputListOfModuleEntity {

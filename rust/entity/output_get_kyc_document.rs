// OutputGetKycDocument entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputGetKycDocumentEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputGetKycDocumentEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputGetKycDocumentEntity> {
        ...
        let e = Rc::new(OutputGetKycDocumentEntity {
            name: "output_get_kyc_document".to_string(),
            client: client.clone(),
...
impl Entity for OutputGetKycDocumentEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputGetKycDocumentEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputGetKycDocumentEntity {

// OutputListOfRoleGroup entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputListOfRoleGroupEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputListOfRoleGroupEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputListOfRoleGroupEntity> {
        ...
        let e = Rc::new(OutputListOfRoleGroupEntity {
            name: "output_list_of_role_group".to_string(),
            client: client.clone(),
...
impl Entity for OutputListOfRoleGroupEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputListOfRoleGroupEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputListOfRoleGroupEntity {

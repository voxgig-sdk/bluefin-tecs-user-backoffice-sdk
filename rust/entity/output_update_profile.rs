// OutputUpdateProfile entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputUpdateProfileEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputUpdateProfileEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputUpdateProfileEntity> {
        ...
        let e = Rc::new(OutputUpdateProfileEntity {
            name: "output_update_profile".to_string(),
            client: client.clone(),
...
impl Entity for OutputUpdateProfileEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputUpdateProfileEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputUpdateProfileEntity {

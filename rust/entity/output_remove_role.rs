// OutputRemoveRole entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputRemoveRoleEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputRemoveRoleEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputRemoveRoleEntity> {
        ...
        let e = Rc::new(OutputRemoveRoleEntity {
            name: "output_remove_role".to_string(),
            client: client.clone(),
...
impl Entity for OutputRemoveRoleEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputRemoveRoleEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputRemoveRoleEntity {

// OutputActivateStoreModule entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputActivateStoreModuleEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputActivateStoreModuleEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputActivateStoreModuleEntity> {
        ...
        let e = Rc::new(OutputActivateStoreModuleEntity {
            name: "output_activate_store_module".to_string(),
            client: client.clone(),
...
impl Entity for OutputActivateStoreModuleEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputActivateStoreModuleEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputActivateStoreModuleEntity {

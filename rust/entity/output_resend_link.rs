// OutputResendLink entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputResendLinkEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputResendLinkEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputResendLinkEntity> {
        ...
        let e = Rc::new(OutputResendLinkEntity {
            name: "output_resend_link".to_string(),
            client: client.clone(),
...
impl Entity for OutputResendLinkEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputResendLinkEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputResendLinkEntity {

// OutputListOfMandator entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputListOfMandatorEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputListOfMandatorEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputListOfMandatorEntity> {
        ...
        let e = Rc::new(OutputListOfMandatorEntity {
            name: "output_list_of_mandator".to_string(),
            client: client.clone(),
...
impl Entity for OutputListOfMandatorEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputListOfMandatorEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputListOfMandatorEntity {

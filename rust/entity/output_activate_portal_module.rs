// OutputActivatePortalModule entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputActivatePortalModuleEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputActivatePortalModuleEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputActivatePortalModuleEntity> {
        ...
        let e = Rc::new(OutputActivatePortalModuleEntity {
            name: "output_activate_portal_module".to_string(),
            client: client.clone(),
...
impl Entity for OutputActivatePortalModuleEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputActivatePortalModuleEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputActivatePortalModuleEntity {

// OutputCreateMandator entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputCreateMandatorEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputCreateMandatorEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputCreateMandatorEntity> {
        ...
        let e = Rc::new(OutputCreateMandatorEntity {
            name: "output_create_mandator".to_string(),
            client: client.clone(),
...
impl Entity for OutputCreateMandatorEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputCreateMandatorEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputCreateMandatorEntity {

// OutputListOfAvailableRole entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputListOfAvailableRoleEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputListOfAvailableRoleEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputListOfAvailableRoleEntity> {
        ...
        let e = Rc::new(OutputListOfAvailableRoleEntity {
            name: "output_list_of_available_role".to_string(),
            client: client.clone(),
...
impl Entity for OutputListOfAvailableRoleEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputListOfAvailableRoleEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputListOfAvailableRoleEntity {

// OutputActivateDigitalModule entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputActivateDigitalModuleEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputActivateDigitalModuleEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputActivateDigitalModuleEntity> {
        ...
        let e = Rc::new(OutputActivateDigitalModuleEntity {
            name: "output_activate_digital_module".to_string(),
            client: client.clone(),
...
impl Entity for OutputActivateDigitalModuleEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputActivateDigitalModuleEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputActivateDigitalModuleEntity {

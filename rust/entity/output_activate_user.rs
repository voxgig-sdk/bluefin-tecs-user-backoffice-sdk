// OutputActivateUser entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputActivateUserEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputActivateUserEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputActivateUserEntity> {
        ...
        let e = Rc::new(OutputActivateUserEntity {
            name: "output_activate_user".to_string(),
            client: client.clone(),
...
impl Entity for OutputActivateUserEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputActivateUserEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputActivateUserEntity {

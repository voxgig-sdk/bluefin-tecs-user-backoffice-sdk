// OutputChangeLogo entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputChangeLogoEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputChangeLogoEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputChangeLogoEntity> {
        ...
        let e = Rc::new(OutputChangeLogoEntity {
            name: "output_change_logo".to_string(),
            client: client.clone(),
...
impl Entity for OutputChangeLogoEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputChangeLogoEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputChangeLogoEntity {

// OutputListOfTransactionsHistory entity client (generated — mirrors the go Entity fragment).
...
pub struct OutputListOfTransactionsHistoryEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputListOfTransactionsHistoryEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputListOfTransactionsHistoryEntity> {
        ...
        let e = Rc::new(OutputListOfTransactionsHistoryEntity {
            name: "output_list_of_transactions_history".to_string(),
            client: client.clone(),
...
impl Entity for OutputListOfTransactionsHistoryEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputListOfTransactionsHistoryEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputListOfTransactionsHistoryEntity {

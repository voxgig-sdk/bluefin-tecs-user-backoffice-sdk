// OutputGetLogo entity client (generated — mirrors the go Entity fragment).
...
use crate::core::sdk::BluefinTecsUserBackofficeSDK;
use crate::core::types::{Entity, BluefinTecsUserBackofficeEntity};
use crate::core::utility_type::Utility;
use crate::utility::voxgigstruct as vs;
use crate::utility::voxgigstruct::Value;

pub struct OutputGetLogoEntity {
    name: String,
    #[allow(dead_code)]
...
impl OutputGetLogoEntity {
    pub fn new(client: &Rc<BluefinTecsUserBackofficeSDK>, entopts: Value) -> Rc<OutputGetLogoEntity> {
        ...
        let e = Rc::new(OutputGetLogoEntity {
            name: "output_get_logo".to_string(),
            client: client.clone(),
    ...
    ) -> Result<Value, BluefinTecsUserBackofficeError> {
    ...
    pub fn stream(
        ...
        args: Value,
        callopts: Value,
    ) -> Result<std::vec::IntoIter<Value>, BluefinTecsUserBackofficeError> {
...
impl Entity for OutputGetLogoEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OutputGetLogoEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinTecsUserBackofficeEntity for OutputGetLogoEntity {

    fn load(self: &Rc<Self>, reqmatch: Value, ctrl: Value) -> Result<Rc<Self>, BluefinTecsUserBackofficeError> {
        let ctx = self.utility.make_context(
            CtxSpec {
    ...
    fn create(self: &Rc<Self>, _reqdata: Value, _ctrl: Value) -> Result<Rc<Self>, BluefinTecsUserBackofficeError> {

...
// tm/swift/Tests/BluefinTecsUserBackofficeSDKTests/OmniResolver.swift, and it follows the
...
use bluefin_tecs_user_backoffice_sdk::utility::voxgigstruct::ordered_map::OrderedMap;
use bluefin_tecs_user_backoffice_sdk::utility::voxgigstruct::value::Value;
use bluefin_tecs_user_backoffice_sdk::utility::voxgigstruct::InjectDef;
use bluefin_tecs_user_backoffice_sdk::BluefinTecsUserBackofficeError;
...
pub fn vget(val: &Value, key: &str) -> Value {
    bluefin_tecs_user_backoffice_sdk::utility::voxgigstruct::lookup(val, &Value::str(key))
}

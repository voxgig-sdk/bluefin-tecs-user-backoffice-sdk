// BluefinTecsUserBackoffice SDK for Rust (generated by @voxgig/sdkgen).
//
...
pub use crate::core::error::BluefinTecsUserBackofficeError;
...
pub use crate::core::sdk::{test_sdk, BluefinTecsUserBackofficeSDK};
pub use crate::core::spec::Spec;
pub use crate::core::types::{
    Entity, Feature, FeatureRef, FetcherFn, OutVal, BluefinTecsUserBackofficeEntity,
};
...
// No-argument convenience constructors: `bluefin_tecs_user_backoffice_sdk::new()` /
// `bluefin_tecs_user_backoffice_sdk::test()` for the common no-options case.
use std::rc::Rc;

pub fn new() -> Rc<BluefinTecsUserBackofficeSDK> {
    BluefinTecsUserBackofficeSDK::new(Value::Noval)
}

pub fn test() -> Rc<BluefinTecsUserBackofficeSDK> {

// Shared Value helpers for the BluefinTecsUserBackoffice SDK pipeline. The SDK data model
...
// underlying API spec doesn't define. The static BluefinTecsUserBackofficeEntity trait
...
pub fn unsupported_op(opname: &str, entityname: &str) -> BluefinTecsUserBackofficeError {
    BluefinTecsUserBackofficeError::new(
        "unsupported_op",
        &format!(

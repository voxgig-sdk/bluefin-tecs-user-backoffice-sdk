...
boru-driven command-line client **and** interactive REPL for the BluefinTecsUserBackoffice
...
- `<entity>` is a bareword, auto-quoted as an boru atom (e.g. `output_activate_digital_module`).

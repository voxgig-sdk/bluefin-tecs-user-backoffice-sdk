// Command BluefinTecsUserBackoffice-cli is a CLI + REPL for the BluefinTecsUserBackoffice SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      BLUEFIN_TECS_USER_BACKOFFICE_APIKEY (api key), BLUEFIN_TECS_USER_BACKOFFICE_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: BLUEFIN_TECS_USER_BACKOFFICE_APIKEY carries the API key and
	// BLUEFIN_TECS_USER_BACKOFFICE_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("BLUEFIN_TECS_USER_BACKOFFICE_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("BLUEFIN_TECS_USER_BACKOFFICE_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewBluefinTecsUserBackofficeSDK(opts)

// BluefinTecsUserBackoffice SDK — umbrella runtime header (template; BluefinTecsUserBackoffice tokens
...
#ifndef BLUEFINTECSUSERBACKOFFICE_SDK_H
#define BLUEFINTECSUSERBACKOFFICE_SDK_H
...
typedef struct BluefinTecsUserBackofficeSDK BluefinTecsUserBackofficeSDK;
...
// ===========================================================================
// Error (mirrors core/error.rs BluefinTecsUserBackofficeError)
// ===========================================================================

typedef struct PNError {
  char* sdk;   // "BluefinTecsUserBackoffice"
...
// ===========================================================================
// Entity (vtable; mirrors core/types.rs Entity + BluefinTecsUserBackofficeEntity)
// ===========================================================================
...
typedef struct EntityVT {
  ...
  // CRUD ops (BluefinTecsUserBackofficeEntity). On error set *err and return NULL.
...
// ===========================================================================
// SDK client (mirrors Main.fragment BluefinTecsUserBackofficeSDK) — generic fields.
// ===========================================================================

struct BluefinTecsUserBackofficeSDK {
  char* mode;             // "live" | "test"
  voxgig_value* options;
  Utility* utility;
...
void sdk_features_push(BluefinTecsUserBackofficeSDK* sdk, Feature* f);
void sdk_features_insert(BluefinTecsUserBackofficeSDK* sdk, size_t i, Feature* f);
void sdk_features_replace(BluefinTecsUserBackofficeSDK* sdk, size_t i, Feature* f);

voxgig_value* sdk_options_map(BluefinTecsUserBackofficeSDK* sdk); // deep clone of options
Utility* sdk_get_utility(BluefinTecsUserBackofficeSDK* sdk);      // utility_copy
Context* sdk_get_root_ctx(BluefinTecsUserBackofficeSDK* sdk);

// Constructors / prepare / direct are in the generated client.c:
BluefinTecsUserBackofficeSDK* bluefintecsuserbackoffice_sdk_new(voxgig_value* options);
BluefinTecsUserBackofficeSDK* test_sdk(voxgig_value* testopts, voxgig_value* sdkopts);
voxgig_value* sdk_prepare(BluefinTecsUserBackofficeSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_direct(BluefinTecsUserBackofficeSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_graphql(BluefinTecsUserBackofficeSDK* sdk, const char* query,
...
#endif // BLUEFINTECSUSERBACKOFFICE_SDK_H

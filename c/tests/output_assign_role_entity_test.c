// Generated instance test for the output_assign_role entity.
...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_assign_role(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "output_assign_role", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_assign_role(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_assign_role_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_assign_role(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_assign_role_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("output_assign_role_entity");
}

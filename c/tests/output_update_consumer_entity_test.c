...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_update_consumer(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_update_consumer(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_update_consumer_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_update_consumer(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_update_consumer_stream(pe, "list", NULL, NULL, &perr);

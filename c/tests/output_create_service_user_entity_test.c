...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_create_service_user(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "output_create_service_user",
        cmap(2,
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_create_service_user(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_create_service_user_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_create_service_user(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_create_service_user_stream(pe, "list", NULL, NULL, &perr);

// Behavioural feature-test harness for the BluefinTecsUserBackoffice SDK (C port of the
...
#ifndef BLUEFINTECSUSERBACKOFFICE_FEATURE_HARNESS_H
#define BLUEFINTECSUSERBACKOFFICE_FEATURE_HARNESS_H
...
#endif // BLUEFINTECSUSERBACKOFFICE_FEATURE_HARNESS_H

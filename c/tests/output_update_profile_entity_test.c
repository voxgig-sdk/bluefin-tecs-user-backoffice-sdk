// Generated instance test for the output_update_profile entity.
...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_update_profile(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "output_update_profile", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_update_profile(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_update_profile_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_update_profile(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_update_profile_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("output_update_profile_entity");
}

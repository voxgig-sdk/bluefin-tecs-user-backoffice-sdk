...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_register_user(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_register_user(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_register_user_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_register_user(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_register_user_stream(pe, "list", NULL, NULL, &perr);

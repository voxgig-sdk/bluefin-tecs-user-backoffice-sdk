...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_change_logo(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_change_logo(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_change_logo_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_change_logo(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_change_logo_stream(pe, "list", NULL, NULL, &perr);

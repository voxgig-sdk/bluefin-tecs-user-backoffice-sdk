// Minimal C test harness for the BluefinTecsUserBackoffice SDK test binaries. Each test
...
#ifndef BLUEFINTECSUSERBACKOFFICE_CTEST_H
#define BLUEFINTECSUSERBACKOFFICE_CTEST_H
...
#endif // BLUEFINTECSUSERBACKOFFICE_CTEST_H

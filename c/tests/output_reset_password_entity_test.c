...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_reset_password(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_reset_password(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_reset_password_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_reset_password(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_reset_password_stream(pe, "list", NULL, NULL, &perr);

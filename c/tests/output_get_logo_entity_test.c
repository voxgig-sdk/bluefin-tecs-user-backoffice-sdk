// Generated instance test for the output_get_logo entity.
...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_get_logo(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "output_get_logo", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_get_logo(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_get_logo_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_get_logo(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_get_logo_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("output_get_logo_entity");
}

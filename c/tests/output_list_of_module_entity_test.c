// Generated instance test for the output_list_of_module entity.
...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_list_of_module(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "output_list_of_module", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_list_of_module(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_list_of_module_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_list_of_module(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_list_of_module_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("output_list_of_module_entity");
}

...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_provide_credential(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "output_provide_credential",
        cmap(2,
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_provide_credential(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_provide_credential_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_provide_credential(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_provide_credential_stream(pe, "list", NULL, NULL, &perr);

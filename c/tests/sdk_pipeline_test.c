...
int main(void) {
  ...
  BluefinTecsUserBackofficeSDK* t = test_sdk(NULL, NULL);
  ...
  BluefinTecsUserBackofficeSDK* sdk = bluefintecsuserbackoffice_sdk_new(opts);
  ...
  BluefinTecsUserBackofficeSDK* rsdk = bluefintecsuserbackoffice_sdk_new(ropts);
  PNError* rerr = NULL;

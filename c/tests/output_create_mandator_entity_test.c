// Generated instance test for the output_create_mandator entity.
...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_create_mandator(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "output_create_mandator", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_create_mandator(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_create_mandator_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_create_mandator(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_create_mandator_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("output_create_mandator_entity");
}

...
static BluefinTecsUserBackofficeSDK* C;
static Utility* U;
...
static void test_primary_fetcher_live(void) {
  ...
  BluefinTecsUserBackofficeSDK* live = bluefintecsuserbackoffice_sdk_new(
...
static void test_primary_fetcher_blocked_test_mode(void) {
  BluefinTecsUserBackofficeSDK* blocked = bluefintecsuserbackoffice_sdk_new(
...
static void test_primary_new_sdk_smoke(void) {
  BluefinTecsUserBackofficeSDK* client = bluefintecsuserbackoffice_sdk_new(v_undef());

...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_version(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_user_backoffice_version(strsdk, NULL);
    PNError* serr = NULL;
    ...
    Entity* pe = bluefin_tecs_user_backoffice_version(plainsdk, NULL);
    PNError* perr = NULL;

...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_list_of_mandator(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "output_list_of_mandator",
        cmap(2,
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_list_of_mandator(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_list_of_mandator_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_list_of_mandator(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_list_of_mandator_stream(pe, "list", NULL, NULL, &perr);

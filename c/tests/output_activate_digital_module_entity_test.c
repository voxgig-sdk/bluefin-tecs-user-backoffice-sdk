// Generated instance test for the output_activate_digital_module entity.
...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_activate_digital_module(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "output_activate_digital_module", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "output_activate_digital_module",
        cmap(2,
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_activate_digital_module(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_activate_digital_module_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_activate_digital_module(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_activate_digital_module_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("output_activate_digital_module_entity");
}

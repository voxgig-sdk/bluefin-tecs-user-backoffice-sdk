...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_remove_role(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_remove_role(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_remove_role_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_remove_role(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_remove_role_stream(pe, "list", NULL, NULL, &perr);

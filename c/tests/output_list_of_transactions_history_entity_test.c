// Generated instance test for the output_list_of_transactions_history entity.
...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_list_of_transactions_history(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "output_list_of_transactions_history", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "output_list_of_transactions_history",
        cmap(2,
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_list_of_transactions_history(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_list_of_transactions_history_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_list_of_transactions_history(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_list_of_transactions_history_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("output_list_of_transactions_history_entity");
}

...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_get_kyc_document(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "output_get_kyc_document",
        cmap(2,
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_get_kyc_document(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_get_kyc_document_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_get_kyc_document(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_get_kyc_document_stream(pe, "list", NULL, NULL, &perr);

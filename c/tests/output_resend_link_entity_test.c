// Generated instance test for the output_resend_link entity.
...
int main(void) {
  ...
  Entity* e = bluefin_tecs_user_backoffice_output_resend_link(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "output_resend_link", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_tecs_user_backoffice_output_resend_link(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = output_resend_link_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_tecs_user_backoffice_output_resend_link(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = output_resend_link_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("output_resend_link_entity");
}

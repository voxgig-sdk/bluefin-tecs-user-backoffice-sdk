// OutputAssignRole entity client (generated — mirrors the rust Entity fragment).
...
typedef struct output_assign_role_entity {
...
static const char* output_assign_role_get_name(Entity* e);
...
Entity* output_assign_role_entity_new(BluefinTecsUserBackofficeSDK* client, voxgig_value* entopts) {
  ...
  output_assign_role_entity* self = (output_assign_role_entity*)calloc(1, sizeof(output_assign_role_entity));
  self->base.vt = &output_assign_role_VT;
  self->name = strdup("output_assign_role");
  self->client = client;
...
static voxgig_value* output_assign_role_run_op(output_assign_role_entity* self, Context* ctx,
                                    output_assign_role_postdone_fn post_done, PNError** err) {
...
voxgig_value* output_assign_role_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* output_assign_role_get_name(Entity* e) {
  return ((output_assign_role_entity*)e)->name;
}
...
static Entity* output_assign_role_make(Entity* e) {
  ...
  return output_assign_role_entity_new(self->client, opts);
}
...
static voxgig_value* output_assign_role_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_assign_role_ent_ctx(self), "SetData");
  }
  feature_hook_util(output_assign_role_ent_ctx(self), "GetData");
...
static voxgig_value* output_assign_role_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_assign_role_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(output_assign_role_ent_ctx(self), "GetMatch");
...
static void output_assign_role_create_postdone(output_assign_role_entity* self, Context* ctx) {
...
static const EntityVT output_assign_role_VT = {
  ...
  output_assign_role_update,
  output_assign_role_remove,
};

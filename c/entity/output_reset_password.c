// OutputResetPassword entity client (generated — mirrors the rust Entity fragment).
...
typedef struct output_reset_password_entity {
...
static const char* output_reset_password_get_name(Entity* e);
...
Entity* output_reset_password_entity_new(BluefinTecsUserBackofficeSDK* client, voxgig_value* entopts) {
  ...
  output_reset_password_entity* self = (output_reset_password_entity*)calloc(1, sizeof(output_reset_password_entity));
  self->base.vt = &output_reset_password_VT;
  self->name = strdup("output_reset_password");
  self->client = client;
...
static voxgig_value* output_reset_password_run_op(output_reset_password_entity* self, Context* ctx,
                                    output_reset_password_postdone_fn post_done, PNError** err) {
...
voxgig_value* output_reset_password_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* output_reset_password_get_name(Entity* e) {
  return ((output_reset_password_entity*)e)->name;
}
...
static Entity* output_reset_password_make(Entity* e) {
  ...
  return output_reset_password_entity_new(self->client, opts);
}
...
static voxgig_value* output_reset_password_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_reset_password_ent_ctx(self), "SetData");
  }
  feature_hook_util(output_reset_password_ent_ctx(self), "GetData");
...
static voxgig_value* output_reset_password_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_reset_password_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(output_reset_password_ent_ctx(self), "GetMatch");
...
static void output_reset_password_create_postdone(output_reset_password_entity* self, Context* ctx) {
...
static const EntityVT output_reset_password_VT = {
  output_reset_password_get_name,
  ...
  output_reset_password_update,
  output_reset_password_remove,
};

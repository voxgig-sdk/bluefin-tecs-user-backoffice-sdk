// OutputActivatePortalModule entity client (generated — mirrors the rust Entity fragment).
...
typedef struct output_activate_portal_module_entity {
...
static const char* output_activate_portal_module_get_name(Entity* e);
...
Entity* output_activate_portal_module_entity_new(BluefinTecsUserBackofficeSDK* client, voxgig_value* entopts) {
  ...
  output_activate_portal_module_entity* self = (output_activate_portal_module_entity*)calloc(1, sizeof(output_activate_portal_module_entity));
  self->base.vt = &output_activate_portal_module_VT;
  self->name = strdup("output_activate_portal_module");
  self->client = client;
...
static voxgig_value* output_activate_portal_module_run_op(output_activate_portal_module_entity* self, Context* ctx,
                                    output_activate_portal_module_postdone_fn post_done, PNError** err) {
...
voxgig_value* output_activate_portal_module_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* output_activate_portal_module_get_name(Entity* e) {
  return ((output_activate_portal_module_entity*)e)->name;
}
...
static Entity* output_activate_portal_module_make(Entity* e) {
  ...
  return output_activate_portal_module_entity_new(self->client, opts);
}
...
static voxgig_value* output_activate_portal_module_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_activate_portal_module_ent_ctx(self), "SetData");
  }
  feature_hook_util(output_activate_portal_module_ent_ctx(self), "GetData");
...
static voxgig_value* output_activate_portal_module_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_activate_portal_module_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(output_activate_portal_module_ent_ctx(self), "GetMatch");
...
static void output_activate_portal_module_create_postdone(output_activate_portal_module_entity* self, Context* ctx) {
...
static const EntityVT output_activate_portal_module_VT = {
  output_activate_portal_module_get_name,
  ...
  output_activate_portal_module_update,
  output_activate_portal_module_remove,
};

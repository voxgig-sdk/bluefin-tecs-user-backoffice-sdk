// OutputGetKycDocument entity client (generated — mirrors the rust Entity fragment).
...
typedef struct output_get_kyc_document_entity {
...
static const char* output_get_kyc_document_get_name(Entity* e);
...
Entity* output_get_kyc_document_entity_new(BluefinTecsUserBackofficeSDK* client, voxgig_value* entopts) {
  ...
  output_get_kyc_document_entity* self = (output_get_kyc_document_entity*)calloc(1, sizeof(output_get_kyc_document_entity));
  self->base.vt = &output_get_kyc_document_VT;
  self->name = strdup("output_get_kyc_document");
  self->client = client;
...
static voxgig_value* output_get_kyc_document_run_op(output_get_kyc_document_entity* self, Context* ctx,
                                    output_get_kyc_document_postdone_fn post_done, PNError** err) {
...
voxgig_value* output_get_kyc_document_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* output_get_kyc_document_get_name(Entity* e) {
  return ((output_get_kyc_document_entity*)e)->name;
}
...
static Entity* output_get_kyc_document_make(Entity* e) {
  ...
  return output_get_kyc_document_entity_new(self->client, opts);
}
...
static voxgig_value* output_get_kyc_document_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_get_kyc_document_ent_ctx(self), "SetData");
  }
  feature_hook_util(output_get_kyc_document_ent_ctx(self), "GetData");
...
static voxgig_value* output_get_kyc_document_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_get_kyc_document_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(output_get_kyc_document_ent_ctx(self), "GetMatch");
...
static void output_get_kyc_document_create_postdone(output_get_kyc_document_entity* self, Context* ctx) {
...
static const EntityVT output_get_kyc_document_VT = {
  output_get_kyc_document_get_name,
  ...
  output_get_kyc_document_update,
  output_get_kyc_document_remove,
};

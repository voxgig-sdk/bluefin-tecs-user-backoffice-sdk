// OutputGetLogo entity client (generated — mirrors the rust Entity fragment).
...
typedef struct output_get_logo_entity {
  ...
  bool deleted;
} output_get_logo_entity;

typedef void (*output_get_logo_postdone_fn)(output_get_logo_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT output_get_logo_VT;
static const char* output_get_logo_get_name(Entity* e);
static Entity* output_get_logo_make(Entity* e);
static voxgig_value* output_get_logo_data(Entity* e, voxgig_value* args);
static voxgig_value* output_get_logo_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* output_get_logo_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** output_get_logo_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* output_get_logo_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* output_get_logo_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* output_get_logo_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void output_get_logo_mark_deleted(Entity* e);
static bool output_get_logo_deleted(Entity* e);

static Context* output_get_logo_ent_ctx(output_get_logo_entity* self) {
  return self->entctx;
}
...
Entity* output_get_logo_entity_new(BluefinTecsUserBackofficeSDK* client, voxgig_value* entopts) {
  ...
  output_get_logo_entity* self = (output_get_logo_entity*)calloc(1, sizeof(output_get_logo_entity));
  self->base.vt = &output_get_logo_VT;
  self->name = strdup("output_get_logo");
  self->client = client;
...
static voxgig_value* output_get_logo_run_op(output_get_logo_entity* self, Context* ctx,
                                    output_get_logo_postdone_fn post_done, PNError** err) {
...
voxgig_value* output_get_logo_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  output_get_logo_entity* self = (output_get_logo_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, output_get_logo_ent_ctx(self));
...
static const char* output_get_logo_get_name(Entity* e) {
  return ((output_get_logo_entity*)e)->name;
}
...
static Entity* output_get_logo_make(Entity* e) {
  ...
  return output_get_logo_entity_new(self->client, opts);
}
...
static voxgig_value* output_get_logo_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_get_logo_ent_ctx(self), "SetData");
  }
  feature_hook_util(output_get_logo_ent_ctx(self), "GetData");
...
static voxgig_value* output_get_logo_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_get_logo_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(output_get_logo_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void output_get_logo_load_postdone(output_get_logo_entity* self, Context* ctx) {
...
static Entity* output_get_logo_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, output_get_logo_ent_ctx(self));
  output_get_logo_run_op(self, ctx, output_get_logo_load_postdone, err);
  if (*err) return NULL;
...
static Entity** output_get_logo_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "output_get_logo");
  return NULL;
}

static Entity* output_get_logo_create(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("create", "output_get_logo");
  return NULL;
}

static Entity* output_get_logo_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "output_get_logo");
  return NULL;
}

static Entity* output_get_logo_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "output_get_logo");
  return NULL;
}
...
// live record.
static void output_get_logo_mark_deleted(Entity* e) {
  ((output_get_logo_entity*)e)->deleted = true;
}

static bool output_get_logo_deleted(Entity* e) {
  return ((output_get_logo_entity*)e)->deleted;
}

static const EntityVT output_get_logo_VT = {
  output_get_logo_get_name,
  output_get_logo_make,
  output_get_logo_data,
  output_get_logo_matchv,
  output_get_logo_mark_deleted,
  output_get_logo_deleted,
  output_get_logo_load,
  output_get_logo_list,
  output_get_logo_create,
  output_get_logo_update,
  output_get_logo_remove,
};

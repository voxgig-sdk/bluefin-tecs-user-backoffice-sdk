// OutputActivateStoreModule entity client (generated — mirrors the rust Entity fragment).
...
typedef struct output_activate_store_module_entity {
  ...
  bool deleted;
} output_activate_store_module_entity;

typedef void (*output_activate_store_module_postdone_fn)(output_activate_store_module_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT output_activate_store_module_VT;
static const char* output_activate_store_module_get_name(Entity* e);
static Entity* output_activate_store_module_make(Entity* e);
static voxgig_value* output_activate_store_module_data(Entity* e, voxgig_value* args);
static voxgig_value* output_activate_store_module_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* output_activate_store_module_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** output_activate_store_module_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* output_activate_store_module_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* output_activate_store_module_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* output_activate_store_module_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void output_activate_store_module_mark_deleted(Entity* e);
static bool output_activate_store_module_deleted(Entity* e);

static Context* output_activate_store_module_ent_ctx(output_activate_store_module_entity* self) {
  return self->entctx;
}
...
Entity* output_activate_store_module_entity_new(BluefinTecsUserBackofficeSDK* client, voxgig_value* entopts) {
  ...
  output_activate_store_module_entity* self = (output_activate_store_module_entity*)calloc(1, sizeof(output_activate_store_module_entity));
  self->base.vt = &output_activate_store_module_VT;
  self->name = strdup("output_activate_store_module");
  self->client = client;
...
static voxgig_value* output_activate_store_module_run_op(output_activate_store_module_entity* self, Context* ctx,
                                    output_activate_store_module_postdone_fn post_done, PNError** err) {
...
voxgig_value* output_activate_store_module_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  output_activate_store_module_entity* self = (output_activate_store_module_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, output_activate_store_module_ent_ctx(self));
...
static const char* output_activate_store_module_get_name(Entity* e) {
  return ((output_activate_store_module_entity*)e)->name;
}
...
static Entity* output_activate_store_module_make(Entity* e) {
  ...
  return output_activate_store_module_entity_new(self->client, opts);
}
...
static voxgig_value* output_activate_store_module_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_activate_store_module_ent_ctx(self), "SetData");
  }
  feature_hook_util(output_activate_store_module_ent_ctx(self), "GetData");
...
static voxgig_value* output_activate_store_module_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_activate_store_module_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(output_activate_store_module_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static Entity* output_activate_store_module_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "output_activate_store_module");
  return NULL;
}

static Entity** output_activate_store_module_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "output_activate_store_module");
  return NULL;
}


static void output_activate_store_module_create_postdone(output_activate_store_module_entity* self, Context* ctx) {
...
static Entity* output_activate_store_module_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, output_activate_store_module_ent_ctx(self));
  output_activate_store_module_run_op(self, ctx, output_activate_store_module_create_postdone, err);
  if (*err) return NULL;
...
static Entity* output_activate_store_module_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "output_activate_store_module");
  return NULL;
}

static Entity* output_activate_store_module_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "output_activate_store_module");
  return NULL;
}
...
// live record.
static void output_activate_store_module_mark_deleted(Entity* e) {
  ((output_activate_store_module_entity*)e)->deleted = true;
}

static bool output_activate_store_module_deleted(Entity* e) {
  return ((output_activate_store_module_entity*)e)->deleted;
}

static const EntityVT output_activate_store_module_VT = {
  output_activate_store_module_get_name,
  output_activate_store_module_make,
  output_activate_store_module_data,
  output_activate_store_module_matchv,
  output_activate_store_module_mark_deleted,
  output_activate_store_module_deleted,
  output_activate_store_module_load,
  output_activate_store_module_list,
  output_activate_store_module_create,
  output_activate_store_module_update,
  output_activate_store_module_remove,
};

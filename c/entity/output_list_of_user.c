// OutputListOfUser entity client (generated — mirrors the rust Entity fragment).
...
typedef struct output_list_of_user_entity {
  ...
  bool deleted;
} output_list_of_user_entity;

typedef void (*output_list_of_user_postdone_fn)(output_list_of_user_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT output_list_of_user_VT;
static const char* output_list_of_user_get_name(Entity* e);
static Entity* output_list_of_user_make(Entity* e);
static voxgig_value* output_list_of_user_data(Entity* e, voxgig_value* args);
static voxgig_value* output_list_of_user_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* output_list_of_user_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** output_list_of_user_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* output_list_of_user_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* output_list_of_user_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* output_list_of_user_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void output_list_of_user_mark_deleted(Entity* e);
static bool output_list_of_user_deleted(Entity* e);

static Context* output_list_of_user_ent_ctx(output_list_of_user_entity* self) {
  return self->entctx;
}
...
Entity* output_list_of_user_entity_new(BluefinTecsUserBackofficeSDK* client, voxgig_value* entopts) {
  ...
  output_list_of_user_entity* self = (output_list_of_user_entity*)calloc(1, sizeof(output_list_of_user_entity));
  self->base.vt = &output_list_of_user_VT;
  self->name = strdup("output_list_of_user");
  self->client = client;
...
static voxgig_value* output_list_of_user_run_op(output_list_of_user_entity* self, Context* ctx,
                                    output_list_of_user_postdone_fn post_done, PNError** err) {
...
voxgig_value* output_list_of_user_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  output_list_of_user_entity* self = (output_list_of_user_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, output_list_of_user_ent_ctx(self));
...
static const char* output_list_of_user_get_name(Entity* e) {
  return ((output_list_of_user_entity*)e)->name;
}
...
static Entity* output_list_of_user_make(Entity* e) {
  ...
  return output_list_of_user_entity_new(self->client, opts);
}
...
static voxgig_value* output_list_of_user_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_list_of_user_ent_ctx(self), "SetData");
  }
  feature_hook_util(output_list_of_user_ent_ctx(self), "GetData");
...
static voxgig_value* output_list_of_user_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_list_of_user_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(output_list_of_user_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static Entity* output_list_of_user_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "output_list_of_user");
  return NULL;
}

static Entity** output_list_of_user_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "output_list_of_user");
  return NULL;
}


static void output_list_of_user_create_postdone(output_list_of_user_entity* self, Context* ctx) {
...
static Entity* output_list_of_user_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, output_list_of_user_ent_ctx(self));
  output_list_of_user_run_op(self, ctx, output_list_of_user_create_postdone, err);
  if (*err) return NULL;
...
static Entity* output_list_of_user_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "output_list_of_user");
  return NULL;
}

static Entity* output_list_of_user_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "output_list_of_user");
  return NULL;
}
...
// live record.
static void output_list_of_user_mark_deleted(Entity* e) {
  ((output_list_of_user_entity*)e)->deleted = true;
}

static bool output_list_of_user_deleted(Entity* e) {
  return ((output_list_of_user_entity*)e)->deleted;
}

static const EntityVT output_list_of_user_VT = {
  output_list_of_user_get_name,
  output_list_of_user_make,
  output_list_of_user_data,
  output_list_of_user_matchv,
  output_list_of_user_mark_deleted,
  output_list_of_user_deleted,
  output_list_of_user_load,
  output_list_of_user_list,
  output_list_of_user_create,
  output_list_of_user_update,
  output_list_of_user_remove,
};

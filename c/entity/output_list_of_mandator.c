// OutputListOfMandator entity client (generated — mirrors the rust Entity fragment).
...
typedef struct output_list_of_mandator_entity {
...
static const char* output_list_of_mandator_get_name(Entity* e);
...
Entity* output_list_of_mandator_entity_new(BluefinTecsUserBackofficeSDK* client, voxgig_value* entopts) {
  ...
  output_list_of_mandator_entity* self = (output_list_of_mandator_entity*)calloc(1, sizeof(output_list_of_mandator_entity));
  self->base.vt = &output_list_of_mandator_VT;
  self->name = strdup("output_list_of_mandator");
  self->client = client;
...
static voxgig_value* output_list_of_mandator_run_op(output_list_of_mandator_entity* self, Context* ctx,
                                    output_list_of_mandator_postdone_fn post_done, PNError** err) {
...
voxgig_value* output_list_of_mandator_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* output_list_of_mandator_get_name(Entity* e) {
  return ((output_list_of_mandator_entity*)e)->name;
}
...
static Entity* output_list_of_mandator_make(Entity* e) {
  ...
  return output_list_of_mandator_entity_new(self->client, opts);
}
...
static voxgig_value* output_list_of_mandator_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_list_of_mandator_ent_ctx(self), "SetData");
  }
  feature_hook_util(output_list_of_mandator_ent_ctx(self), "GetData");
...
static voxgig_value* output_list_of_mandator_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_list_of_mandator_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(output_list_of_mandator_ent_ctx(self), "GetMatch");
...
static void output_list_of_mandator_create_postdone(output_list_of_mandator_entity* self, Context* ctx) {
...
static const EntityVT output_list_of_mandator_VT = {
  output_list_of_mandator_get_name,
  ...
  output_list_of_mandator_update,
  output_list_of_mandator_remove,
};

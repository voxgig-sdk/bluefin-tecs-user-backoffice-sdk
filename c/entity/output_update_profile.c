// OutputUpdateProfile entity client (generated — mirrors the rust Entity fragment).
...
typedef struct output_update_profile_entity {
  ...
  bool deleted;
} output_update_profile_entity;

typedef void (*output_update_profile_postdone_fn)(output_update_profile_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT output_update_profile_VT;
static const char* output_update_profile_get_name(Entity* e);
static Entity* output_update_profile_make(Entity* e);
static voxgig_value* output_update_profile_data(Entity* e, voxgig_value* args);
static voxgig_value* output_update_profile_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* output_update_profile_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** output_update_profile_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* output_update_profile_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* output_update_profile_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* output_update_profile_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void output_update_profile_mark_deleted(Entity* e);
static bool output_update_profile_deleted(Entity* e);

static Context* output_update_profile_ent_ctx(output_update_profile_entity* self) {
  return self->entctx;
}
...
Entity* output_update_profile_entity_new(BluefinTecsUserBackofficeSDK* client, voxgig_value* entopts) {
  ...
  output_update_profile_entity* self = (output_update_profile_entity*)calloc(1, sizeof(output_update_profile_entity));
  self->base.vt = &output_update_profile_VT;
  self->name = strdup("output_update_profile");
  self->client = client;
...
static voxgig_value* output_update_profile_run_op(output_update_profile_entity* self, Context* ctx,
                                    output_update_profile_postdone_fn post_done, PNError** err) {
...
voxgig_value* output_update_profile_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  output_update_profile_entity* self = (output_update_profile_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, output_update_profile_ent_ctx(self));
...
static const char* output_update_profile_get_name(Entity* e) {
  return ((output_update_profile_entity*)e)->name;
}
...
static Entity* output_update_profile_make(Entity* e) {
  ...
  return output_update_profile_entity_new(self->client, opts);
}
...
static voxgig_value* output_update_profile_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_update_profile_ent_ctx(self), "SetData");
  }
  feature_hook_util(output_update_profile_ent_ctx(self), "GetData");
...
static voxgig_value* output_update_profile_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(output_update_profile_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(output_update_profile_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static Entity* output_update_profile_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "output_update_profile");
  return NULL;
}

static Entity** output_update_profile_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "output_update_profile");
  return NULL;
}


static void output_update_profile_create_postdone(output_update_profile_entity* self, Context* ctx) {
...
static Entity* output_update_profile_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, output_update_profile_ent_ctx(self));
  output_update_profile_run_op(self, ctx, output_update_profile_create_postdone, err);
  if (*err) return NULL;
...
static Entity* output_update_profile_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "output_update_profile");
  return NULL;
}

static Entity* output_update_profile_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "output_update_profile");
  return NULL;
}
...
// live record.
static void output_update_profile_mark_deleted(Entity* e) {
  ((output_update_profile_entity*)e)->deleted = true;
}

static bool output_update_profile_deleted(Entity* e) {
  return ((output_update_profile_entity*)e)->deleted;
}

static const EntityVT output_update_profile_VT = {
  output_update_profile_get_name,
  output_update_profile_make,
  output_update_profile_data,
  output_update_profile_matchv,
  output_update_profile_mark_deleted,
  output_update_profile_deleted,
  output_update_profile_load,
  output_update_profile_list,
  output_update_profile_create,
  output_update_profile_update,
  output_update_profile_remove,
};

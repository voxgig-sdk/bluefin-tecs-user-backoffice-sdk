...
static voxgig_value* output_list_of_available_role_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* output_list_of_available_role_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* output_list_of_available_role_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* output_list_of_available_role_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* output_list_of_available_role_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
...
static voxgig_value* output_list_of_available_role_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "output_list_of_available_role");
  return NULL;
}

static voxgig_value* output_list_of_available_role_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
...
static voxgig_value* output_list_of_available_role_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, output_list_of_available_role_ent_ctx(self));
  return output_list_of_available_role_run_op(self, ctx, output_list_of_available_role_create_postdone, err);
}


static voxgig_value* output_list_of_available_role_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "output_list_of_available_role");
  return NULL;
}

static voxgig_value* output_list_of_available_role_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
